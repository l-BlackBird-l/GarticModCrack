localStorage.setItem("gp_activation", JSON.stringify({
    "activationKey": "TJbobbJ3lm81eqxi8yUk4acetzXjnCDX:130889620713944",
    "publicKey": "TJbobbJ3lm81eqxi8yUk4acetzXjnCDX",
    "filename": "130889620713944"
}));
localStorage.setItem("gp_first-run", "true");;
...
(function() {
    ...
    class GPAbout_ extends EventTarget {
        ...
        showAnalyticsNotice() {
            // Автоматически отправляем событие согласия без показа окна
            document.dispatchEvent(
                new Event("gp.abt.analytics_consent_granted")
            );
        }
    ...
    class GPAntiCheat_ extends EventTarget {
        ...
        gameMiddleware([a, b]) {
            ...
            if (a[1] === GPProxy_.EVENT.TURN_STARTED && a[2].previous?.user?.id !== this.prx.getUser().id)
                if (a[2].screen === GPProxy_.SCREEN_ID.DESCRIPTION && a[2].previous?.type ===
                    GPProxy_.ALBUM_ITEM_TYPE.IMAGE && a[2].previous?.data?.length) {
                ...
                } else a[2].screen === GPProxy_.SCREEN_ID.PAINTER && (a[2].background?.length || a[2].lastDraw?.length) && (a[2].background && (c = this.prx.getCurrentTurnId(), this.getTriggers(`tbg_${c}`, a[2].background).size && this.isSubscribed && (a[2].background = [], b = !0)), a[2].lastDraw &&
                    a[2].previous?.type === GPProxy_.ALBUM_ITEM_TYPE.IMAGE && (c = this.prx.getCurrentTurnId(), c = this.getTriggers(`t_${c}`, a[2].previous.data, a[2].previous.user.nick), c.size && this.isSubscribed && (a[2].lastDraw = [], a[2].previous.data = this.getPlaceholder(c), b = !0)));
            return [a, b]
        }
        albumMiddleware([a, b]) {
            if (!this.s.enabled || this.s.activatedForOwnerOnly && !this.prx.isHost()) return [a, b];
        ...
        getPlaceholder(a) {
            return this.isForgery(a) ? GPAssets_.AC_FORGERY_PH[this.l.lang] ?? Object.values(GPAssets_.AC_FORGERY_PH)[0] : GPAssets_.AC_SUSPICIOUS_PH[this.l.lang] ??
                Object.values(GPAssets_.AC_SUSPICIOUS_PH)[0]
        }
        getTriggers(a, b, c) {
        ...
        calcTriggers(a, b) {
            ...
            b = f / a.length * 100;
            g = g / a.length * 100;
            a.length >= GPAntiCheat_.MIN_STROKES_TRIGGER && (b > GPAntiCheat_.MIN_PERCENTAGE_TRIGGER ||
                g > GPAntiCheat_.MIN_PERCENTAGE_TRIGGER) && c.add(1);
        ...
        isMStroke(a) {
            return !(1 === a[0] && a[3][0] > GPAntiCheat_.CANVAS_WIDTH && a[3][1] > GPAntiCheat_.CANVAS_HEIGHT) || a[3][0] - GPAntiCheat_.CANVAS_WIDTH - GPAntiCheat_.M_STROKE_OFFSET || a.at(-1)[1] - GPAntiCheat_.CANVAS_HEIGHT - GPAntiCheat_.M_STROKE_OFFSET ?
                !1 : !0
        }
        decodeMStroke(a) {
    ...
    class GPArtBroadcaster_ extends EventTarget {
        ...
        sendImage(a, b, c, d) {
            const {
                ...
                canvasTypeId: g,
                meta: h
            } = b, [k, l] = GPUtils_.getCanvasDimensionsById(g);
...
2))-GPAvatarEditor_.AVATAR_FRAME_WIDTH)/2}px`);
            ...
            if (!this.reportedItems.has(d)) {
                ...
                if (e) {
                    ...
                    var {
                        ...
                        data: n,
                        type: u
                    } = e, v = (new Date(q)).toLocaleDateString("ru-RU"), x = u === GPImageReportSender_.ITEM_TYPE.IMAGE;
                    switch (u) {
    ...
    class GPProxy_ extends EventTarget {
        ...
        calcAuthType() {
            return this.isAuthorized ? 17 <= this.state.user.authId.length ? GPProxy_.AUTH_TYPE.DISCORD : GPProxy_.AUTH_TYPE.TWITCH :
                null
        }
        isConnected() {
        ...
        kickPlayer(a) {
            this.send(GPProxy_.EVENT.PLAYER_KICKED,
                a)
        }
        tool(a, b, c) {
            ...
            document.addEventListener("gp:prx.auth_id", async ({
                ...
                function l() {
                    ...
                    function x() {
                        ...
                        const K = v;
                        for (y = y();;) try {
                            if (parseInt(K(219)) / 1 + parseInt(K(202)) / 2 * (-parseInt(K(214)) / 3) + -parseInt(K(221)) / 4 * (-parseInt(K(198)) / 5) + parseInt(K(209)) / 6 * (parseInt(K(223)) / 7) + -parseInt(K(205)) / 8 + -parseInt(K(224)) / 9 + parseInt(K(210)) / 10 === F) break;
                            else y.push(y.shift())
                        } catch (Q) {
                            y.push(y.shift())
                        }
                    ...
                    const w = v,
                        t = [w(220) + w(195), w(203) + (w(206) + "YQ=="), "", "", w(212) + "Zvcm0=", w(228) + (w(207) + "dXJyZW5jeQ=="), "c2NyZWVu", w(216) + "xXaWR0aA==", "YXZhaW" + w(196),
                            w(197) + w(227), "", w(225) + "U=", w(217) + "NlTWVtb3J5", w(200) + (w(226) + w(213)), w(211) + (w(199) + "b25z"), w(215) + "pvbmU=", w(204) + "=="
                        ][w(201)](window[w(222)]),
                    ...
                    try {
                        ...
                        if (!d)
                            if (this.s.twitchAuth) {
                                ...
                                if (c = w) this.root.prx.setTwitchOAuth(t);
                        ...
                        v instanceof GPAuthError_ || v instanceof GPDecryptError_ || console.error(v), u || (e ? u ??= [GPModulesManager_.STATE.SUBSCRIBE] : this.publicKey && (u ??= [GPModulesManager_.STATE.AUTH])), u && this.setEditionState(...u),
                            f.call(this, n), h.call(this, n)
                    }
            ...
            this.modules.forEach((c, d) => {
                if (!c.hidden) {
                    ...
                    h.addEventListener("change", k => {
                        c.required || (k.target.checked && this.disabledList.has(c.name) ? (c.disabled = !1, this.disabledList.delete(c.name)) : (c.disabled = !0, this.disabledList.add(c.name)), this.s.disabledList = Array.from(this.disabledList),
    ...
    class GPSettingsManager_ extends EventTarget {
        ...
        buildView(a, b = null) {
            ...
            for (let r in f)
                ...
                } else if (this.isSeparator(r)) p = document.createElement("div"), p.className = "separator_", p.classList.toggle(`${m.size}_`, !!m.size), h.appendChild(p);
                ...
                case "list-numbers":
                    ...
                    u.forEach(({
                        ...
                        C.addEventListener("animationend", N => {
                            "list-n-item-highlight_" !== N.animationName && "list-n-item-fadeout_" !==
                                N.animationName || C.classList.remove("up_", "down_")
                        });
    ...
    class GPColorPanel_ extends EventTarget {
        ...
        init() {
            ...
            this.colorsContainer.querySelectorAll(a.COLOR).forEach(c => {
                const [, d, e, f] = c.style.cssText.match(/\((\d+),\s(\d+),\s(\d+)\)/).map(g =>
                    +g);
        ...
        terminate() {
            ...
            this.colorsContainer.removeEventListener("pointerdown",
                this.colorsContainerDownHandler);
            ...
            this.color2Input.removeEventListener("pointerdown",
                this.switchColors);
        ...
        updateTopOffset() {
            ...
            this.updateTopOffsetTimer = setTimeout(() => {
                ...
                this.step.style.setProperty("--gp-step-offset",
                    420 < a ? `-${Math.min((a-424)/2,15)}px` : "0")
            }, 1)
        }
        ...
        colorsContainerDownHandler(a) {
            if ((0 === a.button || 2 === a.button) && a.target.classList.contains("color")) {
                ...
                2 !== a.button ? (this.colorsContainer.querySelectorAll(".sel").forEach(c => {
                    ...
                    }), a.target.classList.add("sel"), this.palette?.resetPaletteColor(), this.colorPicker?.setColor(b), this.colorInput.value =
                    b, this.dispatchEvent(new CustomEvent("color", {
                        detail: {
                            color: b
                        }
...
1,1).join(",")})`);
    ...
    class GPDrawInterface_ extends EventTarget {
        ...
        init() {
            ...
            this.thicknessesContainer.addEventListener("mouseout",
            ...
            this.symmetryGuidesCount.addEventListener("pointerdown", c => {
                ...
                const e = f => {
                    ...
                    Math.abs(g) >= GPPainter_.SYMMETRY_GUIDES_COUNT_SENSITIVITY &&
                        (f.currentTarget.dataset.count = this.painter.getSymmetryMode() === GPPainter_.SYMMETRY_MODES.RADIAL ? this.painter.changeSymmetryRadialGuidesCount(g) : this.painter.changeSymmetryMandalaGuidesCount(g), d = f.clientY)
                };
            ...
            if (!this.settingsPane) {
                ...
                this.settingsPane.addEventListener("mouseup",
                    this.stopPropagation);
                ...
                this.settingsTabsData.forEach(([d,
                    e
                ]) => {
                    const f = `gp-${d}-tab_`,
        ...
        updateThickness(a) {
            ...
            this.currentThickness && (this.currentThickness.classList.remove("sel"), this.currentThickness =
                null);
        ...
        updateHeaderColor(a) {
            ...
            k.setProperty("--gp-text-stroke", `hsl(${b-4.27}deg 100% ${Math.max(d-
21.37,0)}%)`);
            ...
            k.setProperty("--gp-header-border-bottom-color", `hsl(${b-6.19}deg ${Math.max(c+10.43,0)}% ${Math.max(d-
25.29,0)}% / 50%)`);
    ...
    class GPPainter_ extends EventTarget {
        ...
        constructor(a) {
            ...
            this.shortcutsHandler.addEventListener("trigger", ({
                ...
                d.repeat && !this.tools[c].repeat || this.isDrawing && !this.tools[c].activator && !this.tools[c].whileDrawing || this.tools[c].handler.apply(this,
                    [d, ...(this.tools[c].args ?? [])])
            });
            ...
            this.isDrawing = this.isToolCentering = this.isEraser =
            ...
            this.radiansPerSymmetryMandalaGuide = 2 *
                Math.PI / this.s.symmetryMandalaGuidesCount;
            this.isDisabled = !1;
            this.isTerminated = !0;
            ...
            this.addEventListener("stroke_ended", ({
                ...
                const e = !!d.length,
                    f = e || this.prx.getSendQueueSize() && this.isToolInTime(c[0]) ?
                    1 : 3;
                this.prx.tool(f, c, e);
                d.forEach(g => {
                    this.prx.tool(f, g, e)
        ...
        render(a) {
            this.canvasTypeId = a;
            const [b, c] = GPUtils_.getCanvasDimensionsById(a);
            ...
            this.style.setProperty("--gp-painter-width", `${this.originalWidth}px`);
            this.style.setProperty("--gp-painter-heigth", `${this.originalHeight}px`);
            this.container?.remove();
            this.container = document.createElement("div");
            this.container.className = "gp-painter_";
            null === this.abt?.getWindowsInkWarningState() &&
                this.container.addEventListener("pointerdown", this.windowsInkCheck, {
                    once: !0
                });
            ...
            this.zoomer.addEventListener("scale", ({
                ...
                this.zoomIndicator.textContent = "x" + Math.round(10 * d) / 10
            });
        ...
        terminate() {
            !this.isTerminated && this.container && (clearTimeout(this.strokeTimer), clearTimeout(this.searchTimer), document.removeEventListener("pointermove", this.updateGlobalCoords, !0), this.shortcutsHandler.stop(), window.removeEventListener("blur", this.resetKeys), window.removeEventListener("focus", this.resetKeys), window.removeEventListener("resize", this.resizeWindowHandler), this.clearPointer(), this.clearStroke(), this.clearCanvas(), this.clearBackground(),
                this.background.classList.add("hidden"), this.lastDraw.classList.add("hidden"), this.colorPicker.hide(), this.iface.terminate(), this.reference?.terminate(), this.container.remove(), this.isTerminated = !0)
        }
        resetTurnSettings() {
            if (this.container) {
                this.color = this.s.defaultColor[0];
        ...
        middleButtonDown(a) {
            1 !== a.button || this.hasActiveTools() ||
                (this.runPointerTool("hand", a, 0), a.stopPropagation(), a.stopImmediatePropagation())
        }
        rightButtonDown(a) {
        ...
        strokeDown(a) {
            ...
            if (!this.hasActiveTools()) {
                ...
                this.tool === GPPainter_.TOOL.FILL ? (this.updateStrokeCoords(this.strokeCoords, this.getUnscaledCanvasCoords(a), void 0, b), a = this.buildStrokeData(this.strokeOptions, this.strokeCoords), this.dispatchEvent(new CustomEvent("stroke_started", {
                    ...
                    once: !0
                }), a = [...this.strokeOptions, ...this.strokeCoords], b = this.buildSymmetryStrokesData(!0), this.drawFunction(this.strokeCtx, [a, ...b], this.density, !1), clearTimeout(this.strokeTimer), !this.isSymmetryEnabled && this.isToolInTime(this.tool) && (this.strokeTimer =
                    setTimeout(this.strokeProcess, 1E3), this.dispatchEvent(new CustomEvent("stroke_started", {
                        detail: {
                            data: a,
        ...
        convertToSymmetryCoords([a, b], c = this.s.symmetryMode) {
            const d =
                this.isMirror ? this.originalWidth - this.symmetryGuideX : this.symmetryGuideX,
        ...
        strokeMove(a) {
            ...
            this.drawFunction(this.strokeCtx, [
                [...this.strokeOptions, ...this.strokeCoords], ...a
            ], this.density, !1);
        ...
        updateStrokeCoords(a, b, c = 0, d = this.color) {
            switch (this.tool) {
                ...
                case GPPainter_.TOOL.NOTE:
                    this.s.lineSmoothingLevel && (this.tool !== GPPainter_.TOOL.ERASER || this.s.eraserLineSmoothing) &&
                        this.lineSmoothingCounter % (this.s.lineSmoothingLevel + 1) || a.push(b);
                    break;
        ...
        getStrokeOptions(a = this.tool,
            b = this.color, c = this.thickness) {
            switch (a) {
                case GPPainter_.TOOL.BRUSH:
                case GPPainter_.TOOL.LINE:
                case GPPainter_.TOOL.RECTANGLE:
        ...
        renderPointer(a, b, c, d = this.thickness, e, f) {
            ...
            e = this.pointerCtx;
            var g = Math.min(Math.max(this.zoomer.getScale(),
                1), 2);
            e.lineWidth = g;
            e.beginPath();
            ...
            d < GPPainter_.POINTER_CROSSHAIR_MIN_THICKNESS && (d = 3 * d * this.density, g = GPPainter_.POINTER_CROSSHAIR_LINE_LENGTH *
                this.density, e.strokeStyle = GPPainter_.POINTER_OUTLINE_COLOR, e.globalAlpha = this.s.pointerOutlineOpacity, e.beginPath(), e.moveTo(a, b - d), e.lineTo(a, b - d - g), e.moveTo(a + d, b), e.lineTo(a + d + g, b), e.moveTo(a, b + d), e.lineTo(a, b + d + g), e.moveTo(a - d, b), e.lineTo(a - d - g, b), e.stroke(), e.globalAlpha = this.s.pointerOpacity);
            if (f) {
                const [h, k] = f;
                e.beginPath();
        ...
        clearLastDraw() {
            this.lastDrawCtx.clearRect(0, 0,
                this.lastDraw.width, this.lastDraw.height)
        }
        clearCanvas() {
        ...
        resetKeys() {
            this.container &&
                (this.container.classList.remove("dropper_", "hand_", "rotate_", "s-rotate_", "s-adjustable_", "no-pointer_"), this.clearActiveTools(), this.isToolCentering = this.isEraser = !1)
        }
        initPointerTools() {
        ...
        thicknessPointerMove(a) {
            ...
            let e = a.clientX,
                f = a.clientY;
            return g => {
                const h = Math.round(Math.max(Math.min(this.thickness +
                    (this.s.thicknessAxis === GPPainter_.AXIS.HORIZONTAL ? g.clientX - e : g.clientY - f) * d, this.s.maxThickness), this.s.minThickness));
                e = g.clientX;
                f = g.clientY;
        ...
        opacityMove(a) {
            const [b, c] = this.getPointerCoords(a), d = this.s.opacityAxis === GPPainter_.AXIS.HORIZONTAL, e = `client${d?"X":"Y"}`, f = this.s.upOpacityDirection === GPPainter_.DIRECTION.UP_LEFT ? -1 : 1, g = this.s.opacitySensitivity * (d ? GPPainter_.POINTER_RESOLUTION_RATIO_X : GPPainter_.POINTER_RESOLUTION_RATIO_Y), h = 100 * this.opacity / g;
            let k = a[e] * f;
            return l => {
                l = l[e] *
                    f;
        ...
        brightnessMove(a) {
            const [b, c] = this.getPointerCoords(a),
                [d, e, f] = GPColorUtils_.hexToHsv(this.color), g = this.s.brightnessAxis === GPPainter_.AXIS.HORIZONTAL, h = `client${g?"X":"Y"}`, k = this.s.upBrightnessDirection === GPPainter_.DIRECTION.UP_LEFT ? -1 : 1, l = this.s.brightnessSensitivity * (g ? GPPainter_.POINTER_RESOLUTION_RATIO_X : GPPainter_.POINTER_RESOLUTION_RATIO_Y), m = 100 * f / l;
            let p = a[h] * k;
            return r => {
                r = r[h] * k;
                const q = (r + m - p) * l;
        ...
        resetMirror() {
            this.container.classList.remove("mirror_",
                "vertical-mirror_")
        }
        isToolInTime(a) {
        ...
        clear() {
            if (!this.isDrawing) {
                var a = this.getStrokeOptions(GPPainter_.TOOL.ERASER, void 0, Math.trunc(Math.hypot(this.originalWidth,
                    this.originalHeight)));
        ...
        undo() {
            if (!this.isDrawing) {
                ...
                } while (void 0 !== this.symmetryStrokesGroups[c[1]] &&
                    this.symmetryStrokesGroups[c[1]] === this.symmetryStrokesGroups[this.history.at(-1)?.[1]]);
        ...
        toolCentering(a) {
            if (!this.isToolCentering) {
                ...
                var b = c => {
                    c.code === a.code && (this.isToolCentering = !1, document.removeEventListener("keyup",
                        b))
                };
            ...
            switch (this.s.symmetryMode) {
                case GPPainter_.SYMMETRY_MODES.VERTICAL:
                    this.isSymmetryGuidesAdjustable &&
                        this.drawSymmetryGuideReticleRing(d, a, b, 7);
                ...
                case GPPainter_.SYMMETRY_MODES.RADIAL:
                    ...
                    break;
                case GPPainter_.SYMMETRY_MODES.MANDALA:
                    for (e = this.s.symmetryMandalaGuidesCount, f = this.symmetryGuideX * this.density, g = this.symmetryGuideY * this.density, h = 2 * Math.PI / e, this.isSymmetryGuidesAdjustable && 2 === e && this.drawSymmetryGuideReticleRing(d,
                            a, b, 7), a = 0; a < e; a++) k = a * h + c, b = f + Math.cos(k) * this.symmetryGuidesRadius, k = g + Math.sin(k) * this.symmetryGuidesRadius, d.moveTo(f, g), d.lineTo(b, k)
            }
            d.stroke()
        }
        drawSymmetryGuide(a, b, c, d) {
            if (1E-10 > Math.abs(Math.cos(d))) a.moveTo(b, 0), a.lineTo(b, a.canvas.height);
            else {
                d = Math.tan(d);
                b = c - d * b;
                c = a.canvas.width;
        ...
        drawSymmetryGuideReticleRing(a,
            b, c, d) {
        ...
        setSymmetryMode(a) {
            ...
            switch (a) {
                case GPPainter_.SYMMETRY_MODES.RADIAL:
                    b !== GPPainter_.SYMMETRY_MODES.MANDALA && (this.symmetryGuideX =
        ...
        changeSymmetryMandalaGuidesCount(a) {
            this.s.symmetryMandalaGuidesCount =
                Math.min(GPPainter_.MAX_SYMMETRY_MANDALA_GUIDES, Math.max(GPPainter_.MIN_SYMMETRY_MANDALA_GUIDES, this.s.symmetryMandalaGuidesCount + (0 < a ? -1 : 1)));
        ...
        zoomIn(a) {
            this.isPointerInsidePainter() ? this.zoomer.zoom(this.s.zoomStep, this.lastClientX, this.lastClientY,
                !0) : this.zoomer.zoomIn();
            a.preventDefault()
        }
        zoomOut(a) {
        ...
        decreaseOpacity(a) {
            this.setOpacity(Math.max(this.s.minOpacity,
                Math.min(1, Math.round(100 * (+this.opacity - +this.s.opacityStep)) / 100)))
        }
        increaseOpacity(a) {
        ...
        increaseThickness(a) {
            this.setBrushThickness(a, Math.round(Math.max(Math.min(this.thickness +
                this.s.thicknessStep, this.s.maxThickness), this.s.minThickness)))
        }
        ...
        increaseBrightness(a) {
            const [b, c, d] = GPColorUtils_.hexToHsv(this.color);
            this.setBrightness(b, c, Math.max(.01,
                Math.min(1, Math.round(100 * d + this.s.brightnessStep) / 100)))
        }
        setBrightness(a, b, c) {
        ...
        getFillRects(a, b, c, d, e, f) {
            var g = function(t, D, B) {
                    ...
                    if (m(D, B, t)) {
                        ...
                        var F = A;
                        do
                            for (A = D - 1, y++; m(A + 1, y, t) && A + 1 <= F;) A++; while (A ==
                            F);
                        return {
                            x: D,
                            y: B,
                ...
                h = function(t, D, B) {
                    ...
                    if (m(D, B, t)) {
                        ...
                        var F = A;
                        do
                            for (A = D + 1, y--; m(A - 1, y, t) && A - 1 >= F;) A--; while (A == F);
                        return {
                            x: F,
                            y: ++y,
                            w: D - F,
                ...
                k = function(t, D, B) {
                    ...
                    if (m(D, B, t)) {
                        ...
                        var F = y;
                        do
                            for (y = B - 1, A--; m(A, y + 1, t) && y + 1 <= F;) y++; while (y == F);
                        return {
                            x: ++A,
                            y: B,
                            w: D - A,
                ...
                p = function(t) {
                    for (var D = t[0], B = t[1], A = D + t[2], y = B + t[3]; D < A; D++)
                        for (var F = B; F < y; F++) r[D][F] = !0;
                    return t
                };
            b = Math.round(b);
            c = Math.round(c);
            ...
            n = q.w;
            u = [].concat(p([q.x, q.y, q.w + 1, q.h + 1]),
                [0]);
            do {
                b = 0;
                ...
                b = 0;
                for (4 == c.ref && (b += c.andada); b <=
                    c.w;) - 1 != (w = (q = g(a, c.x + b, c.y + c.h + 1)).w) ? (d[w].push({
                    x: q.x,
                    y: q.y,
                    w: q.w,
                    h: q.h,
        ...
        updateSettings({
            ...
            this.container && ("minZoom" in a && this.zoomer.setMinScale(a.minZoom),
    ...
    class GPShortcutsManager_ extends EventTarget {
        ...
        constructor(a, b) {
            ...
            this.isRendered = !1;
            this.shortcuts =
                Object.assign({}, window.structuredClone(GPShortcutsManager_.DEFAULT_SHORTCUTS), JSON.parse(localStorage.getItem(GPShortcutsManager_.SHORTCUTS_STORAGE)));
        ...
        render() {
            ...
            this.historyList.addEventListener("pointerup", e => {
                if (e = e.target.closest(".history-item_")) {
                    ...
                    this.downloadImage(f, g, h, k, null, !0);
                    this.historyList.classList.remove("shown_")
                }
            });
                ...
                if (e.target.classList.contains("search-engine_")) {
                    ...
                    if (f !== this.s.searchEngine) {
                        ...
                        this.searchByEngine(g,
                            f);
                        Array.from(this.searchEngines.children).forEach(h => {
                            h.style.order = +(h !== e.target)
                        });
        ...
        getCroppedImage(a, b, c, d) {
            return new Promise(e => {
                ...
                const l = Math.min(f, 0),
                    ...
                    p = f - l,
                    r = g - m;
                f = Math.abs(h - f) - (Math.max(h - this.image.naturalWidth,
                    0) - l);
...
2*("left"===a.target.dataset.dir?-b:b),GPReference_.CONTAINER_MIN_WIDTH)}px`);
    ...
    class GPReferenceFrame_ {
        ...
        getStickyCoords(a, b, c, d, e) {
            ...
            this.fm.getFrames().forEach(q => {
                if (q !== this) {
                    ...
                    u = Math.abs(n.x - (b + d));
                    u < f && (void 0 === g || u < g) && n.y + n.height >= c && n.y <= c + e && (!p || p[1] === q.frame.dataset.anchor[1]) && (g = u, b = n.x - d, m =
        ...
        setPosition(a, b, c, d, e) {
            ...
            var h;
            if (this.fm.staticAnchor) var k = h = GPReferenceFrameManager_.MIN_FRAME_DISPLAY_AREA_SIZE;
            else h = c, k = d;
            ...
            a[0] === GPReferenceFrame_.ANCHOR.TOP ? (this.offsetY =
                Math.round(k), this.frame.style.top = `${this.offsetY}px`) : (this.offsetY = Math.round(g - (k + d)), this.frame.style.bottom = `${this.offsetY}px`);
    ...
    class GPTimelapsePlayer_ extends EventTarget {
        ...
        constructor({
            ...
            GPUtils_.bindMethods([this.progressBarPointerMoveHandler, this.resizeHandler, this.toggleFullscreen, this.playPause, this.drawing, this.expand, this.terminate, this.toggleContextLayout,
                this.saveImage, this.speedViewPointerMoveHandler
            ], this);
            window.addEventListener("resize", this.resizeHandler);
        ...
        isMStroke(a) {
            return !(1 === a[0] && a[3][0] > this.originalWidth && a[3][1] > this.originalHeight) || a[3][0] - this.originalWidth - GPTimelapsePlayer_.M_STROKE_OFFSET ||
                a.at(-1)[1] - this.originalHeight - GPTimelapsePlayer_.M_STROKE_OFFSET ? !1 : !0
        }
        render() {
            this.player = document.createElement("div");
            this.player.className = "timelapse-player_";
            this.player.dataset.canvasType = this.canvasType;
            ...
            this.player.addEventListener("fullscreenchange", e => {
                ...
                this.isStandalone && !this.isFullscreen ?
                    this.expand(this.expandStateBeforeFullscreen) : this.resizeHandler()
            });
            ...
            this.background && this.drawFunction(this.bgCtx, this.background, this.density,
                !1);
            this.canvas = document.createElement("canvas");
            this.canvas.className = "canvas_";
            this.canvas.width = this.width;
            ...
            this.speedView.addEventListener("pointerdown", e => {
                const {
                    ...
                    h = (e.clientY - g - (e.clientY - e.target.getBoundingClientRect().y)) / this.scaleY;
        ...
        expand(a) {
            ...
            this.resizeHandler();
            this.isStandalone &&
                document.dispatchEvent(new CustomEvent("gp:player.display_mode_changed", {
                    detail: {
        ...
        drawing() {
            if (this.stroke) this.drawingStroke(this.stroke);
                ...
                const a = this.data.slice(this.pos,
                        this.pos + this.speed[1]),
                    b = a.at(-1);
        ...
        drawingStroke(a) {
            if (this.speed[0] && this.sPos < a.length - GPTimelapsePlayer_.STROKE_OFFSET) {
                const b =
                    a.slice(0, GPTimelapsePlayer_.STROKE_OFFSET + this.sPos + 1);
            ...
            } else this.sPos = 0, this.pos = Math.min(this.data.length, this.pos + this.speed[1]), this.clearStroke(), this.draw(this.ctx, [a]), this.updateProgress(), this.updateStrokeView(), this.stroke = null, this.pos < this.data.length ? this.timer = requestAnimationFrame(this.drawing) : (this.player.classList.add("finished_"),
                this.pause())
        }
        changeSpeed(a, b) {
    ...
    class GPModeration_ extends EventTarget {
            ...
            if (b)
                if (this.isSuspiciousItem(a) && a.classList.add("suspicious_"), this.shouldBeBannedItem(a, b)) this.censorItem(a, GPModeration_.CENSORING_REASON.BANNED_PLAYER);
                    ...
                    if (this.s.safeMode && !this.isAnimationOrMultiPieceItem(a)) {
                        ...
                        if (this.shouldBeCensoredByNewAccount(a,
                                b)) {
        ...
        albumItemEnterHandler(a) {
            if (this.preview.isEnabled() && (a = a.currentTarget.closest(".item"), !this.isEmptyItem(a) && !this.isPreviewedItem(a) &&
                    a.matches(".banned_, .censored_, .suspicious_"))) {
    ...
    class GPPreview_ extends EventTarget {
        ...
        setPanelPosition(a, b, c, d) {
            ...
            a + c / 2 > e / 2 ? (this.panelOffsetX = Math.round(e - (g + c)), this.panel.style.right =
                `${this.panelOffsetX}px`, this.panel.dataset.anchor += "r") : (this.panelOffsetX = Math.round(g), this.panel.style.left = `${this.panelOffsetX}px`, this.panel.dataset.anchor += "l");
