;(function () {
  ;(() => {
    const a = ({ pos: l, prevPos: m }) => l !== m,
      ...
      c =
        ...
        ({ pos: r, prevPos: q, translate: p }) =>
          b({ minScale: l, maxScale: m, scale: n }) && a({ pos: r, prevPos: q })
            ? p + (r - q * n) * (1 - 1 / n)
            : p,
      d = ({
        scale: l,
      ...
      h = (l) => ({
        zoom: ({ x: m, y: n, deltaScale: r, scaleSensitivity: q }) => {
          const { left: p, top: t } = l.element.getBoundingClientRect(),
  ...
  class GPAntiCheat_ extends EventTarget {
    ...
    static SETTINGS_UI = {
      ...
      sendReports: {
        type: "switch",
        description:
          "\u041e\u0442\u0441\u044b\u043b\u0430\u0442\u044c \u043e\u0442\u0447\u0451\u0442\u044b \u043e \u0440\u0438\u0441\u0443\u043d\u043a\u0430\u0445, \u043a\u043e\u0442\u043e\u0440\u044b\u0435 \u0431\u044b\u043b\u0438 \u043f\u043e\u043c\u0435\u0447\u0435\u043d\u044b \u0430\u043d\u0442\u0438\u0447\u0438\u0442\u043e\u043c \u043a\u0430\u043a \u043f\u043e\u0434\u043e\u0437\u0440\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0435, \u0441\u043e\u0434\u0435\u0440\u0436\u0430\u0449\u0438\u0435 \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044e \u043e \u0440\u0438\u0441\u0443\u043d\u043a\u0435 \u0438 \u0430\u0432\u0442\u043e\u0440\u0435",
      },
    }
    static MODULE = {
      title: "Anti-Cheat",
    ...
    constructor(a, b) {
      ...
      this.gpproxy.addEventListener("rejoin", ({ detail: { stage: c } }) => {
        switch (c) {
          case GPProxy_.STAGE.GAME:
            this.gpproxy.addWSMsgMiddleware(
      ...
      this.gpproxy.addEventListener("data", ({ detail: { event: c } }) => {
        c === GPProxy_.EVENT.GAME_STARTED
          ? (this.gpproxy.addWSMsgMiddleware(
              [GPProxy_.EVENT.TURN_STARTED],
              this.gameMiddleware
            ),
            (this.isGameMWActivated = !0))
          : c === GPProxy_.EVENT.GALLERY_SETTINGS
          ? (this.gpproxy.addWSMsgMiddleware(
              [GPProxy_.EVENT.ALBUM_ITEM, GPProxy_.EVENT.ALBUM_INFO],
              this.albumMiddleware
            ),
            (this.isAlbumMWActivated = !0),
            this.gpproxy.removeWSMsgMiddleware(this.gameMiddleware),
          ...
          : this.isAlbumMWActivated &&
            ...
            (this.gpproxy.removeWSMsgMiddleware(this.albumMiddleware),
    ...
    gameMiddleware([a, b]) {
      if (
        !this.s.enabled ||
        (this.s.activatedForOwnerOnly && !this.gpproxy.isHost())
      )
        return [a, b]
      if (
        a[1] === GPProxy_.EVENT.TURN_STARTED &&
        a[2].previous?.user?.id !== this.gpproxy.getUser().id
      )
        if (
          a[2].screen === GPProxy_.SCREEN.DESCRIPTION &&
          ...
          a[2].screen === GPProxy_.SCREEN.PAINTER &&
    ...
    albumMiddleware([a, b]) {
      ...
      if (
        ...
        a[2].user?.id !== this.gpproxy.getUser().id &&
        ...
        a[1] === GPProxy_.EVENT.ALBUM_INFO &&
          (a[2].background?.length &&
            a[2].bookAuthor.id !== this.gpproxy.getUser().id &&
            ((c = this.gpproxy.getCurrentAlbumId()),
          ...
          a[2].timeline?.length &&
            (a[2].timeline = a[2].timeline.map((f) => {
              if (
                !f.type ||
                f.user?.id === this.gpproxy.getUser().id ||
              ...
              if (f.bg) {
                ...
                f.data?.length &&
                  ((g = this.gpproxy.getCurrentAlbumId()),
    ...
    calcTriggers(a, b) {
      const c = new Set()
      var d = a.findLastIndex((p) => 11 === p[0])
      a = a.slice(d + 1)
      if (!a?.length) return c
      const { animate: e } = this.gpproxy.getGameConfig()
      let f = 0
      var g = 0
      let h = null,
        k = null,
      ...
      for (let p = 0; p < a.length; p++) {
        ...
        if (b && this.isMStroke(t)) {
          const { code: w, author: u } = this.decodeMStroke(t)
      ...
      ;(d.length > GPAntiCheat_.SEQUENCES_COUNT_TRIGGER ||
        n.length > GPAntiCheat_.SEQUENCES_COUNT_TRIGGER) &&
        c.add(2)
  ...
  class GPArtBroadcaster_ extends EventTarget {
    ...
    init() {
      ...
      document.dispatchEvent(
        new CustomEvent("_update_urls_avatars_cache", {
          detail: {
    ...
    sendImage(a, b, c, d) {
      const { data: e, background: f, meta: g } = b
      ...
      h.toBlob(async (q) => {
        ...
        document.dispatchEvent(
          new CustomEvent("_send_to_media", {
            detail: {
              services: a,
              artFile: q,
              sourceFile: p,
    ...
    sendSocialMediaSettings() {
      document.dispatchEvent(
        new CustomEvent("_update_sm_settings", {
  ...
  class GPAlbumObserver_ {
    ...
    constructor(a) {
      ...
      this.observerConfig = { childList: !0, subtree: !0 }
      this.observer = new MutationObserver(this.observerCallback.bind(this))
      this.titleObserverConfig = { characterData: !0, subtree: !0 }
      this.titleObserver = new MutationObserver(
        this.titleObserverCallback.bind(this)
      )
    ...
    init() {
      this.gpproxy.addEventListener("data", ({ detail: { event: a } }) => {
        if (this.gpproxy.isAuthorized || this.gpproxy.isTwitchOAuth)
          a === GPProxy_.EVENT.ALBUM_INFO
            ? this.terminate()
            : a === GPProxy_.EVENT.GALLERY_SETTINGS
            ? this.startMonitor()
            : [
                GPProxy_.EVENT.NEW_GAME,
                GPProxy_.EVENT.ALBUM_SCORE,
      ...
      this.gpproxy.addEventListener("rejoin", ({ detail: { stage: a } }) => {
        a === GPProxy_.STAGE.ALBUM &&
          ((this.gpproxy.isAuthorized || this.gpproxy.isTwitchOAuth) &&
            this.startMonitor(),
          this.gpproxy.isTwitchAuth() &&
            ((this.title = document.querySelector(".scrapbook > h4")),
            (this.endTitle = document.querySelector(".scrapbook .end > p"))))
      })
      this.gpproxy.addEventListener(
        "album_item_loading",
        ({ detail: { id: a } }) => {
    ...
    observerCallback(a, b) {
      for (const c of a)
        if (
          ...
          c.addedNodes[0].classList.contains("item")
        ) {
          ...
          a =
            ...
            [...d.parentElement.children]
              ...
              .indexOf(d)
          b = null
          d.querySelector(":scope > .drawing")
            ? (b = GPAlbumObserver_.ITEM_TYPE.IMAGE)
            : d.querySelector(":scope > .answer")
            ? (b = GPAlbumObserver_.ITEM_TYPE.TEXT)
            : d.querySelector(":scope > section > .animationmode")
            ? (b = GPAlbumObserver_.ITEM_TYPE.ANIMATION)
            : d.querySelector(":scope > section > .loopmode")
            ? (b = GPAlbumObserver_.ITEM_TYPE.MULTI_PIECE)
            : d.querySelector(":scope > .img") &&
              (b = GPAlbumObserver_.ITEM_TYPE.AI_IMAGE)
          d.dataset.id = a
          d.dataset.type = b
  ...
  class GPImageReportSender_ extends EventTarget {
    ...
    static BAN = "BAN"
    static EVENTS = { ANTI_CHEAT: "_ac_report", BAN: "_ban_report" }
    ...
    constructor(a, b, c) {
      ...
      this.gpproxy.addEventListener("data", ({ detail: { event: d } }) => {
    ...
    async send({ itemId: a, albumId: b, ...c }) {
      ...
      if (!this.reportedItems.has(d)) {
        ...
        if (e) {
          ...
          var { authId: l, nick: m } = this.gpproxy.getUser(),
            {
              meta: { author: n, title: r, date: q },
              data: p,
              type: t,
            } = e,
            v = new Date(q).toLocaleDateString("ru-RU"),
            w = t === GPImageReportSender_.ITEM_TYPE.IMAGE
          switch (t) {
            ...
            case GPImageReportSender_.ITEM_TYPE.TEXT:
              ;(u = `${n} - ${p} (${v})`),
                (v = new Blob([p], { type: "text/plain" })),
                (u = new File([v], `${u}.txt`))
          }
          v = Object.keys(GPProxy_.AUTH_TYPE_IDS).find(
            (z) => GPProxy_.AUTH_TYPE_IDS[z] === e.auth
          )
          var y = this.gpproxy.isTwitchAuth()
            ? this.twitchIdsCache.get(n.toLowerCase()) ?? null
            : null
          document.dispatchEvent(
    ...
    constructor() {
      ...
      function b(e, f, g) {
        ...
        for (var h = []; 0 < e.byteLength; ) {
          for (
            var k = new Uint8Array(e), l = 0 === k[0], m = "", n = 1;
            255 !== k[n];
            n++
          ) {
          ...
          if (l)
            try {
              ...
              for (l = new Uint8Array(k), k = "", n = 0; n < l.length; n++)
                k += String.fromCharCode(l[n])
            }
          h.push(k)
          e = e.slice(m)
        }
          ...
          if (this.wsMsgMiddlewares.size)
            if ("string" !== typeof d.data) c(d)
              ...
              if (void 0 !== f && this.wsMsgMiddlewares.has(+f)) {
                ...
                if (h) {
                  var [k, l] = [...g].reduce((m, n) => n(m), [h, !1])
                  l
                    ? ((g = this.encodePacket(k, !!e)),
    ...
    constructor(a, b) {
      ...
      document.addEventListener(
        ...
        async ({ detail: { authId: c, authTypeId: d, isAuthorized: e } }) => {
          ...
          function h(p) {
            document.dispatchEvent(
              new CustomEvent("_auth_perms", { detail: { ps: p } })
            )
          }
          async function k(p) {
            p = await g(p, l())
            return fetch("https://id.twitch.tv/oauth2/validate", {
              headers: { Authorization: `OAuth ${p}` },
              credentials: "omit",
              cache: "no-cache",
            })
              .then((t) => {
          ...
          if (this.s.allowAnalytics) {
            ...
            if (this.lm.length) {
              ...
              try {
                if (!a || !this.publicKey)
                  throw (
                    ((q = [GPModulesManager_.STATE.KEY]), new GPAuthError_())
                  )
                if (!d)
                ...
                if (t.ed) {
                  if (t.ed < Date.now())
                    throw (
                      ((q = [GPModulesManager_.STATE.EXPIRED]),
                      2 & t.p && (r |= 16),
                      new GPAuthError_())
                    )
                ...
                p instanceof GPAuthError_ ||
                  p instanceof GPDecryptError_ ||
                  console.error(p),
                  e
                    ? (q ??= [GPModulesManager_.STATE.SUBSCRIBE])
                    : this.publicKey && (q ??= [GPModulesManager_.STATE.AUTH]),
                  q && this.setEditionState(...q),
                  f.call(this, r),
                  h.call(this, r)
              }
      ...
      this.modules.forEach((c, d) => {
        if (!c.hidden) {
          ...
          e.addEventListener("pointerenter", (k) => {
            ...
            ;({ height: k } = l.getBoundingClientRect())
      ...
      Array.from(a.keys())
        ...
        .forEach((d, e) => {
          ...
          l.addEventListener("click", (n) => {
            g || (n.ctrlKey ? this.singleСontrolClickHandler(n, m) : m.click())
          })
          ...
          d.addEventListener("click", (n) => {
            n.ctrlKey && this.singleСontrolClickHandler(n, n.target.control)
          })
          d.addEventListener("auxclick", (n) => {
            2 === n.button &&
              this.singleСontrolClickHandler(n, n.target.control)
          })
          h.appendChild(d)
    ...
    buildControl(a, b, c, d, e, f, g) {
      ...
      switch (h) {
        case "switch":
          ...
          break
        case "slider":
          const { min: w, max: u, step: y, reverse: z } = k
        ...
        case "dropdown":
          ...
          q.autocomplete = "off"
          q.name = b
          const { items: A, itemsProxySetting: C } = k
      ...
      for (let t = 0; t < (m ? 2 : 1); t++)
        q.addEventListener(p[t], (v) => {
          v = { [v.target.name]: this.parseValue(v.target, h) }
          this.dispatchEvent(
            new CustomEvent("update", {
              detail: {
                source: d,
  ...
  class GPPainter_ extends EventTarget {
    ...
    strokeMove(a) {
      ...
      this.isCenteringActivated &&
        this.renderPointer(
          ...
          void 0,
          !1,
          this.centeringСoords[0].map((c) => c * this.density)
        )
    }
    strokeUp(a) {
      clearTimeout(this.strokeTimer)
    ...
    zoomMove(a, b, c, d, e, f) {
      ...
      return (h) => {
        ...
        h = h.pageY
        const l =
          (this.s.zoomAxis === GPPainter_.AXIS.HORIZONTAL ? k - e : h - f) * g
        2 < Math.abs(l) &&
          (this.zoomer.zoom({
    ...
    symmetryGuidesDownHandler(a) {
      function b(d) {
        ...
        this.updateSymmetryGuides(
          ...
          Math.max(0, Math.min(GPPainter_.ORIGINAL_HEIGHT, h))
        )
      }
    ...
    getFillRects(a, b, c, d, e, f) {
      ...
      var t
      p = g(a, b, c)
      c = { x: b, y: c, w: p.w, h: p.h, ref: 0, andada: 0, stack: 0 }
      var v = p.w,
        w = [].concat(n([p.x, p.y, p.w + 1, p.h + 1]), [0])
      do {
        b = 0
        for (2 == c.ref && (b += c.andada); b <= c.h; )
          -1 != (t = (p = l(a, c.x + c.w + 1, c.y + c.h - b)).h)
            ? (d[t].push({
                x: p.x,
                y: p.y,
                w: p.w,
              ...
              w.push.apply(
                w,
                n([p.x, p.y, p.w + 1, p.h + 1]).concat([c.stack])
              ),
              t > v && (v = t),
              (b += t))
            : b++
    ...
    constructor(a) {
      ...
      document.addEventListener(
        ...
        ({
          ...
          "image" === b && c
            ? this.downloadImage(c, d, e, f, null, g, h, k)
            : h ||
              ("search" === b
                ? (this.pendingSearch = null)
                : (this.pendingImage = null))
      ...
      this.fm.getFrames().forEach((q) => {
        if (q !== this) {
          ...
          t < f &&
            ...
            p.x + p.width >= b &&
            p.x <= b + d &&
            (!r || r[0] === q.frame.dataset.orien[0]) &&
            ((k = t), (c = p.y - e), (m = r = q.frame.dataset.orien))
          ...
          t < f &&
            ...
            p.x <= b + d &&
            (!r || r[0] === q.frame.dataset.orien[0]) &&
            ((l = t), (c = p.y + p.height), (m = r = q.frame.dataset.orien))
          t = Math.abs(p.x - (b + d))
          t < f &&
            (void 0 === g || t < g) &&
            p.y + p.height >= c &&
            p.y <= c + e &&
            (!n || n[1] === q.frame.dataset.orien[1]) &&
            ((g = t), (b = p.x - d), (m = n = q.frame.dataset.orien))
          ...
          t < f &&
            ...
            p.y <= c + e &&
            (!n || n[1] === q.frame.dataset.orien[1]) &&
            ((h = t), (b = p.x + p.width), (m = n = q.frame.dataset.orien))
        }
      })
      return [b, c, m]
    }
  ...
  class GPTimelapsePlayer_ extends EventTarget {
    ...
    constructor(
      ...
      k = GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE,
      l = !1
    ) {
      super()
      ...
      function a(f) {
        ...
        if (!this.cache[f]) {
          ...
          self.background &&
            ...
            (n = h.getImageData(0, 0, g.width, g.height)),
  ...
  class GPModeration_ extends EventTarget {
    ...
    static SETTINGS_UI = {
      ...
      copyUsernamesWithClick: {
        type: "switch",
        description:
          "\u041a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0438\u043c\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0438 \u043f\u0440\u0438 \u043d\u0430\u0436\u0430\u0442\u0438\u0438 \u043d\u0430 \u0435\u0433\u043e \u043d\u0438\u043a \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0435 \u0438\u043b\u0438 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u043e\u0432",
      },
      _1: { text: "Interface" },
      compactMode: {
        type: "switch",
      ...
      disableLocalizedTwitchUsernames: {
        type: "switch",
        description:
          "\u0417\u0430\u043c\u0435\u043d\u044f\u0442\u044c \u043a\u0438\u0442\u0430\u0439\u0441\u043a\u0438\u0435, \u044f\u043f\u043e\u043d\u0441\u043a\u0438\u0435 \u0438 \u043a\u043e\u0440\u0435\u0439\u0441\u043a\u0438\u0435 \u0438\u043c\u0435\u043d\u0430 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0435\u0439 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0438 \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0430\u0445 \u043d\u0430 \u0438\u043c\u0435\u043d\u0430 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u043e\u0432",
      },
      _2: { text: "Censor Content" },
      censorDrawings: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0440\u0438\u0441\u0443\u043d\u043a\u0438 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0432\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0445 \u0432 \u0447\u0451\u0440\u043d\u044b\u0439 \u0441\u043f\u0438\u0441\u043e\u043a",
      },
      censorSentences: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u044f \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0432\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0445 \u0432 \u0447\u0451\u0440\u043d\u044b\u0439 \u0441\u043f\u0438\u0441\u043e\u043a",
      },
      censorNicknames: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0438\u043c\u0435\u043d\u0430 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0432\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0445 \u0432 \u0447\u0451\u0440\u043d\u044b\u0439 \u0441\u043f\u0438\u0441\u043e\u043a",
      },
      ...
      safeMode: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0440\u0438\u0441\u0443\u043d\u043a\u0438 \u0432\u0441\u0435\u0445 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0438\u0445 \u043c\u043e\u0436\u043d\u043e \u043f\u0440\u043e\u0441\u043c\u0430\u0442\u0440\u0438\u0432\u0430\u0442\u044c \u0447\u0435\u0440\u0435\u0437 \u043f\u0430\u043d\u0435\u043b\u044c \u043f\u0440\u0435\u0434\u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430 \u043f\u0435\u0440\u0435\u0434 \u043e\u0442\u043a\u0440\u044b\u0442\u0438\u0435\u043c \u043d\u0430 \u0442\u0440\u0430\u043d\u0441\u043b\u044f\u0446\u0438\u0438)",
      },
      _4: { text: "Twitch Integration" },
      userBansSyncWithTwitch: {
        type: "switch",
        description:
          "\u0411\u0430\u043d\u0438\u0442\u044c/\u0440\u0430\u0437\u0431\u0430\u043d\u0438\u0432\u0430\u0442\u044c \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u043d\u0430 Twitch \u043f\u0440\u0438 \u0431\u0430\u043d\u0435/\u0440\u0430\u0437\u0431\u0430\u043d\u0435 \u0432 \u0438\u0433\u0440\u0435",
      },
      _5: { text: "Reports" },
      sendBanReports: {
        type: "switch",
        description:
          "\u041e\u0442\u0441\u044b\u043b\u0430\u0442\u044c \u043e\u0442\u0447\u0451\u0442\u044b, \u0441\u043e\u0434\u0435\u0440\u0436\u0430\u0449\u0438\u0435 \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044e \u043e \u0440\u0438\u0441\u0443\u043d\u043a\u0435 \u0438 \u0430\u0432\u0442\u043e\u0440\u0435, \u043f\u0440\u0438 \u0431\u043b\u043e\u043a\u0438\u0440\u043e\u0432\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u0430 \u0447\u0435\u0440\u0435\u0437 \u043d\u0430\u0436\u0430\u0442\u0438\u0435 \u043d\u0430 \u0430\u0432\u0430\u0442\u0430\u0440 \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0435",
      },
    }
    ...
    constructor(a, b) {
      ...
      this.preview.addEventListener("status", ({ detail: { status: c } }) => {
        this.s.previewEnabled = c
      })
      this.preview.addEventListener("panel-pos-changed", ({ detail: c }) => {
      ...
      this.newAccountLabels = this.l.NEW_ACCOUNT_AGE_LBLS.split("|").map((c) =>
        c.split(",")
      )
      ...
      this.preventAlbumContentInteraction =
        this.preventAlbumContentInteraction.bind(this)
      ...
      this.painterHeaderTextOverHandler =
        this.painterHeaderTextOverHandler.bind(this)
      this.painterHeaderTextDownHandler =
        this.painterHeaderTextDownHandler.bind(this)
      this.gpproxy.addEventListener("data", ({ detail: { event: c } }) => {
        if (this.gpproxy.isAuthorized || this.gpproxy.isTwitchOAuth)
          c === GPProxy_.EVENT.GAME_STARTED
            ? this.gpproxy.isAuthorized && this.parseUnknownUsers()
            : c === GPProxy_.EVENT.TURNS_ENDED
            ? this.gpproxy.isHost() && this.injectSafeModeControl()
            : c === GPProxy_.EVENT.GALLERY_SETTINGS &&
              (this.gpproxy.addWSMsgMiddleware(
                [GPProxy_.EVENT.ALBUM_ITEM, GPProxy_.EVENT.ALBUM_INFO],
                this.middleware
            ...
            this.isMiddlewareActive &&
              ...
              (this.gpproxy.removeWSMsgMiddleware(this.middleware),
              (this.isMiddlewareActive = !1),
              this.terminate())
      })
      this.gpproxy.addEventListener("rejoin", ({ detail: { stage: c } }) => {
      ...
      this.gpproxy.addEventListener("albums_ended", () => {
        if (this.gpproxy.isAuthorized && this.gpproxy.isHost()) {
          var c = this.gpproxy
            ...
            .filter(
              ({ nick: d, viewer: e }) =>
                !this.gpproxy.isYou(d) &&
                !e &&
                !this.banlist.has(this.gpproxy.formatNickname(d))
            )
            .map((d) => d.nick)
      ...
      this.gpproxy.addEventListener("player_joined", ({ detail: c }) => {
        this.clearPlayers([c])
      ...
      document.addEventListener(
        "_tw_users_data",
        ({ detail: { userDatesCreated: c, followers: d, subscribers: e } }) => {
          ...
          this.s.twitchFollowerBadges || this.s.twitchSubscriberBadges
            ...
            : Object.keys(c).length &&
              this.gpproxy.getUsers().forEach((f) => {
                this.gpproxy.formatNickname(f.nick) in c &&
                  this.isNewAccount(f.nick) &&
                  this.updatePlayerItem(f.nick)
              })
        }
      )
      document.addEventListener(
        "_tw_ids_usernames",
        ({ detail: { usernamesMap: c, localizedLoginsMap: d } }) => {
          this.updateUserIdsCache(c)
          this.updateLocalizedLogins(d)
          d.size &&
            (this.gpproxy.getUsers().forEach((e) => {
    ...
    renderBanlist() {
      ...
      this.banlist.size
        ? this.banlist.forEach((d) => {
            ...
            if (
              ...
              var g = this.localizedLogins.get(
                this.gpproxy
                  .getUsers()
                  .find((k) => this.gpproxy.formatNickname(k.nick) === d)?.nick
              )
              g && ((e = g), (f = !0))
            }
        ...
        : ((c = document.createElement("div")),
          ...
          (c.textContent = this.l.BANLIST_EMPTY_LBL),
          b.appendChild(c))
    ...
    renderUser(a) {
      ...
      c.appendChild(d)
      this.gpproxy.isAuthorized &&
        ((c = this.gpproxy.formatNickname(a.nick)),
    ...
    isUserBanned({ nick: a, id: b }) {
      return a && b
        ? !this.gpproxy.isYou(b) &&
            this.banlist.has(this.gpproxy.formatNickname(a))
        : !1
    }
    clearPlayers(a) {
      this.gpproxy.isHost() &&
    ...
    findNickname(a) {
      return this.gpproxy
        .getUsers()
        .find((b) => a === this.gpproxy.formatNickname(b.nick))?.nick
    }
    middleware([a, b]) {
      if (
      ...
      if (a[1] === GPProxy_.EVENT.ALBUM_ITEM && a[2].active) {
        if (
          ...
          if (a[2].data?.length)
            ...
            this.gpproxy.isGameOrder(
              GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND
            ) &&
              this.s.censorDrawings &&
              a[2].bg &&
              ((a[2].data = this.gpproxy.getAlbum().background),
              (a[2].bg = !1),
        ...
        const c =
          ...
          this.isUserBanned(this.gpproxy.getAlbum().bookAuthor) &&
          this.s.censorDrawings
        a[2].timeline?.length &&
          (a[2].timeline = a[2].timeline.map((d) => {
            c &&
              d.bg &&
              ((d.data = this.gpproxy.getAlbum().background),
              (d.bg = !1),
              (b = !0))
            return d
          }))
    ...
    shouldByCensoredByBackground(a) {
      return (this.gpproxy.isGameOrder(
        GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND_NO_PREVIEW
      ) ||
        (this.gpproxy.isGameOrder(
          GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND
    ...
    toggleUserBan(a) {
      const b = this.gpproxy.formatNickname(a),
    ...
    getContentId(a) {
      return this.gpproxy.isGameStage(GPProxy_.GAME_STAGE.ALBUM)
        ? `${this.gpproxy.getCurrentAlbumId()}_${this.getItemId(a)}`
    ...
    requestTwitchUsersData(a) {
      if (this.gpproxy.isHost() && this.gpproxy.isTwitchAuth()) {
        var b = a
          .filter(
            (d) => !this.gpproxy.isYou(d.nick) && !this.gpproxy.isViewer(d)
          )
          .map((d) => this.gpproxy.formatNickname(d.nick))
    ...
    albumItemEnterHandler(a) {
      if (
        ...
        if ((a = this.gpproxy.getAlbumItem(b)))
          (b = `${this.gpproxy.getCurrentAlbumId()}_${b}`),
    ...
    acTriggerHandler({ detail: { itemId: a, albumId: b } }) {
      this.gpproxy.getCurrentAlbumId() === b &&
      ...
      if (!this.inGallerySettingsObserving) {
        ...
        a
          ? (new MutationObserver(
              this.gallerySettingsObserverCallback.bind(this)
            ).observe(a, { childList: !0, subtree: !0 }),
            (this.inGallerySettingsObserving = !0))
          : setTimeout(() => {
    ...
    gallerySettingsObserverCallback(a, b) {
      for (const c of a)
        "childList" === c.type &&
          c.addedNodes[0]?.classList.contains("screen") &&
          ((a = c.addedNodes[0].querySelector(
            ".scrapbook .controls > section"
          )),
    ...
    updateSettings({ detail: { settings: a } }) {
      ...
      "disableLocalizedTwitchUsernames" in a &&
        ...
        (this.renderUsers(),
        this.renderBanlist(),
        this.gpproxy.isGameStages(
          GPProxy_.GAME_STAGE.LOBBY,
          GPProxy_.GAME_STAGE.ALBUM,
          GPProxy_.GAME_STAGE.SCORE
        ) && this.updatePlayerItems(),
        this.gpproxy.isGameStage(GPProxy_.GAME_STAGE.ALBUM)
          ? (this.handleAlbumHeader(),
            this.handleAlbumFooter(),
            this.handleAlbumUsernames())
          : this.gpproxy.isGameStage(GPProxy_.GAME_STAGE.SCORE) &&
            this.updateRankingUsers())
      ...
      ;[
        ...
        this.gpproxy.isGameStage(GPProxy_.GAME_STAGE.ALBUM)
          ? this.handleItems()
          : this.gpproxy.isScreen(GPProxy_.SCREEN.PAINTER) &&
        ...
        (a.twitchFollowerBadges && a.twitchSubscriberBadges) ||
          ...
          (a.twitchFollowerBadges || a.twitchSubscriberBadges) &&
            this.twitchAPI.validateToken(this.s.twitchToken2).then((b) => {
              b
                ? this.requestTwitchUsersData(this.gpproxy.getUsers())
                : this.twitchAPI.requestToken(
                    GPTwitchAPI_.TOKEN_TYPE.FOLLOWERS_SUBSCRIPTIONS
                  )
            })
  ...
  class GPPreview_ extends EventTarget {
    ...
    static ORIENTATIONS = { t: "top", b: "bottom", l: "left", r: "right" }
    static ORIENTATION = {
      TOP: "top",
      BOTTOM: "bottom",
      LEFT: "left",
    ...
    constructor(a, b, { x: c, y: d, o: e }, f, g) {
      ...
      this.gpproxy.addEventListener("data", ({ detail: { event: h } }) => {
    ...
    render() {
      ...
      this.panel.addEventListener("wheel", (b) => {
        ...
        this.updatePanelPosition()
        this.dispatchEvent(
          new CustomEvent("panel-width-changed", {
      ...
      this.panel.addEventListener("pointerdown", (b) => {
        if (0 === b.button) {
          ...
          this.panel.addEventListener(
            ...
            () => {
              this.dispatchEvent(
                new CustomEvent("panel-pos-changed", {
                  detail: {
                    x: this.panelOffsetX,
                    y: this.panelOffsetY,
    ...
    updatePanelPosition() {
      ...
      this.panelOrientation
        .split("")
        .map((c) => GPPreview_.ORIENTATIONS[c])
        .forEach((c) => {
          switch (c) {
