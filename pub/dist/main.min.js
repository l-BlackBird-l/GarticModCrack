;(function () {
  class GPUtils_ {
    static CANVAS_ID = { DEFAULT: 1, SQUARE: 2 }
    static CANVAS_TYPE = {
    ...
    static getCanvasDimensionsById(a) {
      return (
        this.CANVAS_DIMENSIONS[a] ??
        this.CANVAS_DIMENSIONS[this.CANVAS_ID.DEFAULT]
      )
    }
    ...
    static bindDeep(a, b) {
      if (a && "object" === typeof a)
        for (const c in a) {
          ...
          "function" === typeof d
            ? (a[c] = d.bind(b))
            : d && "object" === typeof d && this.bindDeep(d, b)
        }
    }
  ...
  class GPMigration_ {
    ...
    static editStorage({ insert: a, rename: b, remove: c } = {}) {
      const d = {}
      a?.forEach(([e, f, g]) => {
        d[e] ?? (d[e] = [])
    ...
    static latestVersion() {
      return (
        ...
        JSON.parse(localStorage.getItem("gp_about"))?.lastNotifiedVersion
      )
    }
    static painter105() {
      const a = JSON.parse(localStorage.getItem("gp_painter"))
      a?.defaultColor &&
        !Array.isArray(a.defaultColor) &&
        localStorage.setItem(
          "gp_painter",
          JSON.stringify(
            Object.assign(a, { defaultColor: ["#000000", "#ffffff"] })
          )
        )
    }
  }
  ...
  ;(() => {
    function a(d, e, f) {
      ...
      c.mm.setModules(
        [
          ...
          { id: 5, name: "GPAntiCheat_", hiddenSettings: !0 },
          { id: 1, name: "GPModeration_" },
          { id: 2, name: "GPPlayersManager_" },
          { id: 3, name: "GPArtBroadcaster_" },
          { id: 7, name: "GPTimer_" },
          { id: 8, name: "GPReference_" },
          { id: 4, name: "GPPainter_" },
          { id: 11, name: "GPGlobalBanlist_", required: !0 },
        ],
        this,
        c
      )
    ...
    const b = {
      ...
      betaFlag: !0,
      changelogURL:
        "https://discord.com/channels/929715202600095775/953145081471324270/1476247598611435617",
      summaryURL:
        "https://discord.com/channels/929715202600095775/929715202600095778/1476267642649182348",
      updateNoticeFlag: !0,
      updateNoticeText: "",
    ...
    if (
      ...
      console.log(
        `${b.tag} (v${b.version}${b.betaFlag ? "-beta" : ""}): loaded`
      )
  ...
  class GPAbout_ extends EventTarget {
    ...
    constructor(a) {
      ...
      document.addEventListener("_gp_notice", ({ detail: g }) => {
        this.addNotice(g)
      })
      document.addEventListener(
        "_outdated-scripts",
        ({ detail: { outdatedScripts: g } }) => {
          g.size &&
            (this.printOutdatedScripts(g),
            this.addNotice({ type: GPAbout_.NOTICE_TYPE.SCRIPTS, scripts: g }))
        }
      )
      this.render()
      this.resizeHandler()
...
showAnalyticsNotice() {
  ...
  class GPActivation_ extends EventTarget {
    ...
    constructor(a) {
      ...
      GPUtils_.bindMethods(
        [
          this.updateSubsStatus,
          this.broadcastSubsStatus,
    ...
    broadcastPublicKey() {
      document.dispatchEvent(
        new CustomEvent("gp:act.auth_key", {
    ...
    broadcastSubsStatus(a) {
      document.dispatchEvent(
        new CustomEvent("gp:act.subs_status", {
  ...
  class GPAntiCheat_ extends EventTarget {
    ...
    static SETTINGS_UI = {
      enabled: {
        type: "switch",
        description:
          "\u0410\u043a\u0442\u0438\u0432\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0410\u043d\u0442\u0438-\u0427\u0438\u0442",
      },
      activatedForOwnerOnly: {
        type: "switch",
        description:
          "\u0410\u043a\u0442\u0438\u0432\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0410\u043d\u0442\u0438-\u0427\u0438\u0442, \u0442\u043e\u043b\u044c\u043a\u043e \u0435\u0441\u043b\u0438 \u0412\u044b \u044f\u0432\u043b\u044f\u0435\u0442\u0435\u0441\u044c \u0432\u043b\u0430\u0434\u0435\u043b\u044c\u0446\u0435\u043c \u043a\u043e\u043c\u043d\u0430\u0442\u044b",
      },
      _1: { text: "Reports" },
      sendReports: {
        type: "switch",
        description:
          "\u041e\u0442\u0441\u044b\u043b\u0430\u0442\u044c \u043e\u0442\u0447\u0451\u0442\u044b \u043e \u0440\u0438\u0441\u0443\u043d\u043a\u0430\u0445, \u043f\u043e\u043c\u0435\u0447\u0435\u043d\u043d\u044b\u0435 \u0410\u043d\u0442\u0438-\u0427\u0438\u0442\u043e\u043c \u043a\u0430\u043a \u043f\u043e\u0434\u043e\u0437\u0440\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0435\n\u0412 \u0446\u0435\u043b\u044f\u0445 \u0443\u043b\u0443\u0447\u0448\u0435\u043d\u0438\u044f \u0410\u043d\u0442\u0438-\u0427\u0438\u0442\u0430",
      },
    }
    static MODULE = {
      title: "Anti-Cheat",
    ...
    constructor(a) {
      ...
      this.reportSender = new GPImageReportSender_(
        GPImageReportSender_.ANTI_CHEAT,
        this.prx,
        a.act
      )
      ...
      this.prx.addEventListener("rejoin", ({ detail: { stage: b } }) => {
        switch (b) {
          case GPProxy_.STAGE.GAME:
            this.prx.addWSMsgMiddleware(
              [GPProxy_.EVENT.TURN_STARTED],
              this.gameMiddleware
            )
          ...
          case GPProxy_.STAGE.ALBUM:
            this.prx.addWSMsgMiddleware(
              [GPProxy_.EVENT.ALBUM_ITEM, GPProxy_.EVENT.ALBUM_INFO],
              this.albumMiddleware
            ),
              (this.isAlbumMWActivated = !0)
        }
      })
      this.prx.addEventListener("data", ({ detail: { event: b } }) => {
        b === GPProxy_.EVENT.GAME_STARTED
          ...
          ? (this.prx.addWSMsgMiddleware(
            ...
            (this.isAlbumMWActivated = !0),
            this.prx.removeWSMsgMiddleware(this.gameMiddleware),
            (this.isGameMWActivated = !1))
          : this.isAlbumMWActivated &&
            [
            ...
            (this.prx.removeWSMsgMiddleware(this.albumMiddleware),
            (this.isAlbumMWActivated = !1))
      })
      document.addEventListener(
        "gp:act.subs_status",
        ({ detail: { status: b } }) => {
    ...
    gameMiddleware([a, b]) {
      if (
        !this.s.enabled ||
        (this.s.activatedForOwnerOnly && !this.prx.isHost())
      )
        return [a, b]
      if (
        a[1] === GPProxy_.EVENT.TURN_STARTED &&
        a[2].previous?.user?.id !== this.prx.getUser().id
      )
        if (
          a[2].screen === GPProxy_.SCREEN_ID.DESCRIPTION &&
          a[2].previous?.type === GPProxy_.ALBUM_ITEM_TYPE.IMAGE &&
          a[2].previous?.data?.length
        ) {
          var c = this.prx.getCurrentTurnId()
          c = this.getTriggers(
            `t_${c}`,
            a[2].previous.data,
            a[2].previous.user.nick
          )
          c.size &&
            this.isSubscribed &&
            ((a[2].previous.data = this.getPlaceholder(c)), (b = !0))
        } else
          a[2].screen === GPProxy_.SCREEN_ID.PAINTER &&
            (a[2].background?.length || a[2].lastDraw?.length) &&
            (a[2].background &&
              ((c = this.prx.getCurrentTurnId()),
            ...
            a[2].lastDraw &&
              ...
              c.size &&
                this.isSubscribed &&
                ((a[2].lastDraw = []),
                (a[2].previous.data = this.getPlaceholder(c)),
                (b = !0))))
      return [a, b]
    }
    albumMiddleware([a, b]) {
      if (
        ...
        return [a, b]
      if (
        a[1] === GPProxy_.EVENT.ALBUM_ITEM &&
        a[2].user?.id !== this.prx.getUser().id &&
        a[2].type === GPProxy_.ALBUM_ITEM_TYPE.IMAGE &&
        a[2].data
      )
        if (a[2].bg) {
          var c = a[2].id,
          ...
          e.size &&
            this.isSubscribed &&
            ((a[2].bg = !1),
            (a[2].data = this.getPlaceholder(e)),
            this.dispatchEvent(
              new CustomEvent("trigger", { detail: { itemId: c, albumId: d } })
            ),
            (b = !0))
        } else
          a[2].data?.length &&
            ((c = a[2].id),
            (d = this.prx.getCurrentAlbumId()),
            (e = this.getTriggers(`${d}_${c}`, a[2].data, a[2].user.nick)),
            e.size &&
              (this.isSubscribed &&
                ((a[2].data = this.getPlaceholder(e)),
                this.dispatchEvent(
                  new CustomEvent("trigger", {
                    detail: { itemId: c, albumId: d },
                  })
                ),
                (b = !0)),
              (!this.s.sendReports && this.isSubscribed) ||
                this.reportSender.send({ itemId: c, albumId: d, triggers: e })))
      else
        a[1] === GPProxy_.EVENT.ALBUM_INFO &&
          (a[2].background?.length &&
            a[2].bookAuthor.id !== this.prx.getUser().id &&
            ((c = this.prx.getCurrentAlbumId()),
            this.getTriggers(`${c}`, a[2].background, a[2].bookAuthor.nick)
              .size &&
              this.isSubscribed &&
              ((a[2].background = []), (b = !0))),
          a[2].timeline?.length &&
            (a[2].timeline = a[2].timeline.map((f) => {
              if (
                !f.type ||
                f.user?.id === this.prx.getUser().id ||
                f.type !== GPProxy_.ALBUM_ITEM_TYPE.IMAGE
              )
                return f
              if (f.bg) {
                ...
                g.size &&
                  this.isSubscribed &&
                  ((f.bg = !1), (f.data = this.getPlaceholder(g)), (b = !0))
              } else
                f.data?.length &&
                  ((g = this.prx.getCurrentAlbumId()),
                  (g = this.getTriggers(`${g}_${f.id}`, f.data, f.user.nick)),
                  g.size &&
                    this.isSubscribed &&
    ...
    getPlaceholder(a) {
      return this.isForgery(a)
        ? GPAssets_.AC_FORGERY_PH[this.l.lang] ??
            Object.values(GPAssets_.AC_FORGERY_PH)[0]
        : GPAssets_.AC_SUSPICIOUS_PH[this.l.lang] ??
            Object.values(GPAssets_.AC_SUSPICIOUS_PH)[0]
    }
    getTriggers(a, b, c) {
      let d = this.itemsTriggers.get(a)
      d ||
        ((d = this.calcTriggers(b, c)),
        this.itemsTriggers.set(a, d),
        d.size && this.isSubscribed && this.suspiciousItems.add(a))
      return d
    }
    calcTriggers(a, b) {
      const c = new Set()
      ...
      const { animate: e } = this.prx.getGameConfig()
      let f = 0
      var g = 0
      let h = null,
        k = null,
      ...
      for (let n = 0; n < a.length; n++) {
        ...
        if (b && this.isMStroke(u)) {
          const { code: x, author: w } = this.decodeMStroke(u)
        ...
        if (1 === v) {
          ...
          w === h && 3 > x
            ? l++
            : (l > GPAntiCheat_.SEQUENCE_MIN_SIZE &&
                ((r = Math.max(r, l)), d.push(l)),
              (l = 0))
          t === k && 3 > x
            ? m++
            : (m > GPAntiCheat_.SEQUENCE_MIN_SIZE &&
                ((q = Math.max(q, m)), p.push(m)),
              (m = 0))
          h = w
          k = t
        } else 8 === v && g++
      ...
      b = (f / a.length) * 100
      g = (g / a.length) * 100
      a.length >= GPAntiCheat_.MIN_STROKES_TRIGGER &&
        (b > GPAntiCheat_.MIN_PERCENTAGE_TRIGGER ||
          g > GPAntiCheat_.MIN_PERCENTAGE_TRIGGER) &&
        c.add(1)
      ;(d.length > GPAntiCheat_.SEQUENCES_COUNT_TRIGGER ||
        p.length > GPAntiCheat_.SEQUENCES_COUNT_TRIGGER) &&
        c.add(2)
      ;(r > GPAntiCheat_.MAX_SEQUENCE_TRIGGER ||
        q > GPAntiCheat_.MAX_SEQUENCE_TRIGGER) &&
        c.add(3)
      return c
    }
    isForgery(a) {
    ...
    isMStroke(a) {
      return !(
        1 === a[0] &&
        a[3][0] > GPAntiCheat_.CANVAS_WIDTH &&
        a[3][1] > GPAntiCheat_.CANVAS_HEIGHT
      ) ||
        a[3][0] - GPAntiCheat_.CANVAS_WIDTH - GPAntiCheat_.M_STROKE_OFFSET ||
    ...
    decodeMStroke(a) {
      const [b, c, d] = a
        ...
        .map(
          (e, f) =>
            e -
            GPAntiCheat_.M_STROKE_OFFSET -
            (f % 2 ? GPAntiCheat_.CANVAS_HEIGHT : GPAntiCheat_.CANVAS_WIDTH)
        )
        .filter(Boolean)
        .map((e) => String.fromCodePoint(e))
        .join("")
        .split("@")
      return { code: b, author: c, timestamp: d }
    }
    getSuspiciousItems() {
  ...
  class GPArtBroadcaster_ extends EventTarget {
    ...
    static SETTINGS_UI = {
      services: {
        type: "list-multiple",
        args: { items: this.SERVICES },
        description:
          "\u0421\u0435\u0440\u0432\u0438\u0441\u044b \u0434\u043b\u044f \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u0438 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432",
      },
      _1: { text: "Discord" },
      discordButtons: {
        type: "list-multiple",
        args: { items: this.DISCORD_BUTTONS },
        l10n: ["PLAYER_BTN", "SOURCE_BTN"],
        description:
          "\u041a\u043d\u043e\u043f\u043a\u0438 \u043f\u043e\u0434 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u043c \u0432 \u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0438 Discord",
      },
      discordBorderColor: {
        type: "color",
        description:
          "\u0426\u0432\u0435\u0442 \u043b\u0435\u0432\u043e\u0439 \u0440\u0430\u043c\u043a\u0438 \u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u044f \u0441 \u043e\u043f\u0443\u0431\u043b\u0438\u043a\u043e\u0432\u0430\u043d\u043d\u044b\u043c \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u043c",
      },
      discordBotToken: {
        type: "input",
        args: { secure: !0 },
      ...
      discordServerID: {
        type: "input",
        description:
          "ID Discord-\u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u0434\u043b\u044f \u043f\u043e\u043b\u0443\u0447\u0435\u043d\u0438\u0438 \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u0438 \u043e\u0431 \u0430\u0432\u0442\u043e\u0440\u0438\u0437\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u044b\u0445 \u0438\u0433\u0440\u043e\u043a\u0430\u0445",
      },
      discordArtsChannelID: {
        type: "input",
        description:
          "ID \u043a\u0430\u043d\u0430\u043b\u0430 \u0434\u043b\u044f \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u0438 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432",
      },
      discordPlayerChannelID: {
        type: "input",
        description:
          "ID \u043a\u0430\u043d\u0430\u043b\u0430 \u0434\u043b\u044f \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u0438 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432 \u0441 \u0441\u0441\u044b\u043b\u043a\u043e\u0439 \u043d\u0430 \u043f\u043b\u0435\u0435\u0440 \u0438 \u0438\u0441\u0445\u043e\u0434\u043d\u0438\u043a",
      },
      discordArchiveChannelID: {
        type: "input",
        hidden: !0,
        description:
          "ID \u043a\u0430\u043d\u0430\u043b\u0430 \u0434\u043b\u044f \u0438\u0441\u0445\u043e\u0434\u043d\u0438\u043a\u043e\u0432 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432",
      },
      _2: { text: "Telegram" },
      telegramBotToken: {
        type: "input",
      ...
      telegramChannel: {
        type: "input",
        description:
          "\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u0438\u043b\u0438 ID \u043a\u0430\u043d\u0430\u043b\u0430 (\u0432 \u0444\u043e\u0440\u043c\u0430\u0442\u0435 @channel_name)",
      },
      telegramPlayerButton: {
        type: "switch",
        description:
          "\u0414\u043e\u0431\u0430\u0432\u043b\u044f\u0442\u044c \u043a\u043d\u043e\u043f\u043a\u0443 \u0434\u043b\u044f \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430 \u043f\u0440\u043e\u0446\u0435\u0441\u0441\u0430 \u0440\u0438\u0441\u043e\u0432\u0430\u043d\u0438\u044f \u0432 \u043f\u043b\u0435\u0435\u0440\u0435",
      },
      telegramSourceButton: {
        type: "switch",
        description:
          "\u0414\u043e\u0431\u0430\u0432\u043b\u044f\u0442\u044c \u043a\u043d\u043e\u043f\u043a\u0443 \u0434\u043b\u044f \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0438\u044f \u0438\u0441\u0445\u043e\u0434\u043d\u0438\u043a\u0430 \u0440\u0438\u0441\u0443\u043d\u043a\u0430",
      },
      _3: {
        text: "VK (\u0412 \u041a\u043e\u043d\u0442\u0430\u043a\u0442\u0435)",
      },
      ...
      vkGroupID: {
        type: "input",
        description:
          "ID \u0433\u0440\u0443\u043f\u043f\u044b \u0438\u043b\u0438 \u0441\u043e\u043e\u0431\u0449\u0435\u0441\u0442\u0432\u0430 \u0441 \u0430\u043b\u044c\u0431\u043e\u043c\u043e\u043c \u0434\u043b\u044f \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u0438 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432",
      },
      vkAlbumID: {
        type: "input",
        description:
          "ID \u0430\u043b\u044c\u0431\u043e\u043c\u0430 \u0434\u043b\u044f \u043f\u0443\u0431\u043b\u0438\u043a\u0430\u0446\u0438\u0438 \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432",
      },
      vkPhotoDescription: {
        type: "input",
        description:
          "\u0428\u0430\u0431\u043b\u043e\u043d \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u044f \u0440\u0438\u0441\u0443\u043d\u043a\u0430 \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0435 VK. \u041f\u043e\u0434\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0435\u043c\u044b\u0435 \u043f\u0435\u0440\u0435\u043c\u0435\u043d\u043d\u044b\u0435: {author}, {date}",
      },
    }
    static MODULE = {
    ...
    constructor(a) {
      ...
      this.prx.addEventListener(
        "album_item",
        ({ detail: { itemId: b, albumId: c, item: d } }) => {
    ...
    init() {
      document.addEventListener(
        "gp:ab.send_image_complete",
        this.sendResultHandler
      )
      document.dispatchEvent(
        new CustomEvent("gp:ab.update_urls_avatars_cache", {
          detail: {
    ...
    renderButton(a, b, c) {
      if (b.type === GPProxy_.ALBUM_ITEM_TYPE.IMAGE) {
        ...
        d.addEventListener("click", (f) => {
          ...
          f.ctrlKey
            ? (GPArtBroadcaster_.SERVICES.forEach((g) => {
                delete d.dataset[g]
              }),
              this.sendImage(this.s.services, b, c, d))
            : ((f = this.s.services.filter((g) => {
    ...
    observerCallback(a, b) {
      for (const d of a)
        if (
          ...
          d.addedNodes.length &&
          ((a = d.addedNodes[0]),
          d.target.classList.contains("scrollElements") &&
            a.classList.contains("item"))
        ) {
          var c = this.prx.getCurrentAlbumId()
          b = this.nextItemID
          null === b &&
            ((b = [...a.parentElement.children]
              .filter((e) => e.classList.contains("item"))
              .indexOf(a)),
            (c = this.timeline[c]?.[b]) && this.renderButton(a, c, b))
          this.itemsElems[b] = a
        }
    }
    sendImage(a, b, c, d) {
      const { data: e, background: f, canvasTypeId: g, meta: h } = b,
      ...
      m.toBlob(async (v) => {
        ...
        document.dispatchEvent(
          new CustomEvent("gp:ab.send_to_media", {
            detail: {
              services: a,
              artFile: v,
              sourceFile: x,
    ...
    sendResultHandler({
      detail: { service: a, success: b, albumId: c, itemId: d },
    }) {
      ...
      if (c === this.prx.getCurrentAlbumId()) {
        ...
        g &&
          (e.classList.remove("uploading_"), f && e.classList.add("complete_"))
      }
    }
    setState(a, b, c, d) {
      let e, f
    ...
    setInitialButtonState(a, b) {
      ...
      this.s.services.length &&
      this.s.services.every((d) => "true" === a.dataset[d])
        ? a.classList.add("complete_")
        : a.classList.remove("hidden")
    }
    emitSettings() {
      document.dispatchEvent(
        new CustomEvent("gp:ab.update_settings", {
          detail: { settings: window.structuredClone(this.settings) },
        })
      )
    }
    toggleSendButtons(a) {
      ;(a = (a?.detail?.settings || this.settings).services) &&
        this.gpContent.classList.toggle("gp-sm-hidden_", !a.length)
    }
  ...
  GPAssets_.GIRL_PORTRAIT = [
    ...
    [1, 6, ["#000000", 2, 1], [216, 207], [217, 208]],
    [
      1,
      7,
      ["#000000", 2, 1],
    ...
    [1, 8, ["#000000", 2, 1], [246, 209], [247, 211], [248, 213], [248, 214]],
    [
      1,
      9,
      ["#000000", 2, 1],
    ...
    [1, 45, ["#000000", 2, 1], [193, 192], [194, 192], [195, 191], [196, 191]],
    [
      1,
      46,
      ["#000000", 2, 1],
    ...
    [1, 84, ["#000000", 2, 1], [203, 297], [204, 297], [205, 297], [207, 297]],
    [
      1,
      85,
      ["#000000", 2, 1],
    ...
    [1, 86, ["#000000", 2, 1], [198, 289], [198, 290], [198, 294], [199, 296]],
    [
      1,
      87,
      ["#000000", 2, 1],
    ...
    [1, 96, ["#000000", 2, 1], [199, 282], [198, 284], [198, 285], [197, 285]],
    [
      1,
      97,
      ["#000000", 2, 1],
    ...
    [1, 99, ["#000000", 2, 1], [192, 283], [193, 279], [193, 280], [193, 282]],
    [
      1,
      100,
      ["#000000", 2, 1],
    ...
    [1, 125, ["#000000", 2, 1], [236, 328], [235, 329], [234, 330]],
    [
      1,
      126,
      ["#000000", 2, 1],
    ...
    [1, 129, ["#000000", 2, 1], [242, 330], [243, 330], [246, 328], [247, 328]],
    [
      1,
      130,
      ["#000000", 2, 1],
    ...
    [4, 131, ["#000000", 1, 1], [98, 95], [300, 331]],
    [
      1,
      132,
      ["#000000", 2, 1],
    ...
    [1, 133, ["#000000", 2, 1], [220, 323], [221, 323], [222, 323]],
    [
      1,
      134,
      ["#000000", 2, 1],
    ...
    [1, 174, ["#99BCFF", 6, "0.59"], [108, 185], [107, 185]],
    [
      1,
      175,
      ["#99BCFF", 6, "0.59"],
  ...
  GPAssets_.AC_FORGERY_PH = {
    ...
    en: [
      ...
      [1, 46, ["#cc6969", 4, 1], [427, 210], [437, 210], [442, 210]],
      [
        1,
        49,
        ["#cc6969", 4, 1],
  ...
  class GPAvatarEditor_ extends EventTarget {
    ...
    render(a) {
      ...
      this.source.addEventListener("pointerdown", (g) => {
      ...
      this.zoomer = new GPCanvasZoomer_(
        this.source,
        null,
      ...
      this.submitStatus.addEventListener("animationend", (g) => {
        "av_fade-out_" === g.animationName &&
          (this.submitStatus.classList.remove("fade-out_"),
    ...
    showSuccessMessage(a) {
      ...
      if ("review" === a) {
        ...
        this.submitStatus.innerHTML = `<div class="message_">${this.l.REQUEST_SUBMITTED}</div>`
    }
    showErrorMessage(a) {
      this.submitStatus.dataset.status = "error"
      const b = this.l.REQUEST_FAILED_HINT.replace(
        "discord.com",
        '<a href="https://discord.com" target="_blank" rel="noreferrer">$&</a>'
      )
      this.submitStatus.innerHTML = `<div class="message_">${
        "review" === a ? this.l.AVATAR_FAILED : this.l.REQUEST_FAILED
      }<div class="hint_">${b}</div></div>`
    }
    clearSubmitMessage() {
      delete this.submitStatus.dataset.status
    }
    buildAvatar() {
      ...
      f.fill()
      ;(this.hasForeground || this.isNativeAvatar) &&
        f.fillRect(0, 0, b, c - b / 2)
      f = document.createElement("canvas")
      f.width = b
      f.height = c
      const g = f.getContext("2d")
      g.fillStyle = this.isNativeAvatar
        ? "rgb(234, 241, 253)"
        : this.backgroundColor
      g.beginPath()
    ...
    updateViewfinderFocus() {
      ...
      e.fill()
      ;(this.hasForeground || this.isNativeAvatar) &&
        e.fillRect(0, 0, a, b - a / 2)
      this.focusCtx.clearRect(0, 0, a, b)
      this.focusCtx.fillStyle = this.isNativeAvatar
        ? "rgb(234, 241, 253)"
        : this.backgroundColor
    ...
    setNativeAvatar(a, b) {
      ...
      this.zoomer.matrix = this.zoomer.matrix.translate(
        0,
        -(
          (((GPAvatarEditor_.AVATAR_HEIGHT - GPAvatarEditor_.AVATAR_WIDTH) *
            GPAvatarEditor_.AVATAR_DENSITY) /
            2 /
            4) *
          3
    ...
    dispatchChange(a) {
      !this.isChanged ||
        (this.isNativeAvatar && a !== GPAvatarEditor_.CHANGE.LOADED) ||
    ...
    setBackground(a, b = !0) {
      ...
      this.dispatchEvent(
        new CustomEvent("background_color_changed", {
    ...
    setForegroundState(a) {
      a !== this.hasForeground &&
        ...
        this.dispatchEvent(
          new CustomEvent("foreground_mode_changed", {
    ...
    setOpaqueBackgroundState(a) {
      ...
      this.dispatchEvent(
        new CustomEvent("opaque_bg_blocker_update", { detail: { state: a } })
      )
    }
    hasOpaqueBackground() {
  ...
  class GPAvatars_ extends EventTarget {
    ...
    static SETTINGS_UI = {
      ...
      imageSmoothing: {
        type: "switch",
        description:
          "\u0412\u043a\u043b\u044e\u0447\u0438\u0442\u044c \u0441\u0433\u043b\u0430\u0436\u0438\u0432\u0430\u043d\u0438\u0435 \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f",
      },
    }
    ...
    static getButtons() {
      return [
        GPAvatars_.instance.reviewBtn,
        GPAvatars_.instance.nativeAvatarsBtn,
      ]
    }
    static MODULE = {
      title: "Avatars",
    ...
    constructor(a) {
      ...
      this.nativeAvatarsBtn.addEventListener(
        "click",
        this.openNativeAvatarsPanel
      )
      this.prx.isAuthorized &&
        this.initInitialState(this.prx.getAuthType(), this.prx.getUsername())
      const b = new GPContentObserver_(a.prx)
      this.prx.isAuthorized &&
        (b.addPlayerListHandler(this.handlePlayer),
        b.addAlbumItemsHandler(this.handleAlbumItem),
        b.addAlbumRankingHandler(this.handlePlayer),
        b.getPlayerItems().forEach((c) => {
          this.handlePlayer(c)
        }))
      this.mm.addEventListener(
        "modules_loaded",
        ({ detail: { isSubscribed: c } }) => {
          c &&
            this.prx.isTwitchOAuth &&
            (b.addPlayerListHandler(this.handlePlayer),
            b.addAlbumItemsHandler(this.handleAlbumItem),
            b.addAlbumRankingHandler(this.handlePlayer),
            ...
            (c = b.getPlayerItems().get(this.prx.getNickname())) &&
              this.handlePlayer(c),
            b.getAlbumItems().forEach((d) => {
      ...
      document.addEventListener("gp:av.failed", ({ detail: { type: c } }) => {
        this.reviewBtn.classList.remove("loading_")
        this.reviewBtn.classList.remove("disabled_")
      ...
      if (!this.nativeAvatarsPanel) {
        ...
        a.addEventListener("click", (c) => {
          if (c.target.matches(".avatar_")) {
            ...
            d.complete &&
              0 < d.naturalWidth &&
              this.setNativeAvatar(d, c.target.dataset.id)
          }
        })
        a.appendChild(b)
        this.nativeAvatarsPanel = GPModalManager_.createModal(
          "native-avatars",
          {
    ...
    async getLatestNativeAvatarId() {
      ...
      do {
        ...
        b = (await fetch(b, { method: "HEAD" })).status
      } while (404 !== b)
      return a - 1
    }
    setNativeAvatar(a, b) {
    ...
    sendRequest(a, b, c) {
      if (this.isSubscribed) {
        var { authId: d, nick: e } = this.prx.getUser(),
        ...
        document.dispatchEvent(
          new CustomEvent("gp:av.submit", {
            detail: {
              type: a,
              imageFile: h,
              avatarId: c,
              meta: { sender: e, senderId: d, keyHash: g, service: f },
            },
          })
        )
      }
    ...
    handlePlayer(a) {
      ...
      this.prx.isTwitchOAuth
        ? a === this.prx.getNickname() &&
          this.insertAvatar(this.prx.twitchOAuthLogin, b)
        : ((a = this.prx.formatNickname(a)), this.insertAvatar(a, b))
    }
    handleAlbumItem(a) {
      const b = a.querySelector(".avatar > span")
      a = a.querySelector(
        ":scope :is(.answerBalloon, .drawBalloon) > div:not(.avatar) > span"
      )?.textContent
      this.prx.isTwitchOAuth
        ? a === this.prx.getNickname() &&
          this.insertAvatar(this.prx.twitchOAuthLogin, b)
      ...
      if (this.baseUrl)
        if (this.pendingStates.has(a)) {
          const c = ({ detail: { username: d, url: e, isExists: f } }) => {
            d === a &&
              (f && b?.(e), this.removeEventListener("state_changed", c))
          }
  ...
  class GPCanvasZoomer_ extends EventTarget {
    ...
    initEvents() {
      ...
      this.canvas.addEventListener("pointerdown", (a) => {
        0 !== a.button || a.ctrlKey
          ? 2 === a.button && this.reset()
          : (this.canvas.setPointerCapture(a.pointerId),
            (this.dragStartPoint = this.getTransformedPoint(
              a.offsetX,
              a.offsetY
            )))
      })
      this.canvas.addEventListener("pointermove", (a) => {
        ...
        this.dragStartPoint &&
          ((a = this.getTransformedPoint(this.lastX, this.lastY)),
          (this.matrix = this.matrix.translate(
            a.x - this.dragStartPoint.x,
            a.y - this.dragStartPoint.y
          )),
          this.redraw())
      })
      ...
      this.canvas.addEventListener(
        ...
        (a) => {
          ...
          const b =
            this.scaleFactor *
            (a.ctrlKey ? 100 : a.shiftKey ? 10 : a.altKey ? 0.1 : 1)
    ...
    mirror() {
      if (this.image) {
        var a = this.getTransformedPoint(
          this.canvas.width / 2,
  ...
  class GPApp_ {
    static setTooltip(a, b) {
      ...
      c ||
        ((c = document.createElement("div")),
        (c.className = "gp-ui-tooltip_"),
        document.body.appendChild(c),
        (window.gpSettingsTooltip = c))
      ...
      c.innerHTML = ""
      c.appendChild(d)
      const { x: e, y: f, width: g, height: h } = b.getBoundingClientRect()
      ;({ height: a } = c.getBoundingClientRect())
      const k = (b = f - (a - h) / 2),
            ...
            if (e.addedNodes.length) {
              ...
              if (c !== this.currentScreen) {
                ...
                this.areModulesLoaded &&
                  this.emitScreenChange(this.currentScreen)
                break
              }
            }
        }),
        b = document.querySelector("#content > .screen")
      a.observe(b, { childList: !0 })
    }
    findCurrentScreen(a) {
      a ??= document.querySelector("#content > .screen")
      return a
        ? [...a.firstElementChild.firstElementChild.classList].find(
            (b) => !b.startsWith("jsx-")
          )
        : null
    }
    ...
    observe(a) {
      Object.values(this.observers).forEach((b) => {
        if (b.screens.includes(a)) {
          ...
          c &&
            (b.observer && b.observer?.observe(c, b.config), c && b.handler(c))
        }
      })
    }
    ...
    playerListCallback(a, b) {
      for (const c of a)
        if (
          ...
          d &&
            (this.cachePlayer(d), this.playerListHandlers.forEach((e) => e(d)))
        }
    }
    ...
    injectAlbumItemMetadata(a) {
      const b =
        ...
        [...a.parentElement.children]
          ...
          .indexOf(a)
      let c = null
      a.querySelector(":scope > .drawingmode > .drawing")
  ...
  class GPImageReportSender_ extends EventTarget {
    ...
    static BAN = "BAN"
    static EVENTS = { ANTI_CHEAT: "gp:ac.report", BAN: "gp:mod.ban_report" }
    static COLORS = { ANTI_CHEAT: 5358253, BAN: 12467260 }
    static ITEM_TYPE = { IMAGE: 1, TEXT: 2 }
    constructor(a, b, c) {
      super()
      this.prx = b
      ...
      document.addEventListener(
        "gp:tw.ids_usernames",
        ({ detail: { usernamesMap: d } }) => {
          this.updateTwitchIdsCache(d)
        }
      )
      this.prx.addEventListener("data", ({ detail: { event: d } }) => {
        d === GPProxy_.EVENT.GALLERY_SETTINGS && this.reportedItems.clear()
      })
    }
    async send({ itemId: a, albumId: b, ...c }) {
      var d = `${b}_${a}`
      if (!this.reportedItems.has(d)) {
        ...
        if (e) {
          ...
          d = { first: f, turns: g, animate: h, keep: k }
          var { authId: l, nick: m } = this.prx.getUser(),
            {
              meta: { author: p, title: r, date: q },
              data: n,
              type: u,
            } = e,
          ...
          switch (u) {
            ...
            case GPImageReportSender_.ITEM_TYPE.TEXT:
              ;(w = `${p} - ${n} (${v})`),
                (v = new Blob([n], { type: "text/plain" })),
                (w = new File([v], `${w}.txt`))
          }
          v = Object.keys(GPProxy_.AUTH_TYPE_IDS).find(
            (D) => GPProxy_.AUTH_TYPE_IDS[D] === e.auth
          )
          var t = this.prx.isTwitchAuth()
            ? this.twitchIdsCache.get(p.toLowerCase()) ?? null
            : null
          document.dispatchEvent(
  ...
  class GPLocalization_ {
    ...
    getDefaultData() {
      return { lang: this.getDefaultLanguage(), entries: {} }
    }
    getDefaultLanguage() {
      const a = window.navigator.language.split("-")[0].toLowerCase()
      return a.toUpperCase() in GPLocalization_.LANGUAGE
        ? a
        : GPLocalization_.DEFAULT_LANGUAGE
    }
    initEntries(a = {}) {
      return new Proxy(a, {
        get: (b, c) =>
    ...
    init(a) {
      this.loaded = !!a
      const { lang: b, entries: c } = a ?? this.getDefaultData()
      this.lang = b
  ...
  class GPGlobalBanlist_ extends EventTarget {
    ...
    clearPlayersByGlobalBanlist() {
      this.prx.isHost() &&
        this.prx.isTwitchAuth() &&
        this.prx.isGameStage(GPProxy_.GAME_STAGE.LOBBY) &&
        this.prx.getUsers().forEach((a) => {
          !this.prx.isYou(a.nick) &&
            this.globalBanlist.has(this.prx.formatNickname(a.nick)) &&
            this.prx.kickPlayer(a.id)
        })
    }
    ...
    requestIdsUsernames(a) {
      this.prx.isHost() &&
        ...
        ((a = a
          .filter(
            (b) =>
              !this.twitchCachedUsers.has(this.prx.formatNickname(b.nick)) &&
              !this.prx.isYou(b.nick) &&
              !this.prx.isViewer(b)
          )
          .map((b) => this.prx.formatNickname(b.nick))),
        a.length &&
          document.dispatchEvent(
    ...
    constructor() {
      function a(d) {
        ...
        if (d.charAt(++e)) {
          ...
          if (!1 === k || (f.type !== c.ERROR && !Array.isArray(k)))
    ...
    constructor() {
      ...
      function b(e, f, g) {
        ...
        for (var h = []; 0 < e.byteLength; ) {
          for (
            var k = new Uint8Array(e), l = 0 === k[0], m = "", p = 1;
            255 !== k[p];
            p++
          ) {
          ...
          if (l)
            try {
              ...
              for (l = new Uint8Array(k), k = "", p = 0; p < l.length; p++)
                k += String.fromCharCode(l[p])
            }
          h.push(k)
          e = e.slice(m)
        }
  ...
  class GPProxy_ extends EventTarget {
    ...
    constructor(a) {
      ...
      document.addEventListener(
        ...
        ({ detail: { encodedPacket: b } }) => {
          b &&
            3 < b.length &&
            (b = this.parser.decode(b)) &&
            this.wsSendHandler(b)
        }
      )
      document.addEventListener(
        "_onmessage_intercept",
        ({ detail: { handler: b, e: c } }) => {
            ...
            if ("string" !== typeof c.data) b(c)
              ...
              if (void 0 !== e && this.wsMsgMiddlewares.has(+e)) {
                ...
                if (g) {
                  ...
                  k
                    ? ((f = this.encodePacket(h, !!d)),
                      (c = this.buildMessageEvent(c, f)),
                      b(c))
                    : b(c)
                } else b(c)
              } else b(c)
      ...
      this.requestLocalization("draw")
        .then(({ data: b, type: c }) => {
          ...
          this.dispatchEvent(
            new CustomEvent("localization", { detail: { data: b, type: c } })
          )
        })
        .catch(({ error: b, type: c }) => {
          console.error(b)
          this.localization[c] = {}
        })
    }
    ...
    rejoinHandler({ detail: { path: a } }) {
      if (this.rejoinFlag) {
        ...
        this.rejoinEvent = new CustomEvent("rejoin", {
          detail: { stage: c?.toLowerCase(), path: a },
        })
    ...
    requestAuthId() {
      document.dispatchEvent(
        new CustomEvent("gp:prx.auth_id", {
          detail: {
    ...
    isSoloGame() {
      return (
        this.state.screen === GPProxy_.SCREEN_ID.PAINTER &&
    ...
    requestLocalization(a) {
      return new Promise((b, c) => {
        if (window.__NEXT_DATA__) {
          const d =
            window.__NEXT_DATA__ instanceof Element
              ? JSON.parse(window.__NEXT_DATA__.textContent)
              : window.__NEXT_DATA__
          fetch(
            `${location.origin}/_next/data/${d.buildId}/${d.locale}/${a}.json`
          )
            .then((e) => e.json())
            .then((e) => {
              ;(e = e.pageProps?.texts?.page)
                ? b({ data: e, type: a })
        ...
        } else c({ error: "__NEXT_DATA__ is undefined", type: a })
      })
    }
  }
  ...
  class GPFloatManager_ {
    ...
    constructor() {
      ...
      this.initialAnchors = { x: "left", y: "top" }
      this.handlePointerMove = this.handlePointerMove.bind(this)
      this.handlePointerUp = this.handlePointerUp.bind(this)
    }
    promote(a) {
      this.lastPromotedElement === a
        ? (this.activeElement = a)
        : (this.highestZ++,
          (a.style.zIndex = this.highestZ),
          (this.lastPromotedElement = this.activeElement = a))
    }
    grab(a, b) {
      this.promote(a)
      ...
      if (a.computedStyleMap) {
        ...
        (d = a.style.position),
          ...
          (e = "auto" !== e.right),
          (a.style.position = d)
      this.initialAnchors = { x: e ? "right" : "left", y: c ? "bottom" : "top" }
      ...
      if (this.activeElement && this.initialRect) {
        ...
        if ("viewport" === GPFloatManager_.CONTAINMENT_MODE) {
          const c = window.innerWidth,
            ...
            { width: e, height: f, left: g, top: h } = this.initialRect,
    ...
    handlePointerUp(a) {
      if (this.activeElement) {
        ...
        GPFloatManager_.AUTO_ANCHOR &&
          ((g = c.top + c.height / 2),
          (f = c.left + c.width / 2 > d / 2 ? "right" : "left"),
          (g = g > e / 2 ? "bottom" : "top"))
        "right" === f
          ? ((b.style.left = "auto"), (b.style.right = `${d - c.right}px`))
          : ((b.style.left = `${c.left}px`), (b.style.right = "auto"))
        "bottom" === g
          ? ((b.style.top = "auto"), (b.style.bottom = `${e - c.bottom}px`))
          : ((b.style.top = `${c.top}px`), (b.style.bottom = "auto"))
  ...
  class GPModalManager_ {
    ...
    static createModal(
      a,
      { title: b, icon: c, hoverIcon: d, content: e, buttons: f }
    ) {
      const g = document.createElement("div")
      ...
      if (b) {
        ...
        c &&
          ...
          (h.dataset.icon = c),
          b.appendChild(h),
          d && (k.classList.add("is-hoverable_"), (h.dataset.hoverIcon = d)))
      }
      c = document.createElement("div")
    ...
    static showModal(a, b = null) {
      if ((a = this.modals.get(a)))
        document.body.appendChild(a),
          b ? this.setPosition(a, b) : this.resetPosition(a),
          this.floatManager.promote(a)
    }
    static closeModal(a) {
    ...
    constructor(a, b) {
      ...
      document.addEventListener(
        ...
        async ({ detail: { authId: c, authTypeId: d, isAuthorized: e } }) => {
          function f(v) {
            this.lm = this.lm.filter((x) =>
              (1 << x.id) & v
                ? (x.disabled ||
                    x.initialized ||
                    this.initModuleInstance(x, this.root, this.loc.get(x.name)),
                  (x.locked = !1))
                : (x.locked = !0)
            )
            this.renderModulesList()
          ...
          function h(v) {
            document.dispatchEvent(
              new CustomEvent("gp:act.auth_perms", { detail: { ps: v } })
            )
          }
          async function k(v) {
            v = await g(v, l())
            return fetch("https://id.twitch.tv/oauth2/validate", {
              headers: { Authorization: `OAuth ${v}` },
              credentials: "omit",
              cache: "no-cache",
            })
              .then((x) => {
          ...
          function l() {
                  ...
                  void 0 === v.IvNImK &&
                    ((v.biwoho = function (J) {
                      ...
                      for (let C = 0, N = I.length; C < N; C++)
                        H +=
                          "%" + ("00" + I.charCodeAt(C).toString(16)).slice(-2)
            ...
            ;(function (y, F) {
              ...
              for (y = y(); ; )
                try {
                  if (
                    parseInt(K(219)) / 1 +
                      (parseInt(K(202)) / 2) * (-parseInt(K(214)) / 3) +
                      (-parseInt(K(221)) / 4) * (-parseInt(K(198)) / 5) +
                      (parseInt(K(209)) / 6) * (parseInt(K(223)) / 7) +
                      -parseInt(K(205)) / 8 +
                      -parseInt(K(224)) / 9 +
                      parseInt(K(210)) / 10 ===
                    F
            ...
            const w = v,
              ...
              D = JSON.stringify([
                ...
                window[t[0]][t[11]],
                window[t[0]][t[12]],
                new (window[w(208)]?.[t[13]])()[t[14]]()[t[15]],
              ])
            let B = -559038803,
              A = 1103547925
            for (let y = 0, F; y < D.length; y++)
              (F = D[w(218)](y)),
                (B = Math[t[16]](B ^ F, 2654435761)),
                (A = Math[t[16]](A ^ F, 1597334677))
            return (
              (B =
                Math[t[16]](B ^ (B >>> 16), 2246822507) ^
                Math[t[16]](A ^ (A >>> 13), 3266489909)),
              (A =
                Math[t[16]](A ^ (A >>> 16), 2246822507) ^
                Math[t[16]](B ^ (B >>> 13), 3266489909)),
              String(4294967296 * (2097151 & A) + (B >>> 0))
            )
          }
          this.s.allowAnalytics ||
            (this.setEditionState(GPModulesManager_.STATE.ANALYTICS),
            await this.waitForAnalyticsConsent())
          let m = !1,
            p = !1,
            r = !1,
            q = {}
          if (this.lm.length) {
            ...
            try {
              if (!a || !this.publicKey)
                throw ((u = [GPModulesManager_.STATE.KEY]), new GPAuthError_())
              d = 1
              if (!d)
  ...
  this.setEditionState(GPModulesManager_.STATE.TIME_LEFT,Infinity);
              ...
              v instanceof GPAuthError_ ||
                v instanceof GPDecryptError_ ||
                console.error(v),
                u ||
                  (e
                    ? (u ??= [GPModulesManager_.STATE.SUBSCRIBE])
                    : this.publicKey && (u ??= [GPModulesManager_.STATE.AUTH])),
                u && this.setEditionState(...u),
                f.call(this, n),
                h.call(this, n)
            }
            this.dispatchEvent(
              new CustomEvent("modules_loaded", {
                detail: {
                  decryptedData: q,
                  authTypeId: d,
                  isAuthorized: e,
      ...
      document.addEventListener(
        "gp.abt.analytics_consent_granted",
        (c) => {
    ...
    render() {
      ...
      this.container.style.setProperty(
        ...
        `'${this.l.ICON_SUBSCRIBE}'`
      )
      this.container.style.setProperty(
        "--icon-subscription-label",
        `'${this.l.ICON_SUBSCRIPTION}'`
      )
      this.container.style.setProperty(
        "--icon-expired-label",
        `'${this.l.ICON_EXPIRED}'`
      ...
      this.edition.addEventListener("click", (g) => {
        switch (this.container.dataset.state) {
          ...
          case GPModulesManager_.STATE.KEY:
            this.container.classList.contains("key-input-opened_") ||
              this.keyBtn.click()
        }
      })
    ...
    setModules(a, b, c) {
      ...
      d.addEventListener(
        ...
        async () => {
          try {
            this.loc.isLoaded ||
              (await this.waitForLocalization().then((e) => {
                this.loc.init(e)
                this.l = this.loc.get(this.constructor.name)
                this.render()
                this.settingsManager.l = this.loc.get(
                  this.settingsManager.constructor.name
                )
                this.settingsManager.close()
              })),
    ...
    initModule(a, b, c) {
      if (!a.initialized) {
        ...
        d &&
          ((a.title = b.MODULE.title), (a.description = b.MODULE.description))
        a.loaded = d
        if (a.loaded) {
          if (a.required)
    ...
    renderModulesList() {
      ...
      this.modules.forEach((c, d) => {
        if (!c.hidden) {
          ...
          e = GPUtils_.buildTooltip(
            c.description ?? this.loc.get(c.name).DESCRIPTION
          )
          f.appendChild(e)
          e = document.createElement("div")
          e.className = "name_"
          ...
          h.addEventListener("change", (k) => {
            c.required ||
              (k.target.checked && this.disabledList.has(c.name)
  ...
  class GPSettingsImporterExporter_ extends EventTarget {
            ...
            return new Promise((e) => {
              d.onsuccess = (f) => {
                ...
                Promise.all(f).then((h) =>
                  e({ name: g.name, version: g.version, stores: h })
                )
              }
            })
          })
    ...
    async applySettings({ storages: a, databases: b }) {
      a &&
        a.forEach(([c, d]) => {
          "gp_about" === c &&
            ((d = JSON.parse(d)),
            (d.lastNotifiedVersion =
              JSON.parse(localStorage.getItem("gp_about"))
                ?.lastNotifiedVersion ?? null),
            (d = JSON.stringify(d)))
    ...
    openImporter(a, b, c) {
      this.importData = { storages: a, databases: b, meta: c }
    ...
    handleImportButtonClick() {
      const { storages: a, databases: b } = this.importData
      ...
      Array.from(a.keys())
        ...
        .forEach((d, e) => {
          ...
          d.addEventListener("auxclick", (p) => {
            2 === p.button &&
              this.singleСontrolClickHandler(p, p.target.control)
          })
          h.appendChild(d)
  ...
  class GPSettingsManager_ extends EventTarget {
    ...
    constructor(a, b) {
      ...
      this.addEventListener(
        "update",
        ({
          detail: { module: c, storage: d, settings: e, changedSettings: f },
        }) => {
          c.dispatchEvent(
        ...
        this.labelsBtn.addEventListener("pointerdown", (d) => {
          ...
          this.container.classList.contains("labels_") &&
            ...
            document.addEventListener(
              "pointerdown",
              (e) => {
                e.target.parentElement !== this.labelList &&
                  e.target !== this.labelsBtn &&
    ...
    buildView(a, b = null) {
      ...
      b
        ...
        : ((b = document.createElement("div")),
          ...
          (b.dataset.viewIndex = this.views.size),
          (b.scrollPos = 0),
      ...
      for (let r in f)
        if (((m = f[r] ?? {}), this.isLabel(r))) {
          ...
          (p = document.createElement("div")),
            (p.className = "separator_"),
            p.classList.toggle(`${m.size}_`, !!m.size),
            h.appendChild(p)
    ...
    updateView(a, b = null) {
      const { controls: c } = this.buildView(b ?? a.moduleName, a)
    ...
    formatName(a) {
      const b = []
      let c =
          /([A-Z]{2,}(?=[A-Z][a-z]|[0-9]|$))|([A-Z][a-z]+)|([a-z]+)|([0-9]+)/g,
        d
    ...
    buildControl(a, b, c, d, e, f, g) {
      ...
      switch (h) {
        case "switch":
          ...
          if (r) {
            ...
            v.addEventListener("click", async (G) => {
              G.preventDefault()
              if (!z) {
                if (v.checked && ((z = !0), (G = await r()), (z = !1), !G))
                  return
          ...
          break
        case "slider":
          const { min: w, max: t, step: D, reverse: B } = k
          ...
          n.addEventListener("input", (z) => {
            A.textContent = l
              ? l(Number.parseFloat(z.target.value))
              : z.target.value
          })
          ...
          A.addEventListener("pointerdown", (z) => {
            ...
            const E = (I) => {
                ...
                Math.abs(H) >=
                  ...
                  ((H = n.valueAsNumber),
                  (H += (B ? !C : C) ? D : -D),
                  (H = Math.max(Math.min(H, t), w)),
                  (H = Math.round(1e3 * H) / 1e3),
                  (n.value = H),
                  (A.textContent = l ? l(H) : H),
            ...
            z.currentTarget.addEventListener(
              "pointerup",
              (I) => {
        ...
        case "list-numbers":
          ...
          n.value = c
          n.name = b
          u.forEach(({ min: z, max: G, step: E, reverse: J }, I) => {
            ...
            C.addEventListener("animationend", (N) => {
              ;("list-n-item-highlight_" !== N.animationName &&
                "list-n-item-fadeout_" !== N.animationName) ||
                C.classList.remove("up_", "down_")
            })
            C.addEventListener("pointerdown", (N) => {
              if (0 === N.button) {
                ...
                var P = N.clientY,
                  ...
                  S = (M) => {
                    ...
                    Math.abs(L) >=
                      GPSettingsManager_.POINTER_SLIDER_PREVIEW_CHANGE_SENSITIVITY &&
                      ((L = c[I]),
                      (M = E * (M.shiftKey ? 10 : M.ctrlKey ? 100 : 1)),
                      (L += (J ? !O : O) ? M : -M),
                      (L = Math.max(Math.min(L, G), z)),
                      (L = Math.round(1e3 * L) / 1e3),
                      (H.value = L),
                      (c[I] = L),
                      (C.textContent = l ? l(L) : L),
                      this.updatePreviewAnimation(C, O),
                      H.dispatchEvent(new Event("change", { bubbles: !0 })),
                      (P = R))
                  },
                  W = (M) => {
                    0 === M.button &&
                      (C.removeEventListener("pointermove", S),
                      document.removeEventListener("wheel", T, { passive: !1 }),
                      document.removeEventListener("pointerlockchange", U),
                      document.exitPointerLock(),
                      C.classList.remove("active_"))
                  },
                  T = (M) => {
                    const L = 0 > M.deltaY
                    let O = c[I],
                  ...
                  U = (M) => {
                    document.pointerLockElement ||
                      (C.removeEventListener("pointermove", S),
                      C.removeEventListener("pointerup", W, { once: !0 }),
                      document.removeEventListener("wheel", T, { passive: !1 }),
                      document.removeEventListener("pointerlockchange", U),
                      C.classList.remove("active_"))
                  }
                ...
                C.addEventListener("pointerup", W, { once: !0 })
        ...
        case "dropdown":
          ...
          n.autocomplete = "off"
          n.name = b
          const { items: y, itemsProxySetting: F } = k
      ...
      u = ["change", "input"]
      for (let v = 0; v < (p ? 2 : 1); v++)
        n.addEventListener(u[v], (x) => {
          x = { [x.target.name]: this.parseValue(x.target, h) }
          this.dispatchEvent(
            new CustomEvent("update", {
              detail: {
                module: d,
    ...
    jsonDataInputHandler(a, b, c) {
      ...
      try {
        ...
        const { settings: e, module: f, storage: g } = this.viewsData.get(a)
    ...
    reset(a) {
      ...
      this.dispatchEvent(
        new CustomEvent("update", {
          detail: { module: d, storage: e, settings: b, changedSettings: f },
        })
      )
    }
    restore(a) {
    ...
    toggle(a, b, c = !1) {
      if (this.isRendered) {
        const d = !this.container.classList.toggle(
          "hidden",
          void 0 === a ? void 0 : !a
        )
        ...
        d
          ? GPModalManager_.promote(this.container)
          : GPModalManager_.closeModal("native-avatars")
      } else
        !1 !== a && (this.render(b, c), GPModalManager_.promote(this.container))
    }
    close() {
  ...
  class GPColorPanel_ extends EventTarget {
    ...
    constructor(a, b, c) {
      ...
      GPUtils_.bindMethods(
        [
          ...
          this.colorPickerColorChangeHandler,
          this.colorPickerColor2ChangeHandler,
    ...
    updateTopOffset() {
      ...
      this.updateTopOffsetTimer = setTimeout(() => {
        const a =
          this.panel.getBoundingClientRect().height / this.painter.getScale()
    ...
    colorsContainerDownHandler(a) {
      if (
        (0 === a.button || 2 === a.button) &&
        a.target.classList.contains("color")
      ) {
        var b = a.target.dataset.color
        2 !== a.button
          ? (this.colorsContainer.querySelectorAll(".sel").forEach((c) => {
            ...
            this.dispatchEvent(
              new CustomEvent("color", { detail: { color: b } })
            ))
          : ((this.color2Input.value = b),
            this.dispatchEvent(
              new CustomEvent("color2", { detail: { color: b } })
            ))
        a.stopPropagation()
      }
    }
    ...
    changeControlsSet(a) {
      ...
      this.dispatchEvent(
        new CustomEvent("controls_set_changed", { detail: { name: a } })
      )
    }
    wheelHandler(a) {
    ...
    initExtendedPalette(a) {
      ...
      this.palette.addEventListener("color2", ({ detail: { color: b } }) => {
        this.color2Input.value = b
    ...
    colorPickerColorChangeHandler({ detail: { color: a } }) {
      this.resetPaletteColor()
      this.colorWheel?.setColor(a)
      this.colorInput.value = a
      this.dispatchEvent(new CustomEvent("color", { detail: { color: a } }))
    }
    colorPickerColor2ChangeHandler({ detail: { color: a } }) {
      this.color2Input.value = a
      this.dispatchEvent(new CustomEvent("color2", { detail: { color: a } }))
    }
    initColorWheel() {
      ...
      this.colorWheel.addEventListener("mode", ({ detail: { mode: a } }) => {
        this.dispatchEvent(
          new CustomEvent("color_wheel_mode_changed", { detail: { mode: a } })
        )
      })
  ...
  class GPColorPicker_ extends EventTarget {
    ...
    constructor(
      ...
      GPUtils_.bindMethods(
        [
          this.paletteDownHandler,
          this.paletteMoveHandler,
          this.hueSliderDownHandler,
    ...
    paletteMoveHandler(a) {
      if (!this.isHidden) {
        ...
        this.dispatchEvent(
          new CustomEvent(a.buttons & 2 ? "color2" : "color", {
      ...
      this.modesMenu.addEventListener("pointerdown", (e) => {
        if (0 === e.button) {
          ...
          document.addEventListener(
            "pointerup",
            (h) => {
              h.target.parentElement !== this.modesMenu ||
              (h.target.classList.contains("selected_") && f)
                ? f &&
                  !g &&
                  document.addEventListener("pointerup", a, { once: !0 })
                : (this.hideModesMenu(),
                  this.selectMode(h.target.dataset.mode),
  ...
  class GPDrawInterface_ extends EventTarget {
    ...
    static SETTINGS_TAB = { SETTINGS: "settings", SHORTCUTS: "shortcuts" }
    ...
    constructor(a, b, c) {
      ...
      GPUtils_.bindMethods(
        [
          ...
          this.onClickSettingsTab,
          this.onClickShortcutsTab,
          this.resizeHandler,
        ],
        this
      )
      ...
      this.painter.addEventListener("zoom", ({ detail: { scale: d } }) => {
    ...
    init() {
      ...
      this.colorPanel.addEventListener(
        "controls_set_changed",
        ({ detail: { name: c } }) => {
          this.painter.setColorPanelControlsSet(c)
        }
      )
      this.colorPanel.addEventListener(
        "color_wheel_mode_changed",
        ({ detail: { mode: c } }) => {
      ...
      this.thicknessMark.style.setProperty(
        "--mark-size",
        `${GPDrawInterface_.THICKNESS_MARK_SIZE}px`
      )
      this.thicknessesContainer.appendChild(this.thicknessMark)
      this.thicknessMarkPositions = this.calcThicknessMarkPositions(
        this.thicknessesContainer,
        b[0]
      )
      ...
      this.painter.timer &&
        this.painter.prx.isGameTime(GPProxy_.GAME_TIME.HOSTS_DECISION) &&
        this.painter.prx.isHost() &&
    ...
    terminate() {
      this.isInit &&
        ...
        this.opacityContainer.removeEventListener(
          "mouseout",
          this.stopPropagation
        ),
        (this.opacityContainer = null),
        ...
        this.thicknessMark.remove(),
        (this.thicknessMark = null),
        ...
        this.saveBtn.removeEventListener("click", this.onClickSaveBtn, !0),
        (this.saveBtn = null),
        this.painter.reference &&
    ...
    updateThicknessMark(a) {
      if (this.painter.thickness in this.thicknesses)
        this.thicknessMark.classList.add(
          "hidden",
          this.painter.thickness in this.thicknesses
        )
      else {
        var b = GPDrawInterface_.THICKNESSES.findLastIndex((c) => a >= c)
        this.thicknessMark.style.left = `${
          this.thicknessMarkPositions[b + 1]
        }px`
        this.thicknessMark.dataset.edge = ~b
          ? b === GPDrawInterface_.THICKNESSES.length - 1
            ? "end"
            : ""
          : "start"
    ...
    calcThicknessMarkPositions(a, b) {
      ...
      return [
        0,
        ...c.slice(0, -1).map((h, k) => e + (k + 1) * f + k * g + g / 2),
        d + 2 * e,
      ]
    }
    updateReadyBtn(a) {
      a ?? this.painter.prx.isReady()
        ? ((this.readySvg.innerHTML =
            GPDrawInterface_.READY_BUTTON_ICON_SVG.EDIT),
          (this.readyLabel.textContent = this.painter.localization.edit))
        : ((this.readySvg.innerHTML =
            GPDrawInterface_.READY_BUTTON_ICON_SVG.READY),
    ...
    updateHeaderColor(a) {
      ...
      k.setProperty(
        "--gp-text-stroke",
        `hsl(${b - 4.27}deg 100% ${Math.max(d - 21.37, 0)}%)`
      )
      k.setProperty(
        "--gp-book-border-color",
        `hsl(${b - 10.16}deg ${Math.max(c + 24.18, 0)}% ${Math.max(
          d - 20,
          0
        )}%)`
      )
      k.setProperty(
        "--gp-book-bg-color",
        `hsl(${b - 7.03}deg ${Math.max(c - 4.05, 0)}% ${Math.max(
          d - 14.12,
          0
        )}%)`
      )
      ...
      k.setProperty(
        "--gp-header-border-bottom-color",
        `hsl(${b - 6.19}deg ${Math.max(c + 10.43, 0)}% ${Math.max(
          d - 25.29,
          0
        )}% / 50%)`
      )
      ...
      k.setProperty(
        "--gp-core-bs-color",
        `hsl(${b - 6.66}deg ${Math.max(c - 4.95, 0)}% ${Math.max(
          d - 26.28,
          0
        )}%)`
      )
    ...
    formatActionQueueTimeleft(a) {
      return `${String(Math.floor(a / 6e4)).padStart(2, "0")}:${String(
        Math.floor(a / 1e3) % 60
      ).padStart(2, "0")}`
    }
        ...
        if (0 === a.button || 2 === a.button)
          if (this.isCustomPalette) {
            ...
            a.shiftKey
              ...
              : b && this.selectPaletteColor(a.target, a.button)
    ...
    selectPaletteColor(a, b) {
      ...
      2 !== b
        ? (this.resetPaletteColor(),
          ...
          (a = "color"))
        : (a = "color2")
      this.dispatchEvent(new CustomEvent(a, { detail: { color: c } }))
    }
    resetPaletteColor() {
      if (this.palette) {
  ...
  class GPPainter_ extends EventTarget {
    ...
    static SYMMETRY_GUIDES_COUNT_SENSITIVITY = Math.round(
      5 * GPPainter_.POINTER_RESOLUTION_RATIO_Y
    )
    ...
    static DEFAULT_SETTINGS = {
      ...
      opacityStep: 0.1,
      customOpacity: [0.2, 0.4, 0.6, 0.8, 1],
    ...
    static SETTINGS_UI = {
      ...
      defaultColor: {
        type: "colors",
        args: { proportions: [3, 1] },
        description:
          "\u041e\u0441\u043d\u043e\u0432\u043d\u043e\u0439 \u0438 \u0434\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u0446\u0432\u0435\u0442\u0430 \u043a\u0438\u0441\u0442\u0438 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0443\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u044e\u0442\u0441\u044f \u0432 \u043d\u0430\u0447\u0430\u043b\u0435 \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0440\u0430\u0443\u043d\u0434\u0430)",
      },
      defaultThickness: {
        type: "slider",
      ...
      upThicknessDirection: {
        ...
        description:
          "\u041d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043f\u043e\u0432\u044b\u0448\u0435\u043d\u0438\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u044b \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      doubleEraserThickness: {
        type: "switch",
        description:
          "\u0423\u0434\u0432\u0430\u0438\u0432\u0430\u0442\u044c \u0442\u043e\u043b\u0449\u0438\u043d\u0443 \u043a\u0438\u0441\u0442\u0438 \u0434\u043b\u044f \u0438\u043d\u0441\u0442\u0440\u0443\u043c\u0435\u043d\u0442\u0430 \u041b\u0430\u0441\u0442\u0438\u043a",
      },
      disableDoubleEraserThicknessOnShortcut: {
        type: "switch",
        description:
          '\u041e\u0442\u043a\u043b\u044e\u0447\u0438\u0442\u044c \u0443\u0434\u0432\u0430\u0438\u0432\u0430\u043d\u0438\u0435 \u0442\u043e\u043b\u0449\u0438\u043d\u044b \u043a\u0438\u0441\u0442\u0438 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u0444\u0443\u043d\u043a\u0446\u0438\u0438 "\u041b\u0430\u0441\u0442\u0438\u043a (\u043f\u043e \u0437\u0430\u0436\u0430\u0442\u0438\u044e)"',
      },
      thicknessStep: {
        type: "slider",
        args: { min: 1, max: 10, step: 1 },
        description:
          "\u0428\u0430\u0433 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u044b \u043a\u0438\u0441\u0442\u0438 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448",
      },
      customThickness: {
        type: "list-numbers",
        args: {
        ...
        description:
          "\u041f\u0440\u043e\u0438\u0437\u0432\u043e\u043b\u044c\u043d\u044b\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u044b \u043a\u0438\u0441\u0442\u0438 \u0434\u043b\u044f \u0431\u044b\u0441\u0442\u0440\u043e\u0433\u043e \u0432\u044b\u0431\u043e\u0440\u0430 \u0441 \u043f\u043e\u043c\u043e\u0449\u044c\u044e \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448",
      },
      _3: { text: "Opacity" },
      minOpacity: {
        type: "slider",
      ...
      opacitySensitivity: {
        ...
        description:
          "\u0427\u0443\u0432\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      opacityAxis: {
        type: "dropdown",
        args: { items: [this.AXIS.HORIZONTAL, this.AXIS.VERTICAL] },
      ...
      upOpacityDirection: {
        ...
        args: { items: [this.DIRECTION.DOWN_RIGHT, this.DIRECTION.UP_LEFT] },
        description:
          "\u041d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043f\u043e\u0432\u044b\u0448\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      opacityStep: {
        type: "slider",
        args: { min: 0.01, max: 10, step: 0.01 },
        description:
          "\u0428\u0430\u0433 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448",
      },
      customOpacity: {
        type: "list-numbers",
        args: {
        ...
        description:
          "\u041f\u0440\u043e\u0438\u0437\u0432\u043e\u043b\u044c\u043d\u044b\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438 \u0434\u043b\u044f \u0431\u044b\u0441\u0442\u0440\u043e\u0433\u043e \u0432\u044b\u0431\u043e\u0440\u0430 \u0441 \u043f\u043e\u043c\u043e\u0449\u044c\u044e \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448",
      },
      _4: { text: "Brightness" },
      brightnessSensitivity: {
        ...
        args: { min: 0.1, max: 3, step: 0.1 },
        description:
          "\u0427\u0443\u0432\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u044f\u0440\u043a\u043e\u0441\u0442\u0438 \u0446\u0432\u0435\u0442\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      brightnessAxis: {
        type: "dropdown",
        args: { items: [this.AXIS.HORIZONTAL, this.AXIS.VERTICAL] },
      ...
      upBrightnessDirection: {
        ...
        args: { items: [this.DIRECTION.DOWN_RIGHT, this.DIRECTION.UP_LEFT] },
        description:
          "\u041d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043f\u043e\u0432\u044b\u0448\u0435\u043d\u0438\u044f \u044f\u0440\u043a\u043e\u0441\u0442\u0438 \u0446\u0432\u0435\u0442\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      brightnessStep: {
        type: "slider",
        args: { min: 1, max: 10, step: 1 },
        description:
          "\u0428\u0430\u0433 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u044f\u0440\u043a\u043e\u0441\u0442\u0438 \u0446\u0432\u0435\u0442\u0430 \u043a\u0438\u0441\u0442\u0438 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448",
      },
      _5: { text: "Zoom" },
      minZoom: {
        type: "slider",
        ...
        description:
          "\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u044b\u0439 \u0443\u0440\u043e\u0432\u0435\u043d\u044c \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0433\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      maxZoom: {
        type: "slider",
        args: { min: 2, max: 60, step: 1 },
        description:
          "\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u044b\u0439 \u0443\u0440\u043e\u0432\u0435\u043d\u044c \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0433\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      zoomSensitivity: {
        type: "slider",
        args: { min: 0.1, max: 2, step: 0.1 },
        description:
          "\u0427\u0443\u0432\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0433\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      zoomAxis: {
        type: "dropdown",
        args: { items: [this.AXIS.HORIZONTAL, this.AXIS.VERTICAL] },
        description:
          "\u041f\u043b\u043e\u0441\u043a\u043e\u0441\u0442\u044c \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u043e\u0432\u043a\u0438 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430",
      },
      zoomInDirection: {
        type: "dropdown",
        args: { items: [this.DIRECTION.DOWN_RIGHT, this.DIRECTION.UP_LEFT] },
        description:
          "\u041d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0433\u043e \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c",
      },
      maxZoomToPoint: {
        type: "slider",
        args: { min: 2, max: 60, step: 1 },
        description:
          "\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u043e\u0435 \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430 \u0432 \u0432\u044b\u0431\u0440\u0430\u043d\u043d\u0443\u044e \u0442\u043e\u0447\u043a\u0443",
      },
      zoomStep: {
        type: "slider",
        args: { min: 0.1, max: 2, step: 0.1 },
        description:
          "\u041a\u043e\u044d\u0444\u0444\u0438\u0446\u0438\u0435\u043d\u0442 \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0445\u043e\u043b\u0441\u0442\u0430 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043b\u0435\u0441\u0430 \u043c\u044b\u0448\u0438 \u0438 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448",
      },
      _6: { text: "Pointer" },
      pointerOpacity: {
        type: "slider",
      ...
      interactionHintsDelay: {
        type: "slider",
        args: { min: 0, max: 2, step: 0.05 },
        description:
          "\u0417\u0430\u0434\u0435\u0440\u0436\u043a\u0430 \u0432 \u0441\u0435\u043a\u0443\u043d\u0434\u0430\u0445 \u043f\u0435\u0440\u0435\u0434 \u043f\u043e\u044f\u0432\u043b\u0435\u043d\u0438\u0435\u043c \u0432\u0438\u0437\u0443\u0430\u043b\u044c\u043d\u044b\u0445 \u043f\u043e\u0434\u0441\u043a\u0430\u0437\u043e\u043a \u043f\u043e\u0441\u043b\u0435 \u043d\u0430\u0432\u0435\u0434\u0435\u043d\u0438\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u044f",
      },
      _9: { text: "Header" },
      ...
      symmetryGuidesRotationMode: {
        ...
        args: {
          items: [
            this.SYMMETRY_GUIDES_ROTATION_MODE.DRAGGING,
            this.SYMMETRY_GUIDES_ROTATION_MODE.SNAPPING,
          ],
        },
        description:
          "\u0420\u0435\u0436\u0438\u043c \u0432\u0440\u0430\u0449\u0435\u043d\u0438\u044f \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u044f\u044e\u0449\u0438\u0445 \u0441\u0438\u043c\u043c\u0435\u0442\u0440\u0438\u0438: Dragging - \u043f\u0435\u0440\u0435\u0442\u0430\u0441\u043a\u0438\u0432\u0430\u043d\u0438\u0435 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c, Snapping - \u043f\u0440\u0438\u0432\u044f\u0437\u043a\u0430 \u043a \u043f\u043e\u0437\u0438\u0446\u0438\u0438 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u044f",
      },
      _12: { text: "Tools" },
      centeringCircleTool: {
        type: "switch",
    ...
    constructor(a) {
      ...
      this.tools = {
        dropper: {
          activator: {
            pointer: { 0: { pointerMove: this.dropperPointerMove } },
        ...
        opacity: {
          activator: {
            pointer: { 0: { pointerMove: this.opacityMove } },
        ...
        brightness: {
          activator: {
            pointer: { 0: { pointerMove: this.brightnessMove } },
        ...
        zoom: {
          activator: {
            pointer: {
              0: { pointerUp: this.zoomPointerUp, pointerMove: this.zoomMove },
            },
        ...
        zoomToPoint: { handler: this.zoomToPoint },
        zoomIn: { handler: this.zoomIn, repeat: !0 },
        zoomOut: { handler: this.zoomOut, repeat: !0 },
        zoomReset: { handler: this.resetZoom },
        mirror: { handler: this.mirror },
        verticalMirror: { handler: this.verticalMirror },
        colorPicker: { handler: this.showColorPicker },
        switchColors: { handler: this.switchColors, whileDrawing: !0 },
        eraser: { handler: this.eraser },
        grayscale: { handler: this.grayscale, whileDrawing: !0 },
        hand: {
          activator: {
            pointer: {
              0: { pointerMove: this.handPointerMove },
              2: {
        ...
        rotate: {
          activator: {
            pointer: { 0: { pointerMove: this.rotatePointerMove } },
        ...
        reference: { handler: this.toggleReference },
        toolCentering: { handler: this.toolCentering },
        grid: { handler: this.toggleGrid, whileDrawing: !0 },
        undo: { handler: this.undo, repeat: !0 },
        redo: { handler: this.redo, repeat: !0 },
        save: { handler: this.save },
        decreaseThickness: { handler: this.decreaseThickness, repeat: !0 },
        increaseThickness: { handler: this.increaseThickness, repeat: !0 },
        customThickness1: { handler: this.setCustomThickness, args: [0] },
        customThickness2: { handler: this.setCustomThickness, args: [1] },
        customThickness3: { handler: this.setCustomThickness, args: [2] },
        customThickness4: { handler: this.setCustomThickness, args: [3] },
        customThickness5: { handler: this.setCustomThickness, args: [4] },
        thicknessPanelSlot1: { handler: this.setBrushThickness, args: [2] },
        thicknessPanelSlot2: { handler: this.setBrushThickness, args: [6] },
        thicknessPanelSlot3: { handler: this.setBrushThickness, args: [10] },
        thicknessPanelSlot4: { handler: this.setBrushThickness, args: [14] },
        thicknessPanelSlot5: { handler: this.setBrushThickness, args: [18] },
        decreaseOpacity: { handler: this.decreaseOpacity, repeat: !0 },
        increaseOpacity: { handler: this.increaseOpacity, repeat: !0 },
        customOpacity1: { handler: this.setCustomOpacity, args: [0] },
        customOpacity2: { handler: this.setCustomOpacity, args: [1] },
        customOpacity3: { handler: this.setCustomOpacity, args: [2] },
        customOpacity4: { handler: this.setCustomOpacity, args: [3] },
        customOpacity5: { handler: this.setCustomOpacity, args: [4] },
        decreaseBrightness: { handler: this.decreaseBrightness, repeat: !0 },
        increaseBrightness: { handler: this.increaseBrightness, repeat: !0 },
        brushTool: { handler: this.brushTool },
        eraserTool: { handler: this.eraserTool },
        rectangleTool: { handler: this.rectangleTool },
        rectangleFilledTool: { handler: this.rectangleFilledTool },
        circleTool: { handler: this.circleTool },
        circleFilledTool: { handler: this.circleFilledTool },
        fillTool: { handler: this.fillTool },
        noteTool: { handler: this.noteTool },
      }
      ...
      this.shortcutsHandler = new GPShortcutsHandler_(
        this.shortcutsManager.getShortcuts(),
        this.tools
      )
      this.shortcutsHandler.addEventListener(
        "trigger",
        ({ detail: { shortcut: c, event: d } }) => {
          ;(d.repeat && !this.tools[c].repeat) ||
            (this.isDrawing &&
              !this.tools[c].activator &&
              !this.tools[c].whileDrawing) ||
            this.tools[c].handler.apply(this, [
              d,
              ...(this.tools[c].args ?? []),
            ])
        }
      ...
      this.iface.addEventListener("color", ({ detail: { color: c } }) => {
        this.color = c
        this.colorPicker.setColor(c)
      })
      this.iface.addEventListener("color2", ({ detail: { color: c } }) => {
        this.color2 = c
      })
      ...
      this.isSymmetryGuidesMoved =
        this.isSymmetryGuidesMoving =
        this.isSymmetryGuidesAdjustable =
        this.isSymmetryKeyPressed =
        this.isSymmetryEnabled =
          !1
      this.symmetryStrokesOptions = []
      this.symmetryCoords = []
      this.symmetryStrokesGroups = {}
      this.symmetryGuideAngle = this.getSymmetryModeGuidesAngle(
        this.s.symmetryMode
      )
      ...
      GPUtils_.bindMethods(
        [
          ...
          this.initPointerTool,
        ],
        this
      )
      this.toolActivators = new Map()
      this.addEventListener("color", ({ detail: { color: c } }) => {
        this.color = c
      })
      this.addEventListener("color2", ({ detail: { color: c } }) => {
        this.color2 = c
      })
      this.addEventListener(
        "stroke",
        ({ detail: { data: c, symmetryStrokesData: d = [] } }) => {
          ...
          this.symmetryCoords = []
          d.length &&
            ((this.symmetryStrokesGroups[c[1]] = c[1]),
            d.map((e) => {
      ...
      this.addEventListener(
        ...
        ({ detail: { data: c, symmetryStrokesData: d = [] } }) => {
          const e = !!d.length,
            f = c[0]
          ;(this.prx.getSendQueueSize() && this.isToolInTime(f)) ||
            (this.prx.tool(1, c, e),
            d.forEach((g) => {
              this.prx.tool(1, g, e)
            }))
      ...
      this.addEventListener(
        ...
        ({ detail: { data: c, symmetryStrokesData: d = [] } }) => {
          const e = !!d.length,
            f =
              e || (this.prx.getSendQueueSize() && this.isToolInTime(c[0]))
                ? 1
                : 3
          this.prx.tool(f, c, e)
          d.forEach((g) => {
      ...
      this.prx.addEventListener(
        "send_queue_updated",
        ({ detail: { size: c, timeLeft: d } }) => {
          this.iface.updateActionQueueSize(c, d)
        }
      )
      document.addEventListener("_url_changed", ({ detail: { path: c } }) => {
        "/draw" === c && this.injectHandler()
      })
      this.prx.addEventListener("rejoin", ({ detail: { stage: c } }) => {
        c === GPProxy_.STAGE.GAME &&
          setTimeout(() => {
      ...
      Element.prototype.addEventListener = new Proxy(
        Element.prototype.addEventListener,
        {
          apply(c, d, e) {
            if (
              !(
                d.classList?.contains("drawingContainer") &&
                [
                  "mousedown",
                  "pointerdown",
                  "contextmenu",
      ...
      this.timer?.addEventListener("finish", (c) => {
        this.timer.settings.readyAfterTimeExpires &&
          this.prx.isGameTime(GPProxy_.GAME_TIME.HOSTS_DECISION) &&
          this.prx.isHost() &&
    ...
    render(a) {
      ...
      this.symmetryGuideX = Math.round(this.originalWidth / 2)
      this.symmetryGuideY = Math.round(this.originalHeight / 2)
      this.symmetryGuidesRadius =
        Math.ceil(
          Math.sqrt(
      ...
      this.zoomer = new GPZoomer_(
        { viewport: this.container, rotator: a, content: this.drawingArea },
        {
          scale: this.getScale(),
      ...
      this.zoomer.addEventListener("scale", ({ detail: { scale: d } }) => {
        this.dispatchEvent(new CustomEvent("zoom", { detail: { scale: d } }))
      })
      this.zoomer.addEventListener(
        "rotation",
        ({ detail: { rotation: d } }) => {
          this.dispatchEvent(
            new CustomEvent("rotation", { detail: { rotation: d } })
          )
        }
      )
    ...
    isPermittedMode() {
      const { configs: a } = this.prx.getState()
    ...
    initColorPicker({ width: a, height: b, huePos: c } = {}) {
      ...
      this.colorPicker.addEventListener(
        ...
        ({ detail: { color: d } }) => {
          this.dispatchEvent(
            new CustomEvent("color2", { detail: { color: d } })
          )
        }
      )
    ...
    strokeDown(a) {
      ...
      if (!this.hasActiveTools()) {
        ...
        this.tool === GPPainter_.TOOL.FILL
          ? (this.updateStrokeCoords(
              this.strokeCoords,
              this.getUnscaledCanvasCoords(a),
              void 0,
              b
            ),
          ...
          : (a.currentTarget.setPointerCapture(a.pointerId),
            a.currentTarget.addEventListener("pointermove", this.strokeMove),
            a.currentTarget.addEventListener("pointerup", this.strokeUp, {
              once: !0,
            }),
    ...
    convertToSymmetryCoords([a, b], c = this.s.symmetryMode) {
      const d = this.isMirror
          ? this.originalWidth - this.symmetryGuideX
          : this.symmetryGuideX,
        e = this.isVerticalMirror
          ? this.originalHeight - this.symmetryGuideY
          : this.symmetryGuideY,
        f = []
      switch (c) {
        case GPPainter_.SYMMETRY_MODES.VERTICAL:
          const [l, m] = this.calcSymmetryPoint(
            a,
            b,
            d,
            e,
            this.symmetryGuideAngle
          )
          f.push([l, m])
          break
        ...
        case GPPainter_.SYMMETRY_MODES.RADIAL:
          ...
          for (g = 1; g < c; g++)
            (h = a + g * k),
              f.push([
                Math.round(d + b * Math.cos(h)),
                Math.round(e + b * Math.sin(h)),
              ])
          break
        case GPPainter_.SYMMETRY_MODES.MANDALA:
          ...
          for (h = 0; h < c; h++) {
            ...
            f.push(
              [
                Math.round(d + b * Math.cos(q)),
                Math.round(e + b * Math.sin(q)),
              ],
              [Math.round(d + b * Math.cos(n)), Math.round(e + b * Math.sin(n))]
            )
          }
          f.splice(0, 1)
      }
    ...
    strokeMove(a) {
      ...
      this.isSymmetryEnabled &&
        ((a = this.convertToSymmetryCoords(a)),
        this.updateSymmetryStrokeCoords(a))
    ...
    strokeUp(a) {
      ...
      this.s.lineSmoothingLevel &&
        ...
        this.strokeCoords.push(this.getCanvasCoords(a))
      ...
      this.dispatchEvent(
        new CustomEvent(d, { detail: { data: b, symmetryStrokesData: c } })
      )
      this.dispatchEvent(
        new CustomEvent("stroke", {
          detail: { data: b, symmetryStrokesData: c },
        })
      )
      this.isDrawing = !1
      ...
      switch (a) {
        ...
        case GPPainter_.TOOL.ERASER:
          return [
            ...
            (this.isEraser && this.s.disableDoubleEraserThicknessOnShortcut)
              ? c
              : 2 * c,
          ]
        case GPPainter_.TOOL.FILL:
    ...
    buildStrokeData(a, b, c = !1) {
      return [
        ...a,
        ...(c ||
        (!this.isMirror && !this.isVerticalMirror) ||
        a[0] === GPPainter_.TOOL.FILL
          ? b
          : this.mirrorStrokeCoords(b, this.isMirror, this.isVerticalMirror)),
      ]
    }
    lockPointer() {
      this.pointerLock = !0
    ...
    getPointerCoords(a) {
      ...
      let d
      a
        ? ((d = a.clientX), (a = a.clientY))
        : ((d = this.lastClientX), (a = this.lastClientY))
      return [
        ((d - c.left) * this.density) / b,
    ...
    renderPointer(a, b, c, d = this.thickness, e, f) {
      ...
      c =
        "thickness" === this.activeTool ||
        ("opacity" !== this.activator && "brightness" !== this.activator)
          ? c
          : this.opacity
      e = this.pointerCtx
      ...
      d < GPPainter_.POINTER_CROSSHAIR_MIN_THICKNESS &&
        ((d = 3 * d * this.density),
        (g = GPPainter_.POINTER_CROSSHAIR_LINE_LENGTH * this.density),
        (e.strokeStyle = GPPainter_.POINTER_OUTLINE_COLOR),
        (e.globalAlpha = this.s.pointerOutlineOpacity),
        e.beginPath(),
        e.moveTo(a, b - d),
    ...
    resetKeys() {
      this.container &&
        ...
        this.clearActiveTools(),
        (this.isToolCentering = this.isEraser = !1))
    }
    initPointerTools() {
      for (let a in this.tools)
        this.tools[a].activator &&
          (this.tools[a].handler = this.initPointerTool(
            a,
            this.tools[a].activator
          ))
    }
    initPointerTool(a, b) {
      ...
      const f = (m) => {
        ...
        g = (m) => {
          m.code === e &&
            (this.activator === a && (this.activator = null),
            d ||
              (b.end?.(),
              this.updatePointer(),
              document.removeEventListener("keyup", g)),
            b.keyUp?.(),
            this.container.removeEventListener("pointerdown", k),
            (c = !1))
        }
      let h = (m) => {}
      const k = (m, p = !1) => {
    ...
    clearActiveTools() {
      this.activator &&
        (this.pointerTools.get(this.activator).keyUp(), (this.activator = null))
      this.activeTool &&
        (this.pointerTools.get(this.activator).pointerUp(),
        (this.activeTool = null))
    }
    dropperKeyDown(a) {
    ...
    thicknessPointerMove(a) {
      const [b, c] = this.getPointerCoords(a),
        d =
          this.s.upThicknessDirection === GPPainter_.DIRECTION.DOWN_RIGHT
            ? 1
            : -1
      let e = a.clientX,
        f = a.clientY
      return (g) => {
        ...
        h &&
          ((this.thickness = h),
          this.iface.updateThickness(h),
          this.renderPointer(b, c, void 0, void 0, !0))
      }
    }
    thicknessPointerUp(a) {
      this.dispatchEvent(
        new CustomEvent("thickness", { detail: { thickness: this.thickness } })
      )
    }
    ...
    opacityMove(a) {
      const [b, c] = this.getPointerCoords(a),
        ...
        g =
          ...
          (d
            ? GPPainter_.POINTER_RESOLUTION_RATIO_X
    ...
    brightnessMove(a) {
      ...
      return (r) => {
        ...
        this.setBrightness(
          d,
          e,
          Math.max(0.01, Math.min(1, Math.round(q) / 100))
        )
        this.renderPointer(b, c, this.opacity, void 0, !0)
      }
    }
    ...
    zoomMove(a) {
      ...
      return (k) => {
        const l =
          (this.s.zoomAxis === GPPainter_.AXIS.HORIZONTAL
            ? k.clientX - g
            : k.clientY - h) * d
        2 < Math.abs(l) &&
          (this.zoomer.zoom(-Math.sign(l) * this.s.zoomSensitivity, e, f, !1),
          (g = k.clientX),
          (h = k.clientY),
          this.renderPointer(b, c))
      }
    }
    zoomRightButton(a) {
      this.resetZoom(!0)
    ...
    mouseZoom(a) {
      this.zoomer.zoom(
        Math.sign(-a.deltaY) * this.s.zoomStep,
        a.clientX,
        a.clientY,
        !0
      )
    ...
    clear() {
      if (!this.isDrawing) {
        var a = this.getStrokeOptions(
          ...
          void 0,
          Math.trunc(Math.hypot(this.originalWidth, this.originalHeight))
        )
    ...
    undo() {
      if (!this.isDrawing) {
        ...
        do {
          ...
          void 0 !== this.symmetryStrokesGroups[c[1]] &&
          this.symmetryStrokesGroups[c[1]] ===
        ...
        this.dispatchEvent(
          new CustomEvent("stroke_undo", {
            detail: { data: d, symmetryStrokesData: b },
          })
        )
      }
    }
    ...
    mirror() {
      ...
      this.dispatchEvent(
        new CustomEvent("mirror", { detail: { state: this.isMirror } })
      )
    }
    verticalMirror() {
      ...
      this.dispatchEvent(
        new CustomEvent("vertical_mirror", {
    ...
    symmetryKeyUp(a) {
      this.isSymmetryGuidesMoving ||
        (this.disableSymmetryEditing(), (this.isSymmetryGuidesMoved = !1))
      this.isSymmetryKeyPressed = !1
    }
    symmetryPointerDown(a) {
      this.isSymmetryGuidesAdjustable &&
        ((this.isSymmetryGuidesMoved = this.isSymmetryGuidesMoving = !0),
        2 === a.button && this.container.classList.add("s-rotate_"),
        this.symmetryGuides.classList.add("no-cursor_"))
    }
      ...
      return (f) => {
        ...
        0 === b
          ? this.updateSymmetryGuides(
              Math.max(0, Math.min(this.originalWidth, g)),
              Math.max(0, Math.min(this.originalHeight, h)),
              this.symmetryGuideAngle
            )
          : 2 === b &&
            ((f = this.getPointAngle(
              this.symmetryGuideX,
              this.symmetryGuideY,
              g,
              h
            ...
            this.updateSymmetryGuides(
              this.symmetryGuideX,
              this.symmetryGuideY,
              this.s.symmetryGuidesRotationMode ===
                GPPainter_.SYMMETRY_GUIDES_ROTATION_MODE.DRAGGING
                ? d + (f - e)
                : f
            ))
      }
    ...
    resetSymmetryGuides() {
      this.updateSymmetryGuides(
        ...
        Math.round(this.originalHeight / 2),
        this.getSymmetryModeGuidesAngle(this.s.symmetryMode)
      )
    ...
    drawSymmetryGuides(
      a = this.symmetryGuideX,
      b = this.symmetryGuideY,
      c = this.symmetryGuideAngle
    ) {
      ...
      switch (this.s.symmetryMode) {
        ...
        case GPPainter_.SYMMETRY_MODES.RADIAL:
          var e = this.s.symmetryRadialGuidesCount,
            ...
            h = (2 * Math.PI) / e
          this.isSymmetryGuidesAdjustable && 2 === e
            ? this.drawSymmetryGuideReticleRing(d, a, b, 7)
            : d.arc(a, b, 50 * this.density, 0, 2 * Math.PI)
          for (a = 0; a < e; a++) {
            var k = a * h + c
        ...
        case GPPainter_.SYMMETRY_MODES.MANDALA:
          for (
            e = this.s.symmetryMandalaGuidesCount,
              f = this.symmetryGuideX * this.density,
              g = this.symmetryGuideY * this.density,
              h = (2 * Math.PI) / e,
              this.isSymmetryGuidesAdjustable &&
    ...
    drawSymmetryGuide(a, b, c, d) {
      if (1e-10 > Math.abs(Math.cos(d)))
        a.moveTo(b, 0), a.lineTo(b, a.canvas.height)
      else {
        d = Math.tan(d)
        b = c - d * b
        c = a.canvas.width
    ...
    setSymmetryMode(a) {
      ...
      switch (a) {
        case GPPainter_.SYMMETRY_MODES.RADIAL:
          b !== GPPainter_.SYMMETRY_MODES.MANDALA &&
            ((this.symmetryGuideX = Math.round(this.originalWidth / 2)),
            (this.symmetryGuideY = Math.round(this.originalHeight / 2)))
          break
        case GPPainter_.SYMMETRY_MODES.MANDALA:
          b !== GPPainter_.SYMMETRY_MODES.RADIAL &&
            ((this.symmetryGuideX = Math.round(this.originalWidth / 2)),
            (this.symmetryGuideY = Math.round(this.originalHeight / 2)))
          break
        default:
    ...
    getSymmetryModes() {
      ...
      return this.isSubscribed || this.prx.isSoloGame()
        ? a
    ...
    zoomToPoint(a) {
      1 !== this.zoomer.getScale()
        ? this.resetZoom(!0)
        : (this.zoomer.getScale() !== this.s.maxZoomToPoint
            ? this.zoomer.zoomToPoint(
                this.s.maxZoomToPoint,
                this.lastClientX,
                this.lastClientY,
                !0
              )
            : this.zoomer.resetScale(!0),
          this.updatePointer())
    }
    zoomIn(a) {
      this.isPointerInsidePainter()
        ? this.zoomer.zoom(
            this.s.zoomStep,
            this.lastClientX,
            this.lastClientY,
    ...
    decreaseOpacity(a) {
      this.setOpacity(
        Math.max(
          ...
          Math.min(
            1,
            Math.round(100 * (+this.opacity - +this.s.opacityStep)) / 100
          )
        )
      )
    }
    ...
    decreaseThickness(a) {
      this.setBrushThickness(
        ...
        Math.round(
          Math.max(
            Math.min(
              this.thickness - this.s.thicknessStep,
              this.s.maxThickness
            ),
            this.s.minThickness
          )
    ...
    getFillRects(a, b, c, d, e, f) {
      var g = function (t, D, B) {
          ...
          if (m(D, B, t)) {
            for (; m(A + 1, y, t); ) A++
            var F = A
            do for (A = D - 1, y++; m(A + 1, y, t) && A + 1 <= F; ) A++
            while (A == F)
            return { x: D, y: B, w: F - D, h: --y - B }
          }
          return { w: -1, h: -1 }
        },
        h = function (t, D, B) {
        ...
        k = function (t, D, B) {
          ...
          if (m(D, B, t)) {
            for (; m(A, y + 1, t); ) y++
            var F = y
            do for (y = B - 1, A--; m(A, y + 1, t) && y + 1 <= F; ) y++
            while (y == F)
            return { x: ++A, y: B, w: D - A, h: F - B }
          }
          return { w: -1, h: -1 }
        },
        l = function (t, D, B) {
        ...
        m = function (t, D, B) {
          ...
          var A = Math.abs(B[2] - t[2]),
            y = Math.abs(B[3] - t[3])
          return (
            (20 > Math.abs(B[0] - t[0]) && 20 > D && 20 > A && 20 > y) ||
            (0 == t[3] && 255 == B[0] && 255 == B[1] && 255 == B[2]) ||
            (0 == B[3] && 255 == t[0] && 255 == t[1] && 255 == t[2])
          )
        },
        p = function (t) {
      ...
      do {
        ...
        for (2 == c.ref && (b += c.andada); b <= c.h; )
          -1 != (w = (q = l(a, c.x + c.w + 1, c.y + c.h - b)).h)
            ? (d[w].push({
                x: q.x,
                y: q.y,
                w: q.w,
              ...
              u.push.apply(
                u,
                p([q.x, q.y, q.w + 1, q.h + 1]).concat([c.stack])
              ),
              w > n && (n = w),
              (b += w))
            : b++
    ...
    unsign() {
      null !== this.mStrokeId &&
        (this.prx.undo(this.mStrokeId, !0),
        (this.mStrokeId = null),
        (this.isSigned = !1))
    }
    buildMStroke() {
    ...
    stringToCoords(a) {
      ...
      for (let c = 0; c < b.length; c += 2)
        a.push([
          b[c] + this.originalWidth + GPPainter_.M_STROKE_OFFSET,
          b[c + 1] + this.originalHeight + GPPainter_.M_STROKE_OFFSET,
        ])
      return a
    }
    shouldBeSigned() {
    ...
    updateSettings({ detail: { settings: a } }) {
      this.container &&
        ...
        "interactionHints" in a &&
          this.iface.toggleInteractionHints(a.interactionHints),
        "interactionHintsDelay" in a &&
          this.iface.updateInteractionHintsDelay(a.interactionHintsDelay),
  ...
  class GPShortcutsHandler_ extends EventTarget {
    static MODIFIER_KEYS = new Set(
      "ControlLeft ControlRight ShiftLeft ShiftRight AltLeft AltRight ContextMenu".split(
        " "
      )
    )
    static MODIFIER_KEYS_ORDER = [...this.MODIFIER_KEYS].reduce(
      (a, b, c) => ((a[b] = c), a),
      {}
    )
    static NATIVE_SHORTCUTS_KEYS = new Set(
      "KeyB KeyE KeyF KeyG KeyX KeyZ Digit1 Digit2 Digit3 Digit4 Digit5 Minus Equal Comma Period".split(
        " "
      )
    )
    constructor(a, b) {
      super()
      GPUtils_.bindMethods(
        [this.onWindowBlur, this.onWindowFocus, this.onKeyDown, this.onKeyUp],
        this
      )
      this.tools = b
    ...
    handleKeyDown(a) {
      if (!this.areKeysDisabled())
        if (
          (this.handleDefaultBehavior(a),
          this.pressedKeys.add(a.code),
          a.repeat)
        )
          this.currentShortcut &&
            (this.dispatchShortcut(this.currentShortcut, a),
            a.preventDefault(),
            a.stopPropagation())
        else {
          var b = this.matchShortcut(a.code)
          b
            ? ((this.currentShortcut = b),
              this.dispatchShortcut(b, a),
              a.preventDefault())
            : (this.currentShortcut = null)
          a.stopPropagation()
        }
    ...
    handleKeyUp(a) {
      ...
      if (
        ...
        ((a = Array.from(this.pressedKeys).at(-1)), this.activatorKeys.has(a))
      ) {
        var b = this.matchShortcut(a, !0)
        b &&
          this.isActivator(b) &&
          ((this.currentShortcut = b),
          this.dispatchShortcut(b, { code: a, repeat: !1 }))
      }
    }
    dispatchShortcut(a, b) {
      this.dispatchEvent(
        new CustomEvent("trigger", { detail: { shortcut: a, event: b } })
      )
    }
    matchShortcut(a, b) {
      let c = [],
      ...
      c.sort(
        (f, g) =>
          GPShortcutsHandler_.MODIFIER_KEYS_ORDER[f] -
  ...
  class GPShortcutsManager_ extends EventTarget {
    ...
    constructor(a, b) {
      ...
      this.shortcuts = Object.assign(
        {},
        window.structuredClone(GPShortcutsManager_.DEFAULT_SHORTCUTS),
        JSON.parse(localStorage.getItem(GPShortcutsManager_.SHORTCUTS_STORAGE))
      )
    ...
    renderShortcuts(a = this.getShortcuts()) {
      ...
      for (let g in a) {
        ...
        e.className = "name_"
        b
          ? (e.textContent = this.formatShortcutName(g))
          : ((e.title = this.l.TOOLS[g][1]),
            (e.textContent = this.l.TOOLS[g][0]))
    ...
    handleViewScrollbar() {
      this.shortcutsElem.classList.toggle(
        "scrollbar_",
        this.shortcutsElem.scrollHeight > this.shortcutsElem.clientHeight
      )
    }
    handleViewScrollHints() {
      this.container.classList.toggle(
        "scroll-hint-top_",
        0 < this.shortcutsElem.scrollTop
      )
      this.container.classList.toggle(
        "scroll-hint-bottom_",
        this.shortcutsElem.offsetHeight + this.shortcutsElem.scrollTop <
    ...
    renderShortcut(a, b, c, d) {
      ...
      f.addEventListener("contextmenu", (g) => {
        this.activeShortcutElem === f &&
          (this.cancelBinding(f), g.preventDefault(), g.stopPropagation())
      })
      e.appendChild(f)
      c = document.createElement("div")
      ...
      d.addEventListener("click", (g) => {
        this.isAcceptedShortcut(this.bindingKeys, this.currentShortcutKeys)
          ? this.assignShortcut([...this.bindingKeys], this.activeShortcutElem)
    ...
    deleteShortcut(a, b, c) {
      ~b
        ? ((c = this.getShortcuts()),
          c[a].splice(b, 1),
          this.renderShortcuts(c),
          this.dispatchEvent(
            new CustomEvent("shortcuts_updated", { detail: { shortcuts: c } })
          ))
        : c.remove()
    }
    onShortcutSetClick(a) {
      ...
      a = a.target
      this.currentShortcutKeys = this.getShortcutsKeys(
        a.dataset.name,
        +a.dataset.index
      )
      this.pressedKeys.clear()
    ...
    stopShortcut(a) {
      this.activeShortcutElem
        ? this.activeShortcutElem.parentElement.contains(a.target) ||
          this.cancelBinding(this.activeShortcutElem)
    ...
    onKeyDown(a) {
      ...
      if (!a.repeat)
        switch (a.code) {
          ...
          default:
            this.pressedKeys.add(a.code),
              (this.bindingKeys = this.handlePressedKey(a)),
              this.activeShortcutElem.parentElement.parentElement.classList.add(
                "pressed_"
              ),
              this.updateShortcutPreview(this.bindingKeys)
        }
    }
    onKeyUp(a) {
      this.pressedKeys.delete(a.code)
      0 === this.pressedKeys.size &&
        this.activeShortcutElem.parentElement.parentElement.classList.remove(
          "pressed_"
        )
      a.preventDefault()
    }
    handlePressedKey(a) {
      if (0 !== this.pressedKeys.size) {
        ...
        b.sort(
          (d, e) =>
            GPShortcutsManager_.MODIFIER_KEYS_ORDER[d] -
            GPShortcutsManager_.MODIFIER_KEYS_ORDER[e]
        )
        return new Set([...b, ...c])
      }
    }
    ...
    updateShortcutPreview(a) {
      ...
      if (a.size) {
        ...
        if (d || e)
          c.classList.add("is-conflict_"),
            this.updateConflictWarning(c, b.parentElement, d, e)
        b.classList.toggle("is-warning_", d || e)
      } else
        b.innerHTML = this.formatShortcut(
          this.getShortcutsKeys(b.dataset.name, +b.dataset.index)
        )
      this.handleViewScrollbar()
      this.handleViewScrollHints()
    }
    updateConflictWarning(a, b, c, d) {
      ...
      b.after(a)
      a.innerHTML = `<div class="icon_"></div><div class="text_">${
        d
          ? `<span>${this.l.BINDINGS_RESERVED_KEYS}: </span>${d
              .map(
                (e) =>
                  `<span class="shortcut-name_">${this.formatKey(e)}</span>`
              )
              .join("")}`
          : `<span>${this.l.BINDINGS_CONFLICT_WARNING} </span><span class="shortcut-name_">${this.l.TOOLS[c][0]}</span>`
      }</div>`
    }
    ...
    findReservedKeys(a) {
      a = Array.from(a).filter((b) =>
        GPShortcutsManager_.RESERVED_KEYS.includes(b)
      )
    ...
    cancelBinding(a) {
      a.innerHTML = this.formatShortcut(
        this.getShortcutsKeys(a.dataset.name, +a.dataset.index)
      )
      this.endBinding(a)
    }
    endBinding(a) {
    ...
    resetShortcuts() {
      ...
      this.dispatchEvent(
        new CustomEvent("shortcuts_updated", { detail: { shortcuts: a } })
      )
    }
    updateShortcuts(a, b, c) {
      ...
      this.dispatchEvent(
        new CustomEvent("shortcuts_updated", { detail: { shortcuts: d } })
      )
    }
    formatShortcut(a) {
      if (!a) return "\u00a0"
    ...
    formatKey(a) {
      ...
      if (a in GPShortcutsManager_.KEY_ALIASES)
        return GPShortcutsManager_.KEY_ALIASES[a]
      const c = a.endsWith("Left") ? "Left" : a.endsWith("Right") ? "Right" : ""
      return c
        ? ((b = "Right" === c),
          (a = a.slice(0, -c.length)),
          a in GPShortcutsManager_.KEY_ALIASES &&
            (a = GPShortcutsManager_.KEY_ALIASES[a]),
          b ? `${a} (Right)` : a)
        : a
    }
    buildKeysMap(a) {
    ...
    findShortcut2(a) {
      ...
      let b
      return this.keysMap[a.size].some(({ name: c, keys: d }) => {
        b = c
        const e = a.values()
    ...
    saveShortcuts(a) {
      localStorage.setItem(
        GPShortcutsManager_.SHORTCUTS_STORAGE,
        JSON.stringify(a)
      )
    }
    areKeysLocked() {
  ...
  class GPZoomer_ extends EventTarget {
    ...
    constructor({ viewport: a, rotator: b, content: c }, d = {}) {
      ...
      this.zoomToPointScale =
        d.zoomToPointScale ?? GPZoomer_.ZOOM_TO_POINT_SCALE
    ...
    zoom(a, b, c, d = !0) {
      ...
      this.scale = Math.min(
        this.maxScale,
        Math.max(this.minScale, this.scale + a)
      )
      a = this.scale / c
    ...
    zoomToPoint(a, b, c, d = !0) {
      ...
      if (this.rotation % 360) {
        ...
        (c = f),
          ...
          (e = e.width / 2 / this.containerScale - f),
          (g = h - g)
      h = this.scale
    ...
    pan(a, b, c = !1) {
      if (this.rotation % 360) {
        ...
        (a = this.positionX + a / this.containerScale),
          (b = this.positionY + b / this.containerScale)
    ...
    getCoords(a) {
      ...
      return [
        Math.round((d - this.positionX) / this.scale),
        Math.round((e - this.positionY) / this.scale),
      ]
    }
    getMinScale() {
    ...
    setState({ scale: a, positionX: b, positionY: c, rotation: d }, e = !1) {
    ...
    applyViewportBounds(a, b) {
      var c = GPZoomer_.MIN_VISIBLE_PADDING,
        d =
          this.content.offsetWidth === this.viewport.offsetWidth
            ? this.content
    ...
    applyTransition(a) {
      this.content.style.transition = this.rotator.style.transition = a
        ? `transform ${GPZoomer_.ANIMATION_DURATION}s ${GPZoomer_.ANIMATION_EASING}`
        : "none"
    }
    updateTransform(a = !0) {
    ...
    dispatchScale() {
      this.dispatchEvent(
        new CustomEvent("scale", { detail: { scale: this.scale } })
      )
    }
    dispatchRotation() {
      this.dispatchEvent(
        new CustomEvent("rotation", {
          detail: { rotation: this.getRotation() },
        })
      )
    }
  }
  ...
  class GPReference_ extends EventTarget {
    ...
    static SETTINGS_UI = {
      ...
      minZoom: {
        ...
        args: { min: 0.1, max: 1, step: 0.1 },
        description:
          "\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u044b\u0439 \u0443\u0440\u043e\u0432\u0435\u043d\u044c \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0440\u0435\u0444\u0435\u0440\u0435\u043d\u0441\u0430",
      },
      maxZoom: {
        type: "slider",
        args: { min: 2, max: 60, step: 1 },
        description:
          "\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u044b\u0439 \u0443\u0440\u043e\u0432\u0435\u043d\u044c \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0440\u0435\u0444\u0435\u0440\u0435\u043d\u0441\u0430",
      },
      zoomStep: {
        type: "slider",
        args: { min: 0.1, max: 2, step: 0.1 },
        description:
          "\u041a\u043e\u044d\u0444\u0444\u0438\u0446\u0438\u0435\u043d\u0442 \u043c\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0440\u0435\u0444\u0435\u0440\u0435\u043d\u0441\u0430 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043b\u0435\u0441\u0430 \u043c\u044b\u0448\u0438",
      },
      _2: { text: "Frames" },
      frameStickyEdges: {
        type: "switch",
    ...
    constructor(a) {
      ...
      this.fm = new GPReferenceFrameManager_(
        ...
        GPReferenceFrameManager_.DEFAULT_STATIC_ANCHOR,
      ...
      this.fm.addEventListener("anchor", ({ detail: { anchor: b } }) => {
      ...
      document.addEventListener(
        ...
        ({
          ...
          b
            ? this.downloadImage(b, c, d, e, null, f, g, h)
            : g || (this.pendingImage = null)
          this.hideProgress()
        }
      )
    ...
    reset() {
      this.container &&
        (this.container.classList.remove("image-opened_"), this.zoomer.reset())
    }
    render() {
      this.container = document.createElement("div")
      ...
      a.addEventListener(
        ...
        async (e) => {
          e.preventDefault()
          let f
          e.dataTransfer.items && "file" === e.dataTransfer.items[0].kind
            ? (f = e.dataTransfer.items[0].getAsFile())
            : e.dataTransfer.files.length && (f = e.dataTransfer.files[0])
          if (f && GPReference_.IMAGE_TYPES.has(f.type)) {
            const g = new FileReader()
            g.addEventListener("loadend", (h) => {
              this.showPreview(g.result, 0, 0, { query: "file", type: f.type })
            })
            g.readAsDataURL(f)
          }
        },
      ...
      b.addEventListener("animationend", (e) => {
        "gp-ref-fade-out_" === e.animationName &&
      ...
      this.queryInput.addEventListener("keydown", (e) => {
        if ("Enter" === e.key) {
          ...
          GPReference_.URL_PATTERN.test(f)
            ? this.openImageURL(f)
            : f && ((this.lastQuery = f), this.searchImages(f, !1))
          e.target.blur()
      ...
      this.historyList.addEventListener("pointerup", (e) => {
        if ((e = e.target.closest(".history-item_"))) {
          var { url: f, width: g, height: h, query: k } = e.dataset
      ...
      this.searchEngines.addEventListener("click", (e) => {
        e.target.matches(".search-engine_.selected_") &&
          this.searchEngines.classList.remove("shown_")
      })
        ...
        (e) => {
          e.forEach((f) => {
            f.isIntersecting &&
              ((f = f.target),
              (f.src = f.dataset.src),
              this.imageObserver.unobserve(f))
          })
        },
        { root: this.results }
      )
      ...
      this.zoomer = new GPZoomer_(
        { viewport: this.imageWrapper, rotator: b, content: c },
        { minScale: this.s.minZoom, maxScale: this.s.maxZoom }
      )
      b = document.createElement("div")
    ...
    searchImages(a, b) {
      a &&
        ...
        this.abortImageRequest(),
        document.dispatchEvent(
          new CustomEvent("gp:ref.search", {
      ...
      return new Promise((e) => {
        ...
        f && g
          ? ((k = document.createElement("canvas")),
            (k.width = f),
            (k.height = g),
            k.getContext("2d").drawImage(this.image, p, r, f, g, 0, 0, f, g),
            k.toBlob(e))
          : e(null)
      })
    }
    ...
    emitSettings() {
      document.dispatchEvent(
        new CustomEvent("gp:ref.settings", {
          detail: { settings: window.structuredClone(this.settings) },
        })
      )
    }
  ...
  class GPReferenceFrame_ {
    ...
    static ANCHOR_PROPS = { t: "top", b: "bottom", l: "left", r: "right" }
    static ANCHOR = { TOP: "t", BOTTOM: "b", LEFT: "l", RIGHT: "r" }
    constructor(a, b = !1, c) {
      this.fm = c
    ...
    moveHandler(a) {
      if (0 === a.button) {
        var b = this.frame.dataset.anchor,
          ...
          k = ((l) => {
            const [m, p, r] = this.getStickyCoords(
              l,
              l.pageX - e,
              l.pageY - f,
              g,
        ...
        this.frame.addEventListener(
          ...
          () => {
            ...
            this.fm.isSingleFrame() &&
              ...
              this.staticAnchor ||
                this.frame.dataset.anchor === b ||
                ((this.fm.anchor = this.frame.dataset.anchor),
                this.dispatchAnchor(this.frame.dataset.anchor)))
          },
          { once: !0 }
        )
      ...
      this.fm.getFrames().forEach((q) => {
        if (q !== this) {
          ...
          u < f &&
            ...
            n.x + n.width >= b &&
            n.x <= b + d &&
            (!r || r[0] === q.frame.dataset.anchor[0]) &&
            ((k = u), (c = n.y - e), (m = r = q.frame.dataset.anchor))
          ...
          u < f &&
            ...
            n.x <= b + d &&
            (!r || r[0] === q.frame.dataset.anchor[0]) &&
            ((l = u), (c = n.y + n.height), (m = r = q.frame.dataset.anchor))
          u = Math.abs(n.x - (b + d))
          u < f &&
            (void 0 === g || u < g) &&
            n.y + n.height >= c &&
            n.y <= c + e &&
            (!p || p[1] === q.frame.dataset.anchor[1]) &&
            ((g = u), (b = n.x - d), (m = p = q.frame.dataset.anchor))
          ...
          u < f &&
            ...
            n.y <= c + e &&
            (!p || p[1] === q.frame.dataset.anchor[1]) &&
            ((h = u), (b = n.x + n.width), (m = p = q.frame.dataset.anchor))
        }
      })
      return [b, c, m]
    }
        ...
        var b = this.width,
          ...
          f = ((g) => {
            ...
            this.setSize(
              Math.min(
                Math.max(
                  d + (e[1] === GPReferenceFrame_.ANCHOR.LEFT ? g : -g),
                  this.minWidth
                ),
                GPReferenceFrame_.MAX_WIDTH
              )
    ...
    setPosition(a, b, c, d, e) {
      ...
      var h
      if (this.fm.staticAnchor)
        var k = (h = GPReferenceFrameManager_.MIN_FRAME_DISPLAY_AREA_SIZE)
      else (h = c), (k = d)
      h = Math.max(
        Math.min(a, f - (h + GPReferenceFrame_.BORDER_WIDTH)),
        GPReferenceFrame_.BORDER_WIDTH
      )
      k = Math.max(
        Math.min(b, g - (k + GPReferenceFrame_.BORDER_WIDTH)),
        GPReferenceFrame_.BORDER_WIDTH
      )
      a =
        e ??
        (this.fm.staticAnchor
          ? GPReferenceFrame_.DEFAULT_ANCHOR
          : (b + d / 2 > g / 2
              ? GPReferenceFrame_.ANCHOR.BOTTOM
              : GPReferenceFrame_.ANCHOR.TOP) +
            (a + c / 2 > f / 2
              ? GPReferenceFrame_.ANCHOR.RIGHT
              : GPReferenceFrame_.ANCHOR.LEFT))
      this.frame.dataset.anchor = a
      this.frame.style.inset = "unset"
      a[0] === GPReferenceFrame_.ANCHOR.TOP
        ? ((this.offsetY = Math.round(k)),
          (this.frame.style.top = `${this.offsetY}px`))
        : ((this.offsetY = Math.round(g - (k + d))),
          (this.frame.style.bottom = `${this.offsetY}px`))
      a[1] === GPReferenceFrame_.ANCHOR.LEFT
        ? ((this.offsetX = Math.round(h)),
          (this.frame.style.left = `${this.offsetX}px`))
        : ((this.offsetX = Math.round(f - (h + c))),
    ...
    dispatchAnchor(a) {
      this.fm.dispatchEvent(
        new CustomEvent("anchor", { detail: { anchor: a } })
      )
    }
    load(a) {
      ...
      this.image.onload = (c) => {
        ...
        if (this.isSeparated)
          (this.offsetX = this.fm.x),
            ...
            (this.frame.dataset.anchor = this.fm.anchor)
        else {
  ...
  class GPPlayersManager_ extends EventTarget {
    ...
    renderPlayer(a, b, c, d, e, f) {
      ...
      ;(e ?? this.s.autoplay) &&
        g.addEventListener("data_loaded", () => {
          g.play()
        })
    }
    closePlayers() {
  ...
  class GPTimelapsePlayer_ extends EventTarget {
    ...
    constructor(
      {
        image: {
          ...
          canvasTypeId: c,
          auth: d,
          meta: { author: e, title: f, date: g },
        },
        container: h,
        mainContainer: k,
      },
      l = GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE,
      m = !1
    ) {
      super()
    ...
    isMStroke(a) {
      return !(
        1 === a[0] &&
        a[3][0] > this.originalWidth &&
        a[3][1] > this.originalHeight
      ) ||
        a[3][0] - this.originalWidth - GPTimelapsePlayer_.M_STROKE_OFFSET ||
        a.at(-1)[1] - this.originalHeight - GPTimelapsePlayer_.M_STROKE_OFFSET
        ? !1
        : !0
    }
    render() {
    ...
    resizeHandler() {
      ...
      if (document.fullscreenElement === this.player)
        ...
        e = parseInt(e)
        f = parseInt(f)
        const { width: g, height: h } = this.lastContainerDimension
        if (d !== this.mainContainer || e !== g || f !== h)
          this.setSize(e, f),
    ...
    getDensityByDimensions(a, b) {
      a = Math.min(
        Math.ceil(a / this.originalWidth),
        Math.ceil(b / this.originalHeight)
      )
      return {
        density: a,
    ...
    initCacheWorker() {
      ...
      this.worker ||
        ...
        this.worker.addEventListener("message", ({ data: k }) => {
          "worker-ready" === k.type
            ? h.forEach((l) => {
                this.worker.postMessage({ type: "get-cache", density: l })
              })
            : "cache-updated" === k.type &&
              ((this.cache = k.cache),
              this.dispatchEvent(
                new CustomEvent("cache_updated", {
                  detail: { density: k.density },
                })
              ))
        }))
    ...
    cacheWorkerBody() {
      function a(f) {
        ...
        if (!this.cache[f]) {
          ...
          h = g.getContext("2d", { willReadFrequently: !0 })
          let p
          self.background &&
            ((h.fillStyle = d),
            h.fillRect(0, 0, g.width, g.height),
            self.draw(h, this.background, f, !1),
            (p = h.getImageData(0, 0, g.width, g.height)),
  ...
  class GPTimer_ extends EventTarget {
    ...
    static POINTER_TIMER_CHANGE_SENSITIVITY = Math.round(
      (window.screen.height / 1080) * 15
    )
    static DEFAULT_SETTINGS = {
      reverted: !0,
    ...
    static SETTINGS_UI = {
      reverted: {
        type: "switch",
        description:
          "\u0412\u043a\u043b\u044e\u0447\u0430\u0435\u0442 \u043e\u0442\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 \u043e\u0442\u0441\u0447\u0451\u0442\u0430 \u0432\u0440\u0435\u043c\u0435\u043d\u0438 \u0432 \u043e\u0431\u0440\u0430\u0442\u043d\u043e\u043c \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0438",
      },
      delimiterFlicker: {
        type: "switch",
        description:
          "\u0412\u043a\u043b\u044e\u0447\u0430\u0435\u0442 \u043c\u0435\u0440\u0446\u0430\u043d\u0438\u0435 \u0440\u0430\u0437\u0434\u0435\u043b\u0438\u0442\u0435\u043b\u044f \u0447\u0430\u0441\u043e\u0432 \u0438 \u043c\u0438\u043d\u0443\u0442",
      },
      _2: { text: "Sound Alert" },
      soundAlert: {
        type: "switch",
        description:
          "\u0417\u0432\u0443\u043a\u043e\u0432\u043e\u0435 \u043e\u043f\u043e\u0432\u0435\u0449\u0435\u043d\u0438\u0435, \u0441\u0438\u0433\u043d\u0430\u043b\u0438\u0437\u0438\u0440\u0443\u044e\u0449\u0435\u0435 \u043e \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u0438\u0438 \u0432\u0440\u0435\u043c\u0435\u043d\u0438",
      },
      soundAlertVolume: {
        type: "slider",
        args: { min: 0, max: 1, step: 0.01 },
        ...
        description:
          "\u0423\u0440\u043e\u0432\u0435\u043d\u044c \u0433\u0440\u043e\u043c\u043a\u043e\u0441\u0442\u0438 \u0437\u0432\u0443\u043a\u043e\u0432\u043e\u0433\u043e \u043e\u043f\u043e\u0432\u0435\u0449\u0435\u043d\u0438\u044f",
      },
      _3: { text: "Triggers" },
      runAfterTurnStart: {
        type: "switch",
        description:
          "\u0410\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u0437\u0430\u043f\u0443\u0441\u043a\u0430\u0442\u044c \u0442\u0430\u0439\u043c\u0435\u0440 \u043f\u043e\u0441\u043b\u0435 \u043d\u0430\u0447\u0430\u043b\u0430 \u0440\u0430\u0443\u043d\u0434\u0430",
      },
      readyAfterTimeExpires: {
        type: "switch",
        description:
          "\u0410\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438 \u043d\u0430\u0436\u0438\u043c\u0430\u0442\u044c \u043a\u043d\u043e\u043f\u043a\u0443 \u0433\u043e\u0442\u043e\u0432\u043d\u043e\u0441\u0442\u0438 \u043f\u043e \u0438\u0441\u0442\u0435\u0447\u0435\u043d\u0438\u0438 \u0432\u0440\u0435\u043c\u0435\u043d\u0438",
      },
      _4: { text: "Timers" },
      defaultTimer: {
        type: "dropdown",
        ...
        description:
          "\u0422\u0430\u0439\u043c\u0435\u0440 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0443\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u0435\u0442\u0441\u044f \u043f\u0440\u0438 \u0432\u0445\u043e\u0434\u0435 \u043d\u0430 \u0441\u0430\u0439\u0442)",
      },
      timers: {
        type: "list-multiple-dynamic",
        formatter: this.timeFormatter,
        description:
          "\u0421\u043f\u0438\u0441\u043e\u043a \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043d\u044b\u0445 \u0432\u0430\u043c\u0438 \u0442\u0430\u0439\u043c\u0435\u0440\u043e\u0432",
      },
    }
    static timeFormatter(a) {
      return `${Math.floor(a / 36e5)}:${String(
        Math.floor(a / 6e4) % 60
      ).padStart(2, "0")}`
    }
    ...
    onPointerDown(a) {
      ...
      else if (1 === a.button || (0 === a.button && a.ctrlKey))
        this.state === GPTimer_.STARTED ? this.reset() : this.toggleSetting()
    }
    onWheel(a) {
      var b = 0 > a.deltaY
      switch (this.state) {
        case GPTimer_.SETTING:
          ...
          switch (a.target) {
            case this.hours:
              ...
              break
            case this.minutes:
              ;(d += (b ? 1 : -1) * GPTimer_.SETTING_MINUTE_STEP),
                (d = (0 > d ? d + 60 : d) % 60)
          }
          this.value =
            36e5 * Math.max(Math.min(c, 24), 0) +
            6e4 * Math.max(Math.min(d, 55), 0)
          b = this.formatTime(this.value)
          this.renderTime(b)
          break
        case GPTimer_.STARTED:
          ;(a = this.s.timers.length),
            (c = this.s.timers.findIndex((e) => +e === this.value)),
            ~c
              ? ((b = c + (b ? -1 : 1)),
                (this.value = +this.s.timers[(0 > b ? b + a : b) % a]))
              : a && (this.value = +this.s.timers[0]),
            this.reset()
      }
    }
    onTimerChange(a) {
            ...
            if (Math.abs(e) >= GPTimer_.POINTER_TIMER_CHANGE_SENSITIVITY) {
              ...
              switch (d.currentTarget) {
                case this.hours:
                  ...
                  break
                case this.minutes:
                  ;(g += (f ? 1 : -1) * GPTimer_.SETTING_MINUTE_STEP),
                    (g = (0 > g ? g + 60 : g) % 60)
              }
              this.value =
                36e5 * Math.max(Math.min(e, 24), 0) +
                6e4 * Math.max(Math.min(g, 55), 0)
    ...
    onAddBtnClick(a) {
      this.value &&
        !this.s.timers.includes(String(this.value)) &&
        (this.s.timers = [...this.s.timers, String(this.value)].sort(
          (b, c) => c - b
        ))
    }
    toggleSetting() {
      this.state !== GPTimer_.SETTING
        ? (this.reset(), this.updateState(GPTimer_.SETTING))
        : this.updateState(GPTimer_.STOPPED)
    }
    revertTime(a) {
      this.state === GPTimer_.STARTED &&
        (void 0 === a && (this.s.reverted = a = !this.s.reverted),
        this.container.classList.remove("last-minute_"),
        (a = this.formatTime(
          a
            ? Math.max(this.value - this.elapsed, 0)
            : Math.min(this.elapsed, this.value)
        )),
        this.renderTime(a))
    }
    renderTime({ h: a, m: b, s: c }) {
      ...
      this.state !== GPTimer_.STARTED ||
        ...
        a ||
        b ||
        (this.container.classList.add("last-minute_"),
        (this.seconds.textContent = String(c).padStart(2, "0")))
    }
    tick() {
      this.elapsed = Date.now() - this.timeStarted
      const a = this.formatTime(
        this.s.reverted
          ? Math.max(this.value - this.elapsed, 0)
          : Math.min(this.elapsed, this.value)
      )
      ...
      this.elapsed >= this.value &&
        (this.stop(),
        this.s.soundAlert && !this.s.readyAfterTimeExpires && this.runAlert(),
        this.dispatchEvent(new Event("finish")),
        this.container.classList.add("finished_"))
    }
    playPause() {
      switch (this.state) {
    ...
    start() {
      ...
      this.state === GPTimer_.STOPPED
        ...
        : this.state === GPTimer_.PAUSED &&
          (this.timeStarted = Date.now() - (this.timePaused - this.timeStarted))
    ...
    updateSettings({ detail: { settings: a } }) {
      ...
      "delimiterFlicker" in a &&
        this.delimiter.classList.toggle("flicker_", a.delimiterFlicker)
      "soundAlertVolume" in a &&
        ((this.alert.volume = Number.parseFloat(a.soundAlertVolume)),
        1 === Object.keys(a).length && this.runAlert(0.3))
      "defaultTimer" in a &&
        this.state === GPTimer_.STOPPED &&
        (this.value = +a.defaultTimer)
    }
  }
  ...
  class GPKnownUsersDB_ extends EventTarget {
    ...
    init() {
      return new Promise((a, b) => {
        ...
        c.addEventListener("success", (d) => {
          ...
          this.db = d
          this.dispatchEvent(new CustomEvent("init", { detail: d }))
          a(d)
        })
        c.addEventListener("upgradeneeded", (d) => {
          ...
          d.createIndex("username", "username", { unique: !0 })
    ...
    addUser(a, b) {
      return this.db
        ? new Promise(async (c) => {
            var d = { username: a, last_seen: Date.now() }
            b ||= await this.getStore(GPKnownUsersDB_.WRITE)
            d = b.put(d)
            d.addEventListener("success", async (e) => {
              ;(await this.size()) > GPKnownUsersDB_.USERS_LIMIT &&
                (await this.clean())
              c(!0)
            })
            d.addEventListener("error", (e) => {
      ...
      if (this.db) {
        ...
        if (!(0 >= a)) {
          ...
          b.index("last_seen")
            ...
            .addEventListener("success", (c) => {
              ;(c = c.target.result) &&
                a &&
                (b.delete(c.primaryKey), a--, c.continue())
            })
        }
      }
    }
    size() {
      return new Promise(async (a) => {
        ;(await this.getStore(GPKnownUsersDB_.READ))
          .count()
          .addEventListener("success", (b) => {
            a(b.target.result)
          })
      })
    }
    async getStore(a) {
      try {
        return this.db
          .transaction([GPKnownUsersDB_.STORE_NAME], a)
          .objectStore(GPKnownUsersDB_.STORE_NAME)
      } catch (b) {
  ...
  class GPModeration_ extends EventTarget {
    ...
    static TWITCH_APP_REDIRECT_URI =
      "https://gpmod.github.io/twitch-token?WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW&tokenType={token-type}"
    static TWITCH_AUTH_URL = `https://id.twitch.tv/oauth2/authorize?client_id=${
      this.TWITCH_APP_CLIENT_ID
    }&redirect_uri=${encodeURIComponent(
      this.TWITCH_APP_REDIRECT_URI
    )}&response_type=token&scope=${this.TWITCH_APP_SCOPES}`
    static TWITCH_BANS_API = "https://api.twitch.tv/helix/moderation/bans"
    static NEW_ACCOUNT_PERIODS = [
      "3600000",
      "86400000",
      "604800000",
      "2678400000",
    ...
    static SETTINGS_UI = {
      autoKick: {
        type: "switch",
        description:
          "\u0412\u044b\u0433\u043e\u043d\u044f\u0442\u044c \u0438\u0437 \u043b\u043e\u0431\u0431\u0438 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0438\u0437 \u0441\u043f\u0438\u0441\u043a\u0430 \u0437\u0430\u0431\u0430\u043d\u0435\u043d\u043d\u044b\u0445",
      },
      autoKickNewAccounts: {
        type: "switch",
        description:
          "\u0412\u044b\u0433\u043e\u043d\u044f\u0442\u044c \u0438\u0437 \u043b\u043e\u0431\u0431\u0438 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0441 \u043d\u043e\u0432\u044b\u043c\u0438 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0430\u043c\u0438 (Twitch)",
      },
      copyUsernamesWithClick: {
        type: "switch",
        description:
          "\u041a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0438\u043c\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0438 \u043f\u0440\u0438 \u043d\u0430\u0436\u0430\u0442\u0438\u0438 \u043d\u0430 \u0435\u0433\u043e \u043d\u0438\u043a \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0435 \u0438\u043b\u0438 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u043e\u0432",
      },
      _1: { text: "Interface" },
      compactMode: {
        type: "switch",
        description:
          "\u041a\u043e\u043c\u043f\u0430\u043a\u0442\u043d\u044b\u0439 \u0440\u0435\u0436\u0438\u043c \u043e\u0442\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f \u043f\u0430\u043d\u0435\u043b\u0438 \u0441\u043f\u0438\u0441\u043a\u0430 \u0438\u0433\u0440\u043e\u043a\u043e\u0432",
      },
      playersColorIndication: {
        type: "switch",
        description:
          "\u041e\u0442\u043e\u0431\u0440\u0430\u0436\u0430\u0442\u044c \u0446\u0432\u0435\u0442\u043e\u0432\u044b\u0435 \u043e\u0431\u043e\u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u0437\u0430\u0431\u0430\u043d\u0435\u043d\u043d\u044b\u0445, \u043d\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043d\u044b\u0445 \u0438 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0441 \u043d\u043e\u0432\u044b\u043c\u0438 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0430\u043c\u0438 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0440\u043e\u0434\u043d\u043e\u0433\u043e \u0438\u043d\u0442\u0435\u0440\u0444\u0435\u0439\u0441\u0430",
      },
      twitchFollowerBadges: {
        type: "switch",
        description:
          "\u041e\u0442\u043e\u0431\u0440\u0430\u0436\u0430\u0442\u044c \u0437\u043d\u0430\u0447\u043e\u043a \u0444\u043e\u043b\u043b\u043e\u0432\u0435\u0440\u0430 \u0434\u043b\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0435\u0439 Twitch",
      },
      twitchSubscriberBadges: {
        type: "switch",
        description:
          "\u041e\u0442\u043e\u0431\u0440\u0430\u0436\u0430\u0442\u044c \u0437\u043d\u0430\u0447\u043e\u043a \u043f\u043e\u0434\u043f\u0438\u0441\u0447\u0438\u043a\u0430 \u0434\u043b\u044f \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0435\u0439 Twitch",
      },
      disableLocalizedTwitchUsernames: {
        type: "switch",
        description:
          "\u0417\u0430\u043c\u0435\u043d\u044f\u0442\u044c \u044f\u043f\u043e\u043d\u0441\u043a\u0438\u0435, \u043a\u043e\u0440\u0435\u0439\u0441\u043a\u0438\u0435 \u0438 \u043a\u0438\u0442\u0430\u0439\u0441\u043a\u0438\u0435 \u0438\u043c\u0435\u043d\u0430 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0435\u0439 \u0432 \u0441\u043f\u0438\u0441\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0438 \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0430\u0445 \u043d\u0430 \u0438\u043c\u0435\u043d\u0430 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u043e\u0432",
      },
      _2: { text: "Censor Content" },
      censorDrawings: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0440\u0438\u0441\u0443\u043d\u043a\u0438 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0432\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0445 \u0441\u043f\u0438\u0441\u043e\u043a \u0437\u0430\u0431\u0430\u043d\u0435\u043d\u043d\u044b\u0445",
      },
      censorSentences: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u044f \u0440\u0438\u0441\u0443\u043d\u043a\u043e\u0432 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0432\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0445 \u0441\u043f\u0438\u0441\u043e\u043a \u0437\u0430\u0431\u0430\u043d\u0435\u043d\u043d\u044b\u0445",
      },
      censorNicknames: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0438\u043c\u0435\u043d\u0430 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0432\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0445 \u0432 \u0441\u043f\u0438\u0441\u043e\u043a \u0437\u0430\u0431\u0430\u043d\u0435\u043d\u043d\u044b\u0445",
      },
      _3: { text: "Censor Rules" },
      censorUnknownPlayers: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u043a\u043e\u043d\u0442\u0435\u043d\u0442 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u043a\u043e\u0442\u043e\u0440\u044b\u0445 \u0412\u044b \u0432\u0438\u0434\u0438\u0442\u0435 \u0432 \u0438\u0433\u0440\u0430\u0445 \u0432\u043f\u0435\u0440\u0432\u044b\u0435",
      },
      censorNewAccounts: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u043a\u043e\u043d\u0442\u0435\u043d\u0442 \u0438\u0433\u0440\u043e\u043a\u043e\u0432, \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u044b \u043a\u043e\u0442\u043e\u0440\u044b\u0445 \u0441\u0447\u0438\u0442\u0430\u044e\u0442\u0441\u044f \u043d\u043e\u0432\u044b\u043c\u0438 (Twitch)",
      },
      newAccountPeriod: {
        type: "dropdown",
        args: { items: GPModeration_.NEW_ACCOUNT_PERIODS },
        formatter: this.newAccountPeriodFormatter,
        description:
          "\u041f\u0435\u0440\u0438\u043e\u0434, \u0432 \u0442\u0435\u0447\u0435\u043d\u0438\u0435 \u043a\u043e\u0442\u043e\u0440\u043e\u0433\u043e \u0430\u043a\u043a\u0430\u0443\u043d\u0442 \u0441\u0447\u0438\u0442\u0430\u0435\u0442\u0441\u044f \u043d\u043e\u0432\u044b\u043c",
      },
      safeMode: {
        type: "switch",
        description:
          "\u0421\u043a\u0440\u044b\u0432\u0430\u0442\u044c \u0440\u0438\u0441\u0443\u043d\u043a\u0438\u00a0\u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e\n\u0420\u0438\u0441\u0443\u043d\u043a\u0438 \u043c\u043e\u0436\u043d\u043e \u043f\u0440\u043e\u0441\u043c\u0430\u0442\u0440\u0438\u0432\u0430\u0442\u044c \u0447\u0435\u0440\u0435\u0437 \u043f\u0430\u043d\u0435\u043b\u044c \u043f\u0440\u0435\u0434\u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430 \u043f\u0435\u0440\u0435\u0434 \u043f\u043e\u043a\u0430\u0437\u043e\u043c \u0438\u0445 \u043d\u0430 \u0442\u0440\u0430\u043d\u0441\u043b\u044f\u0446\u0438\u0438",
      },
      _4: { text: "Twitch Integration" },
      userBansSyncWithTwitch: {
        type: "switch",
        description:
          "\u0421\u0438\u043d\u0445\u0440\u043e\u043d\u0438\u0437\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0431\u043b\u043e\u043a\u0438\u0440\u043e\u0432\u043a\u0443 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 \u0432 Gartic Phone \u0441 \u0431\u043b\u043e\u043a\u0438\u0440\u043e\u0432\u043a\u0430\u043c\u0438 \u043d\u0430 Twitch\n\u0412 \u0438\u0433\u0440\u0430\u0445 \u0441 \u0430\u0432\u0442\u043e\u0440\u0438\u0437\u0430\u0446\u0438\u0435\u0439 \u0447\u0435\u0440\u0435\u0437 Twitch \u0431\u0430\u043d\u044b/\u0440\u0430\u0437\u0431\u0430\u043d\u044b \u043f\u0440\u0438\u0432\u043e\u0434\u044f\u0442 \u043a \u0431\u0430\u043d\u0430\u043c/\u0440\u0430\u0437\u0431\u0430\u043d\u0430\u043c \u043d\u0430 \u043a\u0430\u043d\u0430\u043b\u0435 Twitch",
      },
      _5: { text: "Reports" },
      sendBanReports: {
        type: "switch",
        description:
          "\u041e\u0442\u0441\u044b\u043b\u0430\u0442\u044c \u043e\u0442\u0447\u0451\u0442\u044b \u043e \u0440\u0438\u0441\u0443\u043d\u043a\u0430\u0445 \u043f\u0440\u0438 \u0431\u043b\u043e\u043a\u0438\u0440\u043e\u0432\u043a\u0435 \u0438\u0433\u0440\u043e\u043a\u0430 \u0447\u0435\u0440\u0435\u0437 \u043d\u0430\u0436\u0430\u0442\u0438\u0435 \u043d\u0430 \u0430\u0432\u0430\u0442\u0430\u0440 \u0432 \u0430\u043b\u044c\u0431\u043e\u043c\u0435\n\u0412 \u0446\u0435\u043b\u044f\u0445 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u044f \u0430\u0432\u0442\u043e\u0440\u0430 \u0440\u0438\u0441\u0443\u043d\u043a\u0430 \u0432 \u0433\u043b\u043e\u0431\u0430\u043b\u044c\u043d\u044b\u0439 \u0441\u043f\u0438\u0441\u043e\u043a \u0437\u0430\u0431\u0430\u043d\u0435\u043d\u043d\u044b\u0445 \u0438\u0433\u0440\u043e\u043a\u043e\u0432 (\u043f\u043e\u0441\u043b\u0435 \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438)",
      },
    }
    ...
    static MODULE = {
      ...
      alias: "mod",
      dependencies:
        "GPUtils_ GPAssets_ GPContentObserver_ GPKnownUsersDB_ GPImageReportSender_ GPPreview_".split(
          " "
        ),
      settings: {
        storage: "gp_userlist",
    ...
    constructor(a) {
      ...
      this.twitchAPI.addEventListener(
        "token",
        ({ detail: { type: b, token: c } }) => {
          switch (b) {
      ...
      this.banlist = new Set(
        this.prx.isTwitchOAuth
          ? null
          : JSON.parse(localStorage.getItem("ul_banlist"))
      )
      ...
      GPUtils_.bindMethods(
        [
          ...
          this.handleAlbumAvatars,
          this.handleAlbumItem,
          this.handlePreviewItem,
          this.handleAlbumUsername,
          this.handleAlbumHeader,
          this.handleAlbumFooter,
          this.handleAlbumRanking,
          this.handlePainterHeader,
        ],
        this
      )
      ...
      this.contentObserver.addAlbumItemsHandler(
        this.handleAlbumAvatars,
        this.handleAlbumItem,
        this.handlePreviewItem,
        this.handleAlbumUsername
      ...
      this.reportSender = new GPImageReportSender_(
        GPImageReportSender_.BAN,
        this.prx,
        a.act
      )
      this.preview = new GPPreview_(
        this.prx,
        this.s.previewEnabled,
        this.s.previewPanelPos,
        this.s.previewPanelWidth,
        this.l
      )
      this.preview.addEventListener("status", ({ detail: { status: b } }) => {
        this.s.previewEnabled = b
      })
      this.preview.addEventListener("panel_pos_changed", ({ detail: b }) => {
      ...
      this.newAccountLabels = this.l.NEW_ACCOUNT_AGE.split("|").map((b) =>
        b.split(",")
      )
      ...
      a = document.documentElement.style
      a.setProperty(
        "--mod-item-banned-player",
        `'${this.l.ITEM_BANNED_PLAYER}'`
      )
      a.setProperty("--mod-item-censored-bg", `'${this.l.ITEM_CENSORED_BG}'`)
      a.setProperty(
        "--mod-item-unknown-player",
        `'${this.l.ITEM_UNKNOWN_PLAYER}'`
      )
      ...
      GPUtils_.bindMethods(
        [
          ...
          this.banlistClickHandler,
          this.albumItemClickHandler,
          this.albumItemEnterHandler,
          this.albumItemLeaveHandler,
          this.preventAlbumContentInteraction,
          this.imagePreviewOverHandler,
          this.imagePreviewDownHandler,
          this.painterHeaderTextOverHandler,
          this.painterHeaderTextDownHandler,
        ],
        this
      )
      this.prx.addEventListener("data", ({ detail: { event: b } }) => {
        if (this.prx.isAuthorized || this.prx.isTwitchOAuth)
          b === GPProxy_.EVENT.GAME_STARTED
            ...
            : b === GPProxy_.EVENT.GALLERY_SETTINGS &&
              ...
              (this.isMiddlewareActive = !0),
              this.init()),
            this.isMiddlewareActive &&
              [
                GPProxy_.EVENT.NEW_GAME,
                GPProxy_.EVENT.ALBUM_SCORE,
                GPProxy_.EVENT.GAME_QUIT,
              ...
              (this.prx.removeWSMsgMiddleware(this.middleware),
              (this.isMiddlewareActive = !1),
              this.terminate())
      })
      this.prx.addEventListener("rejoin", ({ detail: { stage: b } }) => {
          ...
          var b = this.prx
            ...
            .filter(
              ({ nick: c, viewer: d }) =>
                !this.prx.isYou(c) &&
                !d &&
                !this.banlist.has(this.prx.formatNickname(c))
            )
            .map((c) => c.nick)
          this.usersDB.addUsers(b)
        }
      })
      this.prx.addEventListener("users_updated", ({ detail: { users: b } }) => {
        this.renderUsers(b)
      })
      this.prx.addEventListener("player_joined", ({ detail: b }) => {
        this.clearPlayers([b])
      ...
      document.addEventListener(
        "_tw_users_data",
        ({ detail: { userDatesCreated: b, followers: c, subscribers: d } }) => {
          this.updateUserDatesCreatedCache(b)
          this.updateFollowers(c)
          this.updateSubscribers(d)
          this.clearPlayers()
          this.renderUsers()
          this.s.twitchFollowerBadges || this.s.twitchSubscriberBadges
            ? this.updatePlayerItems()
            : Object.keys(b).length &&
              this.prx.getUsers().forEach((e) => {
                this.prx.formatNickname(e.nick) in b &&
                  this.isNewAccount(e.nick) &&
                  this.updatePlayerItem(e.nick)
              })
        }
      )
      document.addEventListener(
        "gp:tw.ids_usernames",
        ({ detail: { usernamesMap: b, localizedLoginsMap: c } }) => {
          this.updateUserIdsCache(b)
          this.updateLocalizedLogins(c)
          c.size &&
            (this.prx.getUsers().forEach((d) => {
      ...
      this.ac &&
        this.ac.addEventListener("trigger", this.acTriggerHandler.bind(this))
      this.render()
      this.initInitialState()
      this.prx.isTwitchAuth() &&
        (this.s.userBansSyncWithTwitch && this.checkTwitchTokenStatus(),
        (this.s.twitchFollowerBadges || this.s.twitchSubscriberBadges) &&
    ...
    initUsernamesCopying() {
      this.prx.isAuthorized &&
        document
          ...
          ?.classList.toggle("gp-copy-username_", this.s.copyUsernamesWithClick)
    }
    render() {
      this.renderUserlist()
    }
    ...
    renderBanlist() {
      ...
      b.appendChild(c)
      this.banlist.size
        ? this.banlist.forEach((d) => {
            var e = d
            let f = !1
            if (
              this.prx.isTwitchAuth() &&
              this.s.disableLocalizedTwitchUsernames
            ) {
              var g = this.localizedLogins.get(
                this.prx
                  .getUsers()
                  .find((k) => this.prx.formatNickname(k.nick) === d)?.nick
              )
              g && ((e = g), (f = !0))
            }
        ...
        : ((c = document.createElement("div")),
          (c.className = "ul-banlist-placeholder_"),
          (c.textContent = this.l.BANLIST_EMPTY),
          b.appendChild(c))
    ...
    updateBanlistUsername(a, b) {
      ...
      const c = this.banlistElem.querySelector(
        `.ul-banned-user_[data-username="${a}"] .username_`
      )
      c &&
        ((c.title = b ? `${b}   |   ${a}` : a),
        (c.textContent = b ?? a),
    ...
    renderUser(a) {
      ...
      c.appendChild(d)
      this.prx.isAuthorized
        ? ((c = this.prx.formatNickname(a.nick)),
          this.av.requestAvatarURL(c, (g) => {
            d.style.backgroundImage = `url(${g})`
          }))
        : this.prx.isTwitchOAuth &&
          a.nick === this.prx.getNickname() &&
          this.av.requestAvatarURL(this.prx.twitchOAuthLogin, (g) => {
            d.style.backgroundImage = `url(${g})`
          })
      let e = a.nick
      c = !1
      if (this.prx.isTwitchAuth()) {
        ...
        this.prx.isHost() &&
          !this.prx.isYou(e) &&
          (this.s.twitchFollowerBadges &&
            this.followers[a.nick] &&
            b.classList.add("follower_"),
          this.s.twitchSubscriberBadges &&
            this.subscribers[a.nick] &&
            b.classList.add("subscriber_"))
      }
      const f = document.createElement("div")
      ...
      a.you ||
        this.prx.isTwitchOAuth ||
        this.usersDB.hasUser(a.nick).then((g) => {
          g ||
            (b.classList.toggle("unknown_", !g),
            (f.dataset.sinceCreation = e),
            this.isNewAccount(a.nick) &&
              (b.classList.add("new_"),
              (b.dataset.created = this.getDateCreated(a.nick)),
              b.addEventListener("pointerenter", (h) => {
                f.dataset.sinceCreation =
                  this.getSinceCreationTime(b.dataset.created) ?? e
              })))
        })
      c = document.createElement("div")
    ...
    handlePlayerItem(a, b) {
      ...
      if (this.prx.isHost() && this.s.playersColorIndication) {
        ...
        this.isBannedUser(d)
          ? (a.dataset.state = "banned")
          : this.prx.isTwitchOAuth ||
            this.usersDB.hasUser(d).then((e) => {
              e ||
                (this.isNewAccount(d)
                  ? (a.dataset.state = "new")
      ...
      this.prx.isTwitchAuth() &&
        (this.s.disableLocalizedTwitchUsernames
          ? (b = this.localizedLogins.get(d))
            ? (c.dataset.login = b)
            : delete c.dataset.login
          : delete c.dataset.login,
        delete a.dataset.badge,
        this.prx.isHost() &&
          !this.prx.isYou(d) &&
          (this.s.twitchFollowerBadges && this.followers[d]
            ? (a.dataset.badge = "follower")
            : this.s.twitchSubscriberBadges &&
              this.subscribers[d] &&
              (a.dataset.badge = "subscriber")))
    }
    updatePlayerItem(a) {
      if (this.prx.isHost()) {
    ...
    updatePlayerItems() {
      this.contentObserver.getPlayerItems().size &&
        this.prx.getUsers().forEach((a) => {
    ...
    isUserBanned({ nick: a, id: b }) {
      return a && b
        ? !this.prx.isYou(b) && this.banlist.has(this.prx.formatNickname(a))
        : !1
    }
    clearPlayers(a) {
      this.prx.isHost() &&
        (this.s.autoKick || this.s.autoKickNewAccounts) &&
        ((a = a || this.prx.getUsers()),
        this.prx.isGameStage(GPProxy_.GAME_STAGE.LOBBY) &&
          a.forEach((b) => {
            this.prx.isYou(b.nick) ||
              this.usersDB.hasUser(b.nick).then((c) => {
                ;((this.s.autoKick && this.isUserBanned(b)) ||
                  (this.s.autoKickNewAccounts &&
                    this.isNewAccount(b.nick) &&
                    !c)) &&
                  this.prx.kickPlayer(b.id)
              })
          }))
    }
    usersClickHandler(a) {
      ...
      if (this.prx.isAuthorized || this.prx.isTwitchOAuth)
        if (
          ((a = a.target.closest(".ul-user_")), !a?.classList.contains("you_"))
        ) {
    ...
    banlistClickHandler(a) {
      ...
      if (b)
        if (((b = b.dataset.username), a.target.matches(".username_")))
          navigator.clipboard.writeText(a.target.dataset.login ?? b)
        else if (a.target.matches(".remove-btn_")) {
          const c = this.findNickname(b)
          this.banlist.delete(b)
          this.s.userBansSyncWithTwitch &&
            this.prx.isTwitchAuth() &&
            this.unbanTwitchUser(b)
          this.renderBanlist()
          c &&
            (this.renderUsers(),
            this.clearPlayers(),
            this.updatePlayerItem(c),
            this.handleItems())
          this.saveBanlist()
        }
      a.preventDefault()
    ...
    findNickname(a) {
      return this.prx
        .getUsers()
        .find((b) => a === this.prx.formatNickname(b.nick))?.nick
    }
    middleware([a, b]) {
      if (
        !this.s.censorDrawings &&
        !this.s.censorNicknames &&
        !this.s.censorSentences
      )
        return [a, b]
      if (a[1] === GPProxy_.EVENT.ALBUM_ITEM && a[2].active) {
        if (
          (this.s.safeMode &&
            a[2].type === GPProxy_.ALBUM_ITEM_TYPE.TEXT &&
            ((a[3] = null), (b = !0)),
          this.isUserBanned(a[2].user))
        )
          if (a[2].data?.length)
            switch (a[2].type) {
            ...
            this.prx.isGameOrder(
              GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND
            ) &&
              this.s.censorDrawings &&
              a[2].bg &&
              ((a[2].data = this.prx.getAlbum().background),
              (a[2].bg = !1),
              (this.isAlbumBgHidden = b = !0))
        ...
        a[2].background &&
          ...
          this.isUserBanned(a[2].bookAuthor) &&
          this.s.censorDrawings &&
          ((a[2].background = []), (this.isAlbumBgHidden = b = !0))
        const c =
          this.prx.isGameOrder(
            GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND
          ) &&
          this.isUserBanned(this.prx.getAlbum().bookAuthor) &&
          this.s.censorDrawings
        a[2].timeline?.length &&
          (a[2].timeline = a[2].timeline.map((d) => {
            c &&
              d.bg &&
              ((d.data = this.prx.getAlbum().background), (d.bg = !1), (b = !0))
            return d
          }))
      }
      return [a, b]
    ...
    async albumItemClickHandler(a) {
      if (0 === a.button) {
        ...
        if (b && !this.isAIImageItem(b)) {
          ...
          if (this.s.copyUsernamesWithClick && this.isAlbumUsername(a.target))
            navigator.clipboard.writeText(a.target.dataset.login ?? d)
          else {
            var e,
              f = !1
            if (this.isAlbumAvatar(a.target))
              this.prx.isYou(d) ||
                this.isAnimationOrMultiPieceItem(b) ||
                ((e = this.toggleUserBan(d)) &&
                  this.s.sendBanReports &&
              ...
              if (
                this.s.safeMode &&
                !this.isBannedItem(b) &&
                !this.safeItems.has(c)
              ) {
                this.safeItems.add(c)
                this.isAnimationOrMultiPieceItem(b) &&
                  this.hasCensoredImageItems() &&
                  this.toggleAlbumItemPreview(b, !0)
                this.handleAlbumItem(b)
                return
              }
              this.shouldBeBannedItem(b, d) ||
              this.isPreviewedItem(b) ||
              (b.dataset.cr &&
                b.dataset.cr !== GPModeration_.CENSORING_REASON.BY_USER)
                ? (this.toggleAlbumItemPreview(b),
                  (f = !0),
                  this.preview.isEnabled() &&
                    (this.preview.clear(), b.classList.remove("previewed_")))
                : this.censorItems.has(c)
                ? this.censorItems.delete(c)
                : this.censorItems.set(c, b.dataset.type)
            }
            void 0 !== e ||
            (this.prx.isGameOrder(
              GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND_NO_PREVIEW
            ) &&
              0 === this.getItemId(b))
              ? this.handleItems(f ? b : null)
              : (this.handleAlbumItem(b),
                this.prx.isAnimateMode() &&
                  !this.isAnimationItem(b) &&
                  (a = this.getAnimationItem()) &&
                  (this.toggleAlbumItemPreview(a, !1), this.handleAlbumItem(a)),
                this.prx.isMultiPieceMode() &&
                  !this.isMultiPieceItem(b) &&
                  (b = this.getMultiPieceItem()) &&
                  (this.toggleAlbumItemPreview(b, !1), this.handleAlbumItem(b)))
          }
        }
      }
    }
    isAlbumUsername(a) {
      return a.matches(
        ":is(.answerBalloon, .drawBalloon) > div:not(.avatar) > span"
      )
    }
    isAlbumAvatar(a) {
    ...
    isAlbumContent(a) {
      return (
        (("CANVAS" === a.tagName || "SPAN" === a.tagName) &&
          a.closest(".drawBalloon:not(.load)")) ||
        (("SPAN" === a.tagName || a.classList.contains("balloon")) &&
    ...
    handleAlbumItem(a) {
      ...
      if (!this.isAIImageItem(a)) {
        ...
        if (this.isAnimationOrMultiPieceItem(a))
          this.shouldBeCensoredBySafemode(a)
            ? this.censorItem(a, GPModeration_.CENSORING_REASON.SAFE_MODE)
            : this.hasCensoredImageItems()
            ? this.censorItem(a, GPModeration_.CENSORING_REASON.ANIMATION_FRAME)
            : this.shouldBeCensoredItem(a) &&
              this.censorItem(a, GPModeration_.CENSORING_REASON.BY_USER)
        else if (
          (this.isBannedUser(b) && a.classList.add("banned_"),
          this.isSuspiciousItem(a) && a.classList.add("suspicious_"),
          this.shouldBeBannedItem(a, b))
        )
          this.censorItem(a, GPModeration_.CENSORING_REASON.BANNED_PLAYER)
        else {
          ...
          this.shouldByCensoredByBackground(a)
            ? this.censorItem(a, GPModeration_.CENSORING_REASON.BACKGROUND)
            : this.shouldBeCensoredItem(a) &&
              this.censorItem(a, GPModeration_.CENSORING_REASON.BY_USER)
        }
      }
    ...
    async handleItems(a) {
      for (const b of this.albumItems)
        b !== a &&
          (this.toggleAlbumItemPreview(b, !1), await this.handleAlbumItem(b))
    }
    resetItem(a) {
      a.classList.remove(
        "banned_",
    ...
    isSuspiciousItem(a) {
      return this.isImageItem(a)
        ? this.suspiciousItems.has(this.getContentId(a))
        : !1
    }
    ...
    censorItem(a, b = GPModeration_.CENSORING_REASON.BY_USER) {
      ...
      a.dataset.cr = b
      b === GPModeration_.CENSORING_REASON.BANNED_PLAYER &&
        a.classList.toggle("censored-nickname_", this.s.censorNicknames)
    }
    shouldBeCensoredBySafemode(a) {
      return this.s.safeMode && !this.safeItems.has(this.getContentId(a))
    }
    shouldByCensoredByBackground(a) {
      return (this.prx.isGameOrder(
        GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND_NO_PREVIEW
      ) ||
        (this.prx.isGameOrder(GPProxy_.GAME_ORDER.DRAWINGS_WITH_A_BACKGROUND) &&
          !this.isAlbumBgHidden)) &&
        0 < this.getItemId(a)
        ? ((a = this.getNickname(this.albumItems[0])),
          this.shouldBeBannedItem(this.albumItems[0], a) ||
            this.isCensoredItem(this.albumItems[0]))
        : !1
    }
    ...
    shouldBeBannedItem(a, b) {
      return this.isAnimationOrMultiPieceItem(a)
        ? !1
        : this.isBannedUser(b) &&
          ((this.isImageItem(a) && this.s.censorDrawings) ||
            (this.isTextItem(a) && this.s.censorSentences))
        ? !0
        : !1
    }
    shouldBeCensoredByUnknownPlayer(a, b) {
      a = this.isImageItem(a)
      return !this.prx.isYou(b) &&
        this.s.censorUnknownPlayers &&
        ((this.s.censorDrawings && a) || (this.s.censorSentences && !a))
        ? this.unknownUsers.has(b)
        : !1
    }
    async parseUnknownUsers() {
      const a = this.prx
          .getUsers()
          .filter((c) => !c.viewer && !c.owner)
          .map((c) => c.nick),
    ...
    toggleUserBan(a) {
      ...
      c
        ? (this.banlist.add(b),
          this.prx.isTwitchOAuth ||
            (this.usersDB.deleteUser(a), this.unknownUsers.add(a)))
        : this.banlist.delete(b)
      this.s.userBansSyncWithTwitch &&
        this.prx.isTwitchAuth() &&
        (c ? this.banTwitchUser(b) : this.unbanTwitchUser(b))
      this.renderUsers()
      this.renderBanlist()
      this.clearPlayers()
    ...
    getContentId(a) {
      return this.prx.isGameStage(GPProxy_.GAME_STAGE.ALBUM)
        ? `${this.prx.getCurrentAlbumId()}_${this.getItemId(a)}`
    ...
    hasCensoredImageItems() {
      return this.albumItems.some((a) => this.isCensoredImageItem(a))
        ? !0
        : this.s.censorDrawings
        ? this.albumItems.some(
            (a) =>
              this.isImageItem(a) &&
              (a.dataset.cr === GPModeration_.CENSORING_REASON.BANNED_PLAYER ||
                a.dataset.cr ===
                  GPModeration_.CENSORING_REASON.UNKNOWN_PLAYER ||
                a.dataset.cr === GPModeration_.CENSORING_REASON.NEW_ACCOUNT)
          )
        : !1
    }
    isTextItem(a) {
    ...
    isNewAccount(a) {
      ...
      return (
        !!a && Date.now() - new Date(a).getTime() <= +this.s.newAccountPeriod
      )
    }
    getDateCreated(a) {
    ...
    requestUserDatesCreated(a) {
      this.prx.isHost() &&
        ...
        ((a = a
          .filter(
            (b) =>
              !this.hasUserDateCreated(b.nick) &&
              !this.prx.isYou(b.nick) &&
              !this.prx.isViewer(b)
          )
          .map((b) => this.prx.formatNickname(b.nick))),
        a.length &&
          document.dispatchEvent(
            new CustomEvent("_request_user_dates_created", {
              detail: { usernames: a },
            })
          ))
    }
    ...
    requestTwitchUsersData(a) {
      if (this.prx.isHost() && this.prx.isTwitchAuth()) {
        var b = a
          .filter((d) => !this.prx.isYou(d.nick) && !this.prx.isViewer(d))
          .map((d) => this.prx.formatNickname(d.nick))
        a = b.filter((d) => !(d in this.userDatesCreated))
        b =
          this.s.twitchFollowerBadges || this.s.twitchSubscriberBadges ? b : []
        if (a.length || b.length) {
          var c = !!this.s.twitchToken2
          document.dispatchEvent(
            new CustomEvent("_request_users_data", {
              detail: {
    ...
    updateFollowers(a) {
      a && Object.assign(this.followers, ...a.map((b) => ({ [b]: !0 })))
    }
    updateSubscribers(a) {
      a && Object.assign(this.subscribers, ...a.map((b) => ({ [b]: !0 })))
    }
    saveBanlist() {
      this.prx.isTwitchOAuth ||
        localStorage.setItem(
    ...
    preventAlbumContentInteraction(a) {
      a.target.closest(".item") &&
        this.isAlbumContent(a.target) &&
        a.stopPropagation()
    }
      ...
      return new Promise((c) => {
        const d = () => {
          ...
          var e = document.querySelector(
            ".screen :is(.write, .memory) .core > div > canvas"
          )
          e
            ? ((e = e.parentElement), (e.dataset.type = "image"), c(e))
            : !a &&
              Date.now() - b < GPModeration_.PREVIEW_MONITOR_TIMEOUT &&
    ...
    handleCensorableItem(a) {
      ...
      if (b)
        if (
          ...
          this.isCensoredItem(a) &&
            this.censorItem(a, GPModeration_.CENSORING_REASON.BY_USER)
        }
    }
    handlePreviewItem(a) {
      this.isAnimationOrMultiPieceItem(a) ||
        ((a = a.querySelector(".balloon")),
        a.addEventListener("pointerenter", this.albumItemEnterHandler),
        a.addEventListener("pointerleave", this.albumItemLeaveHandler))
    }
    albumItemEnterHandler(a) {
      if (
        this.preview.isEnabled() &&
        ((a = a.currentTarget.closest(".item")),
        !this.isEmptyItem(a) &&
          !this.isPreviewedItem(a) &&
        ...
        if ((a = this.prx.getAlbumItem(b)))
          (b = `${this.prx.getCurrentAlbumId()}_${b}`),
            this.preview.load(a.data, a.type, b)
      }
    }
    albumItemLeaveHandler(a) {
      this.preview.isEnabled() &&
        ((a = a.currentTarget.closest(".item")),
        a.classList.contains("previewed_") &&
          (a.classList.remove("previewed_"), this.preview.clear()))
    }
    imagePreviewOverHandler(a) {
      this.preview.isEnabled() &&
        this.isPreviewCanvas(a.target) &&
        this.previewCensorableItem(a.target.parentElement)
    }
    ...
    imagePreviewDownHandler(a) {
      0 === a.button &&
        this.isPreviewCanvas(a.target) &&
        this.handleCensorableItemDown(a.target.parentElement)
    }
    handleCensorableItemDown(a) {
      const b = this.getContentId(a),
        c = this.prx.getPrevData()?.user?.nick
      this.s.safeMode && !this.safeItems.has(b)
        ? this.safeItems.add(b)
        : this.shouldBeBannedItem(a, c) ||
          this.isPreviewedItem(a) ||
          (a.dataset.cr &&
            a.dataset.cr !== GPModeration_.CENSORING_REASON.BY_USER)
        ? (a.classList.toggle("preview_"),
          this.preview.isEnabled() &&
            (this.preview.clear(), a.classList.remove("previewed_")))
        : this.censorItems.has(b)
        ? this.censorItems.delete(b)
        : this.censorItems.set(b, a.dataset.type)
      this.handleCensorableItem(a)
    }
    isPreviewCanvas(a) {
    ...
    handlePainterHeader(a) {
      if ((a = a.querySelector("h4 + h3")))
        a.addEventListener("pointerover", this.painterHeaderTextOverHandler),
          a.addEventListener("pointerdown", this.painterHeaderTextDownHandler),
          (a.dataset.type = "text"),
          (a.dataset.typeId = GPProxy_.ALBUM_ITEM_TYPE.TEXT),
          this.handleCensorableItem(a)
    }
    ...
    acTriggerHandler({ detail: { itemId: a, albumId: b } }) {
      this.prx.getCurrentAlbumId() === b &&
        (b = this.albumItems.find((c) => this.getItemId(c) === a)) &&
        b.classList.add("suspicious_")
    }
    initTwitchTokenBtn() {
      this.twitchTokenBtn = document.createElement("div")
      this.twitchTokenBtn.className = "mod-twitch-token-btn_"
      this.twitchTokenBtn.title =
        "\u041f\u043e\u043b\u0443\u0447\u0438\u0442\u044c Twitch-\u0442\u043e\u043a\u0435\u043d, \u043f\u0440\u0435\u0434\u043e\u0441\u0442\u0430\u0432\u0438\u0432 \u043d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u044b\u0435 \u043f\u0440\u0430\u0432\u0430 \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u044e gp-mod (\u043d\u0435 \u0434\u0435\u043b\u0430\u0439\u0441\u044f \u044d\u0442\u043e\u0433\u043e \u043d\u0430 \u0442\u0440\u0430\u043d\u0441\u043b\u044f\u0446\u0438\u0438 \u0438 \u043d\u0435 \u0441\u043e\u043e\u0431\u0449\u0430\u0439\u0442\u0435 \u0442\u043e\u043a\u0435\u043d \u043d\u0438\u043a\u043e\u043c\u0443)"
    ...
    requestTwitchTokenStatus() {
      return this.s.twitchToken
        ? fetch("https://id.twitch.tv/oauth2/validate", {
            headers: { Authorization: `OAuth ${this.s.twitchToken}` },
            credentials: "omit",
            cache: "no-cache",
          })
            .then((a) => a.ok)
    ...
    checkTwitchToken2Status() {
      this.s.twitchToken2 &&
        this.twitchAPI.validateToken(this.s.twitchToken2).then((a) => {
    ...
    showTwitchToken2Notice() {
      this.abt?.showTwitchToken2Notice({
        onButtonClick: () => {
          this.twitchAPI.requestToken(
            GPTwitchAPI_.TOKEN_TYPE.FOLLOWERS_SUBSCRIPTIONS
          )
        },
        onClose: () => {
    ...
    handleAlbumLocalizedTwitchUsername(a) {
      if (this.prx.isTwitchAuth())
        if (
          ((a = this.getNicknameElem(a)),
          this.s.disableLocalizedTwitchUsernames)
        ) {
          const b = this.localizedLogins.get(a?.textContent)
          b &&
            (a.classList.add("processing_"),
            (a.dataset.login = b),
            (a.style.width = getComputedStyle(a, "::before").width),
            a.classList.remove("processing_"))
        } else delete a.dataset.login, (a.style.width = "")
    }
    handleAlbumHeader(a) {
      if (
        this.prx.isTwitchAuth() &&
        ((a ??= this.contentObserver.getAlbumHeader()), a)
      )
        if (this.s.disableLocalizedTwitchUsernames) {
    ...
    handleAlbumFooter(a) {
      if (
        this.prx.isTwitchAuth() &&
        ((a ??= this.contentObserver.getAlbumFooter()), a)
      )
        if (this.s.disableLocalizedTwitchUsernames) {
          const b = this.prx.getAlbumAuthor(),
            c = this.localizedLogins.get(b)
          c &&
            (a.classList.add("processing_"),
            (a.dataset.login = a.textContent.replace(b, c)),
            (a.style.width = getComputedStyle(a, "::before").width),
            a.classList.remove("processing_"))
        } else delete a.dataset.login, (a.style.width = "")
    }
    updateRankingUsers() {
      this.prx.isTwitchAuth() &&
        this.contentObserver.getRankingUsers().forEach((a) => {
    ...
    gallerySettingsObserverCallback(a, b) {
      for (const c of a)
        if (
          "childList" === c.type &&
          c.addedNodes[0]?.classList?.contains("fade-enter") &&
          c.addedNodes[0].firstElementChild?.classList?.contains("book")
        ) {
    ...
    renderSafeModeControl(a) {
      ...
      var c =
        GPModeration_.SAFE_MODE_OPT_L10N[window.__NEXT_DATA__.locale] ??
    ...
    updateSafeModControl() {
      ...
      a &&
        (a.isConnected
          ? (this.safeModControl.value = +this.s.safeMode)
          : (this.safeModControl = null))
    }
    updateSettings({ detail: { settings: a } }) {
      "showUI" in a &&
        (this.container.classList.toggle("shown_", a.showUI),
        this.container.classList.remove("banlist_"),
        this.renderUsers(),
        this.activateBtn.classList.toggle("pressed_", a.showUI))
      "autoKick" in a &&
        (this.container.classList.toggle("autokick_", a.autoKick),
        this.clearPlayers())
      "autoKickNewAccounts" in a && this.clearPlayers()
      "copyUsernamesWithClick" in a && this.initUsernamesCopying()
      "compactMode" in a &&
        this.container.classList.toggle("compact_", a.compactMode)
      "playersColorIndication" in a && this.updatePlayerItems()
      "disableLocalizedTwitchUsernames" in a &&
        this.prx.isTwitchAuth() &&
        (this.renderUsers(),
        this.renderBanlist(),
        this.prx.isGameStages(
          GPProxy_.GAME_STAGE.LOBBY,
          GPProxy_.GAME_STAGE.ALBUM,
          GPProxy_.GAME_STAGE.GALLERY_SETTINGS,
          GPProxy_.GAME_STAGE.SCORE
        ) && this.updatePlayerItems(),
        this.prx.isGameStage(GPProxy_.GAME_STAGE.ALBUM)
          ? (this.handleAlbumHeader(),
            this.handleAlbumFooter(),
            this.handleAlbumUsernames())
          : this.prx.isGameStage(GPProxy_.GAME_STAGE.SCORE) &&
            this.updateRankingUsers())
      "newAccountPeriod" in a && this.renderUsers()
      ;["censorSentences", "censorNicknames"].some((b) => b in a) &&
        this.prx.isGameStage(GPProxy_.GAME_STAGE.ALBUM) &&
        this.handleItems()
      ;[
        "censorDrawings",
        ...
        ("safeMode" in a &&
          (this.safeItems.clear(), this.updateSafeModControl()),
        this.prx.isGameStage(GPProxy_.GAME_STAGE.ALBUM)
          ? this.handleItems()
          : this.prx.isScreen(GPProxy_.SCREEN_ID.PAINTER) &&
            this.searchPreviewImage(!0).then(this.handleCensorableItem))
      "userBansSyncWithTwitch" in a &&
        a.userBansSyncWithTwitch &&
        this.twitchAPI.validateToken(this.s.twitchToken).then((b) => {
          b || this.twitchAPI.requestToken(GPTwitchAPI_.TOKEN_TYPE.BAN_USERS)
        })
      if ("twitchFollowerBadges" in a || "twitchSubscriberBadges" in a)
        (a.twitchFollowerBadges && a.twitchSubscriberBadges) ||
          (this.renderUsers(), this.updatePlayerItems()),
          (a.twitchFollowerBadges || a.twitchSubscriberBadges) &&
            this.twitchAPI.validateToken(this.s.twitchToken2).then((b) => {
              b
                ? this.requestTwitchUsersData(this.prx.getUsers())
                : this.twitchAPI.requestToken(
                    GPTwitchAPI_.TOKEN_TYPE.FOLLOWERS_SUBSCRIPTIONS
                  )
            })
  ...
  class GPPreview_ extends EventTarget {
    ...
    static ANCHORS = { t: "top", b: "bottom", l: "left", r: "right" }
    static ANCHOR = {
      TOP: "top",
      BOTTOM: "bottom",
      LEFT: "left",
    ...
    static TYPES = { 1: "image", 2: "text", 5: "animation" }
    static WINDOW_URL = "https://gpmod.github.io/preview"
    constructor(a, b, { x: c, y: d, o: e }, f, g) {
      super()
      this.prx = a
      this.l = g
      this.enabled = !!b
      ...
      this.prx.addEventListener("data", ({ detail: { event: h } }) => {
    ...
    render() {
      ...
      this.panel.addEventListener("wheel", (b) => {
        ...
        this.panelWidth =
          0 < b.deltaY
            ? Math.max(
                this.panelWidth - GPPreview_.PANEL_WIDTH_STEP,
                GPPreview_.MIN_PANEL_WIDTH
              )
            : Math.min(
                this.panelWidth + GPPreview_.PANEL_WIDTH_STEP,
                GPPreview_.MAX_PANEL_WIDTH
              )
        this.updatePanelSize()
        this.updatePanelPosition()
        this.dispatchEvent(
          new CustomEvent("panel_width_changed", {
            detail: { width: this.panelWidth },
          })
        )
      })
      this.panel.addEventListener("pointerdown", (b) => {
        if (0 === b.button) {
          var [c, d, e, f] = this.getCoords(b),
            g = ((h) => {
              this.setPanelPosition(h.pageX - c, h.pageY - d, e, f)
            }).bind(this)
          ...
          this.panel.addEventListener(
            ...
            () => {
              this.dispatchEvent(
                new CustomEvent("panel_pos_changed", {
                  detail: {
                    x: this.panelOffsetX,
                    y: this.panelOffsetY,
                    o: this.panelAnchor,
      ...
      this.panel.addEventListener("pointerdown", (b) => {
        if (1 === b.button || 2 === b.button)
          this.panel.setPointerCapture(b.pointerId),
            this.panel.addEventListener(
              "pointerup",
              (c) => {
                if (1 === c.button || 2 === c.button)
                  this.window ? this.closeWindow() : this.openWindow()
              },
              { once: !0 }
            )
      })
      ...
      a.style.setProperty(
        "--frame-mode-warning",
        `'${this.l.PREIVEW_PANEL_WARNING}'`
      )
      a.style.setProperty(
        "--win-mode-warning",
        `'${this.l.PREIVEW_TAB_WARNING}'`
      )
    ...
    toggle(a) {
      ...
      this.enabled
        ? (this.panel.classList.add("frame-mode_"), this.initWorker())
        : (this.clear(),
          this.window && this.closeWindow(),
          this.terminateWorker(),
          this.replaceCanvas())
      this.dispatchEvent(
        new CustomEvent("status", { detail: { status: this.enabled } })
      )
    ...
    updatePanelSize() {
      this.panel.style.setProperty("--gp-preview-width", `${this.panelWidth}px`)
      this.panelBorderWidth = Math.max(
        Math.round(this.panelWidth / 142),
        GPPreview_.MIN_PANEL_BORDER_WIDTH
      )
      this.panel.style.setProperty(
        "--gp-preview-border-width",
        `${this.panelBorderWidth}px`
      )
    }
    updatePanelPosition() {
      const a = Math.max(
        ...
        b = Math.max(
          Math.min(
            ...
            document.documentElement.clientHeight -
              this.panelWidth /
                (GPPreview_.CANVAS_WIDTH / GPPreview_.CANVAS_HEIGHT) -
              this.panelBorderWidth
          ),
          this.panelBorderWidth
        )
    ...
    setPanelPosition(a, b, c, d) {
      ...
      const e = document.documentElement.clientWidth,
        ...
        g = Math.max(
          Math.min(a, e - c - this.panelBorderWidth),
          this.panelBorderWidth
        ),
        h = Math.max(
          Math.min(b, f - d - this.panelBorderWidth),
          this.panelBorderWidth
        )
      this.panel.style.inset = "unset"
      this.panel.dataset.anchor = ""
      b + d / 2 > f / 2
        ? ((this.panelOffsetY = Math.round(f - (h + d))),
          (this.panel.style.bottom = `${this.panelOffsetY}px`),
          (this.panel.dataset.anchor += "b"))
        : ((this.panelOffsetY = Math.round(h)),
          (this.panel.style.top = `${this.panelOffsetY}px`),
          (this.panel.dataset.anchor += "t"))
      a + c / 2 > e / 2
        ? ((this.panelOffsetX = Math.round(e - (g + c))),
          (this.panel.style.right = `${this.panelOffsetX}px`),
          (this.panel.dataset.anchor += "r"))
        : ((this.panelOffsetX = Math.round(g)),
    ...
    initWorker() {
      ...
      this.worker.addEventListener("message", ({ data: { type: b, ...c } }) => {
        switch (b) {
          case "cache":
            const { imageData: d, cacheId: e } = c
            this.cache.set(e, d)
            break
          case "rendered":
    ...
    workerBody() {
      self.addEventListener("message", ({ data: { type: a, data: b } }) => {
        switch (a) {
          case "draw":
            const { strokes: c, cacheId: d } = b
            self.clear()
            self.draw(self.ctx, c, self.density, !0, !1)
            a = self.ctx.getImageData(
              0,
              0,
              self.canvas.width,
              self.canvas.height
            )
            self.postMessage({ type: "cache", imageData: a, cacheId: d })
    ...
    load(a, b, c) {
      if (a) {
        ...
        if (this.window)
          this.window.postMessage(
            { type: "data", data: a, itemType: d },
            GPPreview_.WINDOW_URL
          )
        else
          switch (((this.panel.dataset.type = d), b)) {
            case GPProxy_.ALBUM_ITEM_TYPE.IMAGE:
              this.worker.postMessage({ type: "clear" })
              ;(b = this.cache.get(c))
                ? this.worker.postMessage({ type: "cache", data: b })
                : this.worker.postMessage({
                    type: "draw",
                    data: { strokes: a, cacheId: c },
                  })
              break
            case GPProxy_.ALBUM_ITEM_TYPE.TEXT:
              ;(this.text.textContent = a),
                this.dispatchEvent(new Event("rendered"))
          }
      }
    }
    clear() {
      this.window
        ? this.window.postMessage({ type: "clear" }, GPPreview_.WINDOW_URL)
        : this.worker?.postMessage({ type: "clear" })
  ...
  class GPTwitchAPI_ extends EventTarget {
    ...
    static AUTH_URL = `https://id.twitch.tv/oauth2/authorize?client_id=${
      this.CLIENT_ID
    }&redirect_uri=${encodeURIComponent(
      "https://gpmod.github.io/twitch-token?WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW&tokenType={token-type}"
    ...
    static SCOPES = {
      ...
      [this.TOKEN_TYPE.FOLLOWERS_SUBSCRIPTIONS]:
    ...
    constructor() {
      ...
      window.addEventListener("message", (a) => {
        if (
          ("https://gpmod.github.io" === a.origin ||
            "https://localhost" === a.origin) &&
          "gp-twitch-token" === a.data.type
        ) {
          ...
          this.authWindow.postMessage({ type: "close" }, a.origin)
          this.authWindow = null
        }
      })
    }
    ...
    openAuthWindow(a, b) {
      ...
      a = GPTwitchAPI_.AUTH_URL.replace(
        "{scopes}",
        encodeURIComponent(a)
      ).replace("%7Btoken-type%7D", encodeURIComponent(b))
      this.authWindow = window.open(a)
    }
    validateToken(a) {
      return a
        ? fetch("https://id.twitch.tv/oauth2/validate", {
            headers: { Authorization: `OAuth ${a}` },
            credentials: "omit",
            cache: "no-cache",
          })
            .then((b) => b.ok)
    ...
    banUser(a, b, c) {
      return fetch(
        `${GPTwitchAPI_.BASE_URL}${GPTwitchAPI_.BANS_API}?broadcaster_id=${b}&moderator_id=${b}`,
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            data: { user_id: a, reason: "Gartic Phone" },
          }),
        }
      ).then((d) => {
    ...
    unbanUser(a, b, c) {
      return fetch(
        `${GPTwitchAPI_.BASE_URL}${GPTwitchAPI_.BANS_API}?broadcaster_id=${b}&moderator_id=${b}&user_id=${a}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${c}`,
...
// Автоматическое нажатие кнопки ТОЛЬКО при первом запуске
(function() {
    // Проверяем, есть ли в памяти браузера пометка о том, что мы уже пропускали ввод ключа
    if (!localStorage.getItem("gp_mod_key_bypassed")) {
        
        // Если пометки нет, запускаем поиск кнопки каждые 100 миллисекунд
        const autoClickInterval = setInterval(() => {
            const btn = document.querySelector(".gp-ui-btn_.reload-btn_");
            
            if (btn) {
                // 1. Делаем кнопку активной
                btn.classList.remove("disabled_");
                btn.removeAttribute("disabled");
                
                // 2. Нажимаем её
                btn.click();
                
                // 3. Сохраняем в память браузера пометку, чтобы больше никогда не нажимать
                localStorage.setItem("gp_mod_key_bypassed", "true");
